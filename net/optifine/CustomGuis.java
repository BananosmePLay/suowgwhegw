...
public class CustomGuis {
   ...
   private static CustomGuiProperties[][] guiProperties = (CustomGuiProperties[][])((CustomGuiProperties[][])null);
   ...
   public static void update() {
      guiProperties = (CustomGuiProperties[][])((CustomGuiProperties[][])null);
   ...
   private static CustomGuiProperties[][] propertyListToArray(List<List<CustomGuiProperties>> listProps) {
      if (listProps.isEmpty()) {
         return (CustomGuiProperties[][])((CustomGuiProperties[][])null);
      } else {
