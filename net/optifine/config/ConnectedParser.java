...
public class ConnectedParser {
   ...
   private IBlockState getStateFromMeta(Block block, int md) {
      try {
         ...
         if (block == Blocks.OBSERVER && (md & 8) != 0) {
            iblockstate = iblockstate.withProperty(BlockObserver.POWERED, true);
         }
   ...
   public Biome findBiome(String biomeName) {
      ...
      if (biomeName.equals("nether")) {
         ...
         Iterator var2 = Biome.REGISTRY.getKeys().iterator();
   ...
   public EnumDyeColor[] parseDyeColors(String str, String property, EnumDyeColor[] errValue) {
      return (EnumDyeColor[])((EnumDyeColor[])this.parseObjects(str, EnumDyeColor.values(), NAME_GETTER_DYE_COLOR, property, errValue));
   }

   public Weather[] parseWeather(String str, String property, Weather[] errValue) {
      return (Weather[])((Weather[])this.parseObjects(str, Weather.values(), NAME_GETTER_ENUM, property, errValue));
   }
