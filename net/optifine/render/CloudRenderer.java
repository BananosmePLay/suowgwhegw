...
public class CloudRenderer {
   ...
   public boolean shouldUpdateGlList() {
      if (!this.updated) {
         ...
         boolean flag = var10000 < 128.0 + (double)(Minecraft.gameSettings.ofCloudsHeight * 128.0F);
         var10000 = entity.prevPosY + (double)entity.getEyeHeight();
         var10002 = this.mc;
         boolean flag1 = var10000 < 128.0 + (double)(Minecraft.gameSettings.ofCloudsHeight * 128.0F);
         return flag1 != flag;
      }
   }
