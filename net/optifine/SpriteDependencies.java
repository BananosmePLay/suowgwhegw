...
public class SpriteDependencies {
   ...
   public static TextureAtlasSprite resolveDependencies(List<TextureAtlasSprite> listRegisteredSprites, int ix, TextureMap textureMap) {
      ...
      for(textureatlassprite = (TextureAtlasSprite)listRegisteredSprites.get(ix); resolveOne(listRegisteredSprites, ix, textureatlassprite, textureMap); textureatlassprite = (TextureAtlasSprite)listRegisteredSprites.get(ix)) {
      }
