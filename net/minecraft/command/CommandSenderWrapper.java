...
public class CommandSenderWrapper implements ICommandSender {
   ...
   public CommandSenderWrapper withSendCommandFeedback(boolean sendCommandFeedbackIn) {
      return this.sendCommandFeedback != null && (!this.sendCommandFeedback || sendCommandFeedbackIn) ? this : new CommandSenderWrapper(this.delegate, this.positionVector, this.position, this.permissionLevel, this.entity, sendCommandFeedbackIn);
   }
