...
public class CommandSpreadPlayers extends CommandBase {
   ...
   public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
      if (args.length < 6) {
         ...
         if (list.isEmpty()) {
            ...
            this.spread(sender, list, new Position(d0, d1), d2, d3, ((Entity)list.get(0)).world, flag);
         }
      }
   }
   ...
   private double setPlayerPositions(List<Entity> p_110671_1_, World worldIn, Position[] p_110671_3_, boolean p_110671_4_) {
      ...
      for(int j = 0; j < p_110671_1_.size(); ++j) {
         ...
         Position[] var14 = p_110671_3_;
         int var15 = p_110671_3_.length;

         for(int var16 = 0; var16 < var15; ++var16) {
            Position commandspreadplayers$position1 = var14[var16];
