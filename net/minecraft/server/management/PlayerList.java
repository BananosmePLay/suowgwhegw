...
public abstract class PlayerList {
   ...
   protected void writePlayerData(EntityPlayerMP playerIn) {
      ...
      PlayerAdvancements playeradvancements = (PlayerAdvancements)this.advancements.get(playerIn.getUniqueID());
   ...
   public EntityPlayerMP createPlayerForUser(GameProfile profile) {
      ...
      return new EntityPlayerMP(this.server, this.server.getWorld(0), profile, (PlayerInteractionManager)playerinteractionmanager);
   }
   ...
   public EntityPlayerMP recreatePlayerEntity(EntityPlayerMP playerIn, int dimension, boolean conqueredEnd) {
      ...
      EntityPlayerMP entityplayermp = new EntityPlayerMP(this.server, this.server.getWorld(playerIn.dimension), playerIn.getGameProfile(), (PlayerInteractionManager)playerinteractionmanager);
      ...
      BlockPos blockpos2;
      if (blockpos != null) {
         blockpos2 = EntityPlayer.getBedSpawnLocation(this.server.getWorld(playerIn.dimension), blockpos, flag);
         if (blockpos2 != null) {
   ...
   public String getFormattedListOfPlayers(boolean includeUUIDs) {
      String s = "";
      List<EntityPlayerMP> list = Lists.newArrayList((Iterable)this.playerEntityList);
   ...
   public void removeAllPlayers() {
      for(int i = 0; i < this.playerEntityList.size(); ++i) {
         ((EntityPlayerMP)this.playerEntityList.get(i)).connection.disconnect(new TextComponentTranslation("multiplayer.disconnect.server_shutdown", new Object[0]));
      }
   ...
   public void setViewDistance(int distance) {
      ...
      if (this.server.worlds != null) {
         WorldServer[] var2 = this.server.worlds;
