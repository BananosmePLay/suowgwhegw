   ...
   public void updateTimeLightAndEntities() {
      ...
      for(k = 0; k < this.worlds.length; ++k) {
         ...
         if (k == 0 || this.getAllowNether()) {
            WorldServer worldserver = this.worlds[k];
            ...
            try {
               ...
               throwable = var8;
               crashreport1 = CrashReport.makeCrashReport(throwable, "Exception ticking world");
            ...
            try {
               ...
               throwable = var7;
               crashreport1 = CrashReport.makeCrashReport(throwable, "Exception ticking world entities");
               worldserver.addWorldInfoToCrashReport(crashreport1);
               throw new ReportedException(crashreport1);
            }
