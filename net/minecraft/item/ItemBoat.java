...
public class ItemBoat extends Item {
   ...
   public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
      ...
      if (raytraceresult == null) {
         ...
         boolean flag = false;
         List<Entity> list = worldIn.getEntitiesWithinAABBExcludingEntity(playerIn, playerIn.getEntityBoundingBox().expand(vec3d2.x * 5.0, vec3d2.y * 5.0, vec3d2.z * 5.0).grow(1.0));
         ...
         if (flag) {
            ...
            EntityBoat entityboat = new EntityBoat(worldIn, raytraceresult.hitVec.x, flag1 ? raytraceresult.hitVec.y - 0.12 : raytraceresult.hitVec.y, raytraceresult.hitVec.z);
