...
public class AdvancementTreeNode {
   ...
   private void executeShifts() {
      ...
      for(int i = this.children.size() - 1; i >= 0; --i) {
         AdvancementTreeNode advancementtreenode = (AdvancementTreeNode)this.children.get(i);
   ...
   private AdvancementTreeNode apportion(AdvancementTreeNode nodeIn) {
      if (this.sibling == null) {
         ...
         AdvancementTreeNode advancementtreenode3 = (AdvancementTreeNode)this.parent.children.get(0);
         float f = this.mod;
         float f1 = this.mod;
