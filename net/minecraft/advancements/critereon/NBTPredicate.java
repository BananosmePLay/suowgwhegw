...
public class NBTPredicate {
   ...
   public boolean test(ItemStack item) {
      return this == ANY ? true : this.test((NBTBase)item.getTagCompound());
   }

   public boolean test(Entity entityIn) {
      return this == ANY ? true : this.test((NBTBase)CommandBase.entityToNBT(entityIn));
   }
   ...
   public static NBTPredicate deserialize(@Nullable JsonElement json) {
      if (json != null && !json.isJsonNull()) {
         ...
         try {
            ...
            NBTException nbtexception = var3;
