...
public class MobEffectsPredicate {
   ...
   public boolean test(Map<Potion, PotionEffect> potions) {
      if (this == ANY) {
         ...
         } while(((InstancePredicate)entry.getValue()).test(potioneffect));
   ...
   public static MobEffectsPredicate deserialize(@Nullable JsonElement element) {
      if (element != null && !element.isJsonNull()) {
         ...
         while(var3.hasNext()) {
            ...
            InstancePredicate mobeffectspredicate$instancepredicate = MobEffectsPredicate.InstancePredicate.deserialize(JsonUtils.getJsonObject((JsonElement)entry.getValue(), (String)entry.getKey()));
