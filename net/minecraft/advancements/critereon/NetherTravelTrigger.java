...
public class NetherTravelTrigger implements ICriterionTrigger<Instance> {
   ...
   public void addListener(PlayerAdvancements playerAdvancementsIn, ICriterionTrigger.Listener<Instance> listener) {
      Listeners nethertraveltrigger$listeners = (Listeners)this.listeners.get(playerAdvancementsIn);
   ...
   public void trigger(EntityPlayerMP player, Vec3d enteredNetherPosition) {
      Listeners nethertraveltrigger$listeners = (Listeners)this.listeners.get(player.getAdvancements());
      if (nethertraveltrigger$listeners != null) {
   ...
   static class Listeners {
      ...
      public void trigger(WorldServer world, Vec3d enteredNetherPosition, double x, double y, double z) {
         ...
         while(var10.hasNext()) {
            ...
            if (((Instance)listener1.getCriterionInstance()).test(world, enteredNetherPosition, x, y, z)) {
               if (list == null) {
