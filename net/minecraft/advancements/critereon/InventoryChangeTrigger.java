...
public class InventoryChangeTrigger implements ICriterionTrigger<Instance> {
   ...
   public void addListener(PlayerAdvancements playerAdvancementsIn, ICriterionTrigger.Listener<Instance> listener) {
      Listeners inventorychangetrigger$listeners = (Listeners)this.listeners.get(playerAdvancementsIn);
   ...
   public void trigger(EntityPlayerMP player, InventoryPlayer inventory) {
      Listeners inventorychangetrigger$listeners = (Listeners)this.listeners.get(player.getAdvancements());
      if (inventorychangetrigger$listeners != null) {
   ...
   static class Listeners {
      ...
      public void trigger(InventoryPlayer inventory) {
         ...
         while(var3.hasNext()) {
            ...
            if (((Instance)listener1.getCriterionInstance()).test(inventory)) {
               if (list == null) {
   ...
   public static class Instance extends AbstractCriterionInstance {
      ...
      public boolean test(InventoryPlayer inventory) {
         ...
         int j = 0;
         int k = 0;
         List<ItemPredicate> list = Lists.newArrayList((Object[])this.items);
