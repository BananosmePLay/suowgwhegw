...
public class TameAnimalTrigger implements ICriterionTrigger<Instance> {
   ...
   public void addListener(PlayerAdvancements playerAdvancementsIn, ICriterionTrigger.Listener<Instance> listener) {
      Listeners tameanimaltrigger$listeners = (Listeners)this.listeners.get(playerAdvancementsIn);
   ...
   public void trigger(EntityPlayerMP player, EntityAnimal entity) {
      Listeners tameanimaltrigger$listeners = (Listeners)this.listeners.get(player.getAdvancements());
      if (tameanimaltrigger$listeners != null) {
