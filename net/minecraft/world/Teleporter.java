...
public class Teleporter {
   ...
   public boolean placeInExistingPortal(Entity entityIn, float rotationYaw) {
      ...
      if (d0 >= 0.0) {
         if (flag) {
            this.destinationCoordinateCache.put(l, new PortalPosition((BlockPos)blockpos, this.world.getTotalWorldTime()));
         }

         double d5 = (double)((BlockPos)blockpos).getX() + 0.5;
         double d7 = (double)((BlockPos)blockpos).getZ() + 0.5;
         BlockPattern.PatternHelper blockpattern$patternhelper = Blocks.PORTAL.createPatternHelper(this.world, (BlockPos)blockpos);
         ...
         for(int j7 = -1; j7 <= 1; ++j7) {
            for(i7 = 1; i7 < 3; ++i7) {
               for(k7 = -1; k7 < 3; ++k7) {
                  ...
                  boolean flag = k7 < 0;
                  this.world.setBlockState(new BlockPos(j8, j9, j10), flag ? Blocks.OBSIDIAN.getDefaultState() : Blocks.AIR.getDefaultState());
               }
            }
         }
      }
      ...
      for(i7 = 0; i7 < 4; ++i7) {
         for(k7 = 0; k7 < 4; ++k7) {
            for(j8 = -1; j8 < 4; ++j8) {
               ...
               this.world.setBlockState(new BlockPos(j9, j10, j11), flag1 ? Blocks.OBSIDIAN.getDefaultState() : iblockstate, 2);
            }
         }
      ...
      if (worldTime % 100L == 0L) {
         ...
         while(true) {
            ...
            do {
               ...
               teleporter$portalposition = (PortalPosition)objectiterator.next();
