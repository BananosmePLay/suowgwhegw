   ...
   static class Placer {
      ...
      public void createMansion(BlockPos p_191125_1_, Rotation p_191125_2_, List<MansionTemplate> p_191125_3_, Grid p_191125_4_) {
         ...
         for(int k = 0; k < woodlandmansionpieces$simplegrid1.height && !flag; ++k) {
            for(l2 = woodlandmansionpieces$simplegrid1.width - 1; l2 >= 0 && !flag; --l2) {
               if (WoodlandMansionPieces.Grid.isHouse(woodlandmansionpieces$simplegrid1, l2, k)) {
               ...
               for(int l1 = 0; l1 < woodlandmansionpieces$simplegrid3.width; ++l1) {
                  ...
                  if (woodlandmansionpieces$simplegrid3.get(l1, k1) == 2 || flag1) {
                     ...
                     if (woodlandmansionpieces$simplegrid3.get(l1 + 1, k1) == 1 && !flag1) {
                        ...
                        p_191125_3_.add(new MansionTemplate(this.templateManager, enumfacing1 == EnumFacing.EAST ? s3 : s2, blockpos5, p_191125_2_));
                     }
                     ...
                     if (WoodlandMansionPieces.Grid.isHouse(woodlandmansionpieces$simplegrid3, l1, k1 + 1) && !p_191125_4_.isRoomId(woodlandmansionpieces$simplegrid3, l1, k1 + 1, l2, k2)) {
                        ...
                        p_191125_3_.add(new MansionTemplate(this.templateManager, enumfacing1 == EnumFacing.SOUTH ? s3 : s2, blockpos5, p_191125_2_.add(Rotation.CLOCKWISE_90)));
                     }
      ...
      private void createRoof(List<MansionTemplate> p_191123_1_, BlockPos p_191123_2_, Rotation p_191123_3_, SimpleGrid p_191123_4_, @Nullable SimpleGrid p_191123_5_) {
         ...
         boolean flag2;
         BlockPos blockpos15;
         for(k = 0; k < p_191123_4_.height; ++k) {
            for(i1 = 0; i1 < p_191123_4_.width; ++i1) {
               ...
               flag2 = p_191123_5_ != null && WoodlandMansionPieces.Grid.isHouse(p_191123_5_, i1, k);
               if (WoodlandMansionPieces.Grid.isHouse(p_191123_4_, i1, k) && !flag2) {
                  p_191123_1_.add(new MansionTemplate(this.templateManager, "roof", blockpos3.up(3), p_191123_3_));
                  if (!WoodlandMansionPieces.Grid.isHouse(p_191123_4_, i1 + 1, k)) {
                     blockpos15 = blockpos3.offset(p_191123_3_.rotate(EnumFacing.EAST), 6);
                     p_191123_1_.add(new MansionTemplate(this.templateManager, "roof_front", blockpos15, p_191123_3_));
                  }
                  ...
                  if (!WoodlandMansionPieces.Grid.isHouse(p_191123_4_, i1 - 1, k)) {
                     ...
                     p_191123_1_.add(new MansionTemplate(this.templateManager, "roof_front", blockpos15, p_191123_3_.add(Rotation.CLOCKWISE_180)));
                  }

                  if (!WoodlandMansionPieces.Grid.isHouse(p_191123_4_, i1, k - 1)) {
                     blockpos15 = blockpos3.offset(p_191123_3_.rotate(EnumFacing.WEST), 1);
                     p_191123_1_.add(new MansionTemplate(this.templateManager, "roof_front", blockpos15, p_191123_3_.add(Rotation.COUNTERCLOCKWISE_90)));
                  }

                  if (!WoodlandMansionPieces.Grid.isHouse(p_191123_4_, i1, k + 1)) {
                     blockpos15 = blockpos3.offset(p_191123_3_.rotate(EnumFacing.EAST), 6);
                     blockpos15 = blockpos15.offset(p_191123_3_.rotate(EnumFacing.SOUTH), 6);
                     p_191123_1_.add(new MansionTemplate(this.templateManager, "roof_front", blockpos15, p_191123_3_.add(Rotation.CLOCKWISE_90)));
                  }
               }
            }
         }
         ...
         if (p_191123_5_ != null) {
            for(k = 0; k < p_191123_4_.height; ++k) {
               for(i1 = 0; i1 < p_191123_4_.width; ++i1) {
                  blockpos3 = p_191123_2_.offset(p_191123_3_.rotate(EnumFacing.SOUTH), 8 + (k - this.startY) * 8);
                  blockpos3 = blockpos3.offset(p_191123_3_.rotate(EnumFacing.EAST), (i1 - this.startX) * 8);
                  flag2 = WoodlandMansionPieces.Grid.isHouse(p_191123_5_, i1, k);
                  if (WoodlandMansionPieces.Grid.isHouse(p_191123_4_, i1, k) && flag2) {
                     if (!WoodlandMansionPieces.Grid.isHouse(p_191123_4_, i1 + 1, k)) {
                        blockpos15 = blockpos3.offset(p_191123_3_.rotate(EnumFacing.EAST), 7);
                        p_191123_1_.add(new MansionTemplate(this.templateManager, "small_wall", blockpos15, p_191123_3_));
                     }

                     if (!WoodlandMansionPieces.Grid.isHouse(p_191123_4_, i1 - 1, k)) {
                        blockpos15 = blockpos3.offset(p_191123_3_.rotate(EnumFacing.WEST), 1);
                        blockpos15 = blockpos15.offset(p_191123_3_.rotate(EnumFacing.SOUTH), 6);
                        p_191123_1_.add(new MansionTemplate(this.templateManager, "small_wall", blockpos15, p_191123_3_.add(Rotation.CLOCKWISE_180)));
                     }
                     ...
                     if (!WoodlandMansionPieces.Grid.isHouse(p_191123_4_, i1, k - 1)) {
                        ...
                        p_191123_1_.add(new MansionTemplate(this.templateManager, "small_wall", blockpos15, p_191123_3_.add(Rotation.COUNTERCLOCKWISE_90)));
                     }

                     if (!WoodlandMansionPieces.Grid.isHouse(p_191123_4_, i1, k + 1)) {
                        blockpos15 = blockpos3.offset(p_191123_3_.rotate(EnumFacing.EAST), 6);
                        blockpos15 = blockpos15.offset(p_191123_3_.rotate(EnumFacing.SOUTH), 7);
                        p_191123_1_.add(new MansionTemplate(this.templateManager, "small_wall", blockpos15, p_191123_3_.add(Rotation.CLOCKWISE_90)));
                     }
                     ...
                     if (!WoodlandMansionPieces.Grid.isHouse(p_191123_4_, i1 + 1, k)) {
                        if (!WoodlandMansionPieces.Grid.isHouse(p_191123_4_, i1, k - 1)) {
                           ...
                           p_191123_1_.add(new MansionTemplate(this.templateManager, "small_wall_corner", blockpos15, p_191123_3_));
                        }

                        if (!WoodlandMansionPieces.Grid.isHouse(p_191123_4_, i1, k + 1)) {
                           blockpos15 = blockpos3.offset(p_191123_3_.rotate(EnumFacing.EAST), 8);
                           blockpos15 = blockpos15.offset(p_191123_3_.rotate(EnumFacing.SOUTH), 7);
                           p_191123_1_.add(new MansionTemplate(this.templateManager, "small_wall_corner", blockpos15, p_191123_3_.add(Rotation.CLOCKWISE_90)));
                        }
                     }
                     ...
                     if (!WoodlandMansionPieces.Grid.isHouse(p_191123_4_, i1 - 1, k)) {
                        if (!WoodlandMansionPieces.Grid.isHouse(p_191123_4_, i1, k - 1)) {
                           ...
                           blockpos15 = blockpos15.offset(p_191123_3_.rotate(EnumFacing.NORTH), 1);
                           p_191123_1_.add(new MansionTemplate(this.templateManager, "small_wall_corner", blockpos15, p_191123_3_.add(Rotation.COUNTERCLOCKWISE_90)));
                        }
               ...
               if (WoodlandMansionPieces.Grid.isHouse(p_191123_4_, i1, k) && !flag2) {
                  ...
                  if (!WoodlandMansionPieces.Grid.isHouse(p_191123_4_, i1 + 1, k)) {
                     ...
                     if (!WoodlandMansionPieces.Grid.isHouse(p_191123_4_, i1, k + 1)) {
                        ...
                        p_191123_1_.add(new MansionTemplate(this.templateManager, "roof_corner", blockpos22, p_191123_3_));
                     } else if (WoodlandMansionPieces.Grid.isHouse(p_191123_4_, i1 + 1, k + 1)) {
                        blockpos22 = blockpos15.offset(p_191123_3_.rotate(EnumFacing.SOUTH), 5);
                        p_191123_1_.add(new MansionTemplate(this.templateManager, "roof_inner_corner", blockpos22, p_191123_3_));
                     }
                     ...
                     if (!WoodlandMansionPieces.Grid.isHouse(p_191123_4_, i1, k - 1)) {
                        ...
                        p_191123_1_.add(new MansionTemplate(this.templateManager, "roof_inner_corner", blockpos22, p_191123_3_.add(Rotation.CLOCKWISE_90)));
                     }
                  }
                  ...
                  if (!WoodlandMansionPieces.Grid.isHouse(p_191123_4_, i1 - 1, k)) {
                     ...
                     if (!WoodlandMansionPieces.Grid.isHouse(p_191123_4_, i1, k + 1)) {
                        blockpos22 = blockpos15.offset(p_191123_3_.rotate(EnumFacing.SOUTH), 6);
                        p_191123_1_.add(new MansionTemplate(this.templateManager, "roof_corner", blockpos22, p_191123_3_.add(Rotation.CLOCKWISE_90)));
                     } else if (WoodlandMansionPieces.Grid.isHouse(p_191123_4_, i1 - 1, k + 1)) {
                        ...
                        p_191123_1_.add(new MansionTemplate(this.templateManager, "roof_inner_corner", blockpos22, p_191123_3_.add(Rotation.COUNTERCLOCKWISE_90)));
                     }

                     if (!WoodlandMansionPieces.Grid.isHouse(p_191123_4_, i1, k - 1)) {
                        p_191123_1_.add(new MansionTemplate(this.templateManager, "roof_corner", blockpos15, p_191123_3_.add(Rotation.CLOCKWISE_180)));
                     } else if (WoodlandMansionPieces.Grid.isHouse(p_191123_4_, i1 - 1, k - 1)) {
      ...
      private void addRoom1x2(List<MansionTemplate> p_191132_1_, BlockPos p_191132_2_, Rotation p_191132_3_, EnumFacing p_191132_4_, EnumFacing p_191132_5_, RoomCollection p_191132_6_, boolean p_191132_7_) {
         ...
         if (p_191132_5_ == EnumFacing.EAST && p_191132_4_ == EnumFacing.SOUTH) {
            ...
            p_191132_1_.add(new MansionTemplate(this.templateManager, p_191132_6_.get1x2SideEntrance(this.random, p_191132_7_), blockpos, p_191132_3_));
            ...
            p_191132_1_.add(new MansionTemplate(this.templateManager, p_191132_6_.get1x2SideEntrance(this.random, p_191132_7_), blockpos, p_191132_3_, Mirror.LEFT_RIGHT));
            ...
            blockpos = blockpos.offset(p_191132_3_.rotate(EnumFacing.SOUTH), 6);
            p_191132_1_.add(new MansionTemplate(this.templateManager, p_191132_6_.get1x2SideEntrance(this.random, p_191132_7_), blockpos, p_191132_3_.add(Rotation.CLOCKWISE_180)));
         } else if (p_191132_5_ == EnumFacing.WEST && p_191132_4_ == EnumFacing.SOUTH) {
            blockpos = p_191132_2_.offset(p_191132_3_.rotate(EnumFacing.EAST), 7);
            p_191132_1_.add(new MansionTemplate(this.templateManager, p_191132_6_.get1x2SideEntrance(this.random, p_191132_7_), blockpos, p_191132_3_, Mirror.FRONT_BACK));
         } else if (p_191132_5_ == EnumFacing.SOUTH && p_191132_4_ == EnumFacing.EAST) {
            blockpos = p_191132_2_.offset(p_191132_3_.rotate(EnumFacing.EAST), 1);
            p_191132_1_.add(new MansionTemplate(this.templateManager, p_191132_6_.get1x2SideEntrance(this.random, p_191132_7_), blockpos, p_191132_3_.add(Rotation.CLOCKWISE_90), Mirror.LEFT_RIGHT));
         } else if (p_191132_5_ == EnumFacing.SOUTH && p_191132_4_ == EnumFacing.WEST) {
            blockpos = p_191132_2_.offset(p_191132_3_.rotate(EnumFacing.EAST), 7);
            p_191132_1_.add(new MansionTemplate(this.templateManager, p_191132_6_.get1x2SideEntrance(this.random, p_191132_7_), blockpos, p_191132_3_.add(Rotation.CLOCKWISE_90)));
         } else if (p_191132_5_ == EnumFacing.NORTH && p_191132_4_ == EnumFacing.WEST) {
            blockpos = p_191132_2_.offset(p_191132_3_.rotate(EnumFacing.EAST), 7);
            blockpos = blockpos.offset(p_191132_3_.rotate(EnumFacing.SOUTH), 6);
            p_191132_1_.add(new MansionTemplate(this.templateManager, p_191132_6_.get1x2SideEntrance(this.random, p_191132_7_), blockpos, p_191132_3_.add(Rotation.CLOCKWISE_90), Mirror.FRONT_BACK));
         } else if (p_191132_5_ == EnumFacing.NORTH && p_191132_4_ == EnumFacing.EAST) {
            blockpos = p_191132_2_.offset(p_191132_3_.rotate(EnumFacing.EAST), 1);
            blockpos = blockpos.offset(p_191132_3_.rotate(EnumFacing.SOUTH), 6);
            p_191132_1_.add(new MansionTemplate(this.templateManager, p_191132_6_.get1x2SideEntrance(this.random, p_191132_7_), blockpos, p_191132_3_.add(Rotation.COUNTERCLOCKWISE_90)));
            ...
            p_191132_1_.add(new MansionTemplate(this.templateManager, p_191132_6_.get1x2FrontEntrance(this.random, p_191132_7_), blockpos, p_191132_3_));
            ...
            p_191132_1_.add(new MansionTemplate(this.templateManager, p_191132_6_.get1x2FrontEntrance(this.random, p_191132_7_), blockpos, p_191132_3_.add(Rotation.CLOCKWISE_180)));
            ...
            p_191132_1_.add(new MansionTemplate(this.templateManager, p_191132_6_.get1x2FrontEntrance(this.random, p_191132_7_), blockpos, p_191132_3_.add(Rotation.CLOCKWISE_90)));
            ...
            blockpos = blockpos.offset(p_191132_3_.rotate(EnumFacing.SOUTH), 6);
            p_191132_1_.add(new MansionTemplate(this.templateManager, p_191132_6_.get1x2FrontEntrance(this.random, p_191132_7_), blockpos, p_191132_3_.add(Rotation.COUNTERCLOCKWISE_90)));
         } else if (p_191132_5_ == EnumFacing.UP && p_191132_4_ == EnumFacing.EAST) {
            blockpos = p_191132_2_.offset(p_191132_3_.rotate(EnumFacing.EAST), 15);
            p_191132_1_.add(new MansionTemplate(this.templateManager, p_191132_6_.get1x2Secret(this.random), blockpos, p_191132_3_.add(Rotation.CLOCKWISE_90)));
   ...
   static class Grid {
      ...
      private void setupThirdFloor() {
         ...
         for(int i = 0; i < this.thirdFloorGrid.height; ++i) {
            for(l1 = 0; l1 < this.thirdFloorGrid.width; ++l1) {
      ...
      private void identifyRooms(SimpleGrid p_191116_1_, SimpleGrid p_191116_2_) {
         ...
         int k3;
         for(k3 = 0; k3 < p_191116_1_.height; ++k3) {
