...
public class SetAttributes extends LootFunction {
   ...
   public ItemStack apply(ItemStack stack, Random rand, LootContext context) {
      Modifier[] var4 = this.modifiers;
      int var5 = var4.length;

      for(int var6 = 0; var6 < var5; ++var6) {
         Modifier setattributes$modifier = var4[var6];
   ...
   public static class Serializer extends LootFunction.Serializer<SetAttributes> {
      ...
      public void serialize(JsonObject object, SetAttributes functionClazz, JsonSerializationContext serializationContext) {
         ...
         Modifier[] var5 = functionClazz.modifiers;
         int var6 = var5.length;

         for(int var7 = 0; var7 < var6; ++var7) {
            Modifier setattributes$modifier = var5[var7];
      ...
      public void serialize(JsonObject var1, LootFunction var2, JsonSerializationContext var3) {
         this.serialize(var1, (SetAttributes)var2, var3);
      }
   }
