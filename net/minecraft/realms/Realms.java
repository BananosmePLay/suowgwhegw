...
public class Realms {
   ...
   public static boolean getRealmsNotificationsEnabled() {
      Minecraft.getMinecraft();
      return Minecraft.gameSettings.getOptionOrdinalValue(GameSettings.Options.REALMS_NOTIFICATIONS);
   }

   public static boolean inTitleScreen() {
      return Minecraft.getMinecraft().currentScreen != null && Minecraft.getMinecraft().currentScreen instanceof 0bE;
   }
