      ...
      (new Thread("Realms-connect-task") {
         public void run() {
            ...
            try {
               ...
               RealmsConnect var10000 = RealmsConnect.this;
               int var10002 = p_connect_2_;
               Minecraft.getMinecraft();
               var10000.connection = NetworkManager.createNetworkManagerAndConnect(inetaddress, var10002, Minecraft.gameSettings.isUsingNativeTransport(), 30);
               if (RealmsConnect.this.aborted) {
                  return;
               }
