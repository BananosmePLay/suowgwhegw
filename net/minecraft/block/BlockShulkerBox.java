...
public class BlockShulkerBox extends BlockContainer {
   ...
   public BlockFaceShape getBlockFaceShape(IBlockAccess worldIn, IBlockState state, BlockPos pos, EnumFacing face) {
      ...
      return tileentityshulkerbox$animationstatus == TileEntityShulkerBox.AnimationStatus.CLOSED || tileentityshulkerbox$animationstatus == TileEntityShulkerBox.AnimationStatus.OPENED && (enumfacing == face.getOpposite() || enumfacing == face) ? BlockFaceShape.SOLID : BlockFaceShape.UNDEFINED;
   }
}
