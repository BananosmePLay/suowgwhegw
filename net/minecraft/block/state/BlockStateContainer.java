...
public class BlockStateContainer {
   ...
   protected BlockStateContainer(Block p_i2_1_, IProperty<?>[] p_i2_2_, ImmutableMap<IUnlistedProperty<?>, Optional<?>> p_i2_3_) {
      ...
      Map<Map<IProperty<?>, Comparable<?>>, StateImplementation> map2 = Maps.newLinkedHashMap();
      ...
      while(var13.hasNext()) {
         StateImplementation blockstatecontainer$stateimplementation1 = (StateImplementation)var13.next();
   ...
   public String toString() {
      return MoreObjects.toStringHelper((Object)this).add("block", Block.REGISTRY.getNameForObject(this.block)).add("properties", Iterables.transform(this.properties.values(), GET_NAME_FUNC)).toString();
   }
