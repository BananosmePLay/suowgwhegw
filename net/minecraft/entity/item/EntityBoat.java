...
public class EntityBoat extends Entity {
   ...
   protected void entityInit() {
      ...
      for(int var3 = 0; var3 < var2; ++var3) {
         DataParameter<Boolean> dataparameter = var1[var3];
   ...
   public void onUpdate() {
      ...
      List<Entity> list = this.world.getEntitiesInAABBexcluding(this, this.getEntityBoundingBox().grow(0.20000000298023224, -0.009999999776482582, 0.20000000298023224), EntitySelectors.getTeamCollisionPredicate(this));
      if (!list.isEmpty()) {
               ...
               for(int i2 = i1; i2 < j1; ++i2) {
                  ...
                  if (iblockstate.getMaterial() == Material.WATER && d0 < (double)BlockLiquid.getLiquidHeight(iblockstate, this.world, blockpos$pooledmutableblockpos)) {
                     if ((Integer)iblockstate.getValue(BlockLiquid.LEVEL) != 0) {
                        Status entityboat$status = EntityBoat.Status.UNDER_FLOWING_WATER;
                        Status var17 = entityboat$status;
                        return var17;
                     }
