...
public class EntityFallingBlock extends Entity {
      ...
      if (this.fallTile.getMaterial() == Material.AIR) {
         ...
         if (!this.world.isRemote) {
            ...
            if (!this.onGround && !flag1) {
               ...
               if (!flag1 && BlockFalling.canFallThrough(this.world.getBlockState(new BlockPos(this.posX, this.posY - 0.009999999776482582, this.posZ)))) {
                  this.onGround = false;
                  return;
               }
               ...
               if (iblockstate.getBlock() != Blocks.PISTON_EXTENSION) {
                  ...
                  } else if (this.world.mayPlace(block, blockpos1, true, EnumFacing.UP, (Entity)null) && (flag1 || !BlockFalling.canFallThrough(this.world.getBlockState(blockpos1.down()))) && this.world.setBlockState(blockpos1, this.fallTile, 3)) {
                     if (block instanceof BlockFalling) {
   ...
   public void fall(float distance, float damageMultiplier) {
      ...
      if (this.hurtEntities) {
         ...
         if (i > 0) {
            List<Entity> list = Lists.newArrayList((Iterable)this.world.getEntitiesWithinAABBExcludingEntity(this, this.getEntityBoundingBox()));
