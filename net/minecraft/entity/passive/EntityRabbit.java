...
public class EntityRabbit extends EntityAnimal {
   ...
   protected void initEntityAI() {
      ...
      this.tasks.addTask(4, new AIAvoidEntity(this, EntityPlayer.class, 8.0F, 2.2, 2.2));
      this.tasks.addTask(4, new AIAvoidEntity(this, EntityWolf.class, 10.0F, 2.2, 2.2));
      this.tasks.addTask(4, new AIAvoidEntity(this, EntityMob.class, 4.0F, 2.2, 2.2));
