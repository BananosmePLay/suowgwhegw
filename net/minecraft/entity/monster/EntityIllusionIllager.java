   ...
   class AIBlindnessSpell extends EntitySpellcasterIllager.AIUseSpell {
      ...
      public boolean shouldExecute() {
         if (!super.shouldExecute()) {
            ...
            return EntityIllusionIllager.this.getAttackTarget().getEntityId() == this.lastTargetId ? false : EntityIllusionIllager.this.world.getDifficultyForLocation(new BlockPos(EntityIllusionIllager.this)).isHarderThan((float)EnumDifficulty.NORMAL.ordinal());
         }
      }
