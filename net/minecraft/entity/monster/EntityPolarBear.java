      ...
      public boolean shouldExecute() {
         if (EntityPolarBear.this.isChild()) {
            ...
            if (super.shouldExecute()) {
               Iterator var1 = EntityPolarBear.this.world.getEntitiesWithinAABB(EntityPolarBear.class, EntityPolarBear.this.getEntityBoundingBox().grow(8.0, 4.0, 8.0)).iterator();
