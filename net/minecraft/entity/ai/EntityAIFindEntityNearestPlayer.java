...
public class EntityAIFindEntityNearestPlayer extends EntityAIBase {
   ...
   public boolean shouldExecute() {
      ...
      List<EntityPlayer> list = this.entityLiving.world.getEntitiesWithinAABB(EntityPlayer.class, this.entityLiving.getEntityBoundingBox().grow(d0, 4.0, d0), this.predicate);
