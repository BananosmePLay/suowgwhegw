...
public abstract class EntityLivingBase extends Entity {
   ...
   private int getArmSwingAnimationEnd() {
      if (0bK.getInstance().moduleManager.getModule(0cw.class).isModuleState()) {
         int speed = (int)0cw.speed.value;
   ...
   public void travel(float strafe, float vertical, float forward) {
      ...
      d8 = this instanceof net.minecraft.entity.passive.EntityFlying ? this.posY - this.prevPosY : 0.0;
   ...
   public boolean canBePushed() {
      if (0bK.getInstance().moduleManager.getModule(0cr.class).isModuleState() && 0cr.players.value && this instanceof EntityPlayerSP) {
         return false;
      } else {
   ...
   static {
      SPRINTING_SPEED_BOOST = (new AttributeModifier(SPRINTING_SPEED_BOOST_ID, "Sprinting speed boost", 0.30000001192092896, 2)).setSaved(false);
