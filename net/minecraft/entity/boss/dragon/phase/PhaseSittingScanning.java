...
public class PhaseSittingScanning extends PhaseSittingBase {
   ...
   public void doLocalUpdate() {
      ++this.scanningTime;
      EntityLivingBase entitylivingbase = this.dragon.world.getNearestAttackablePlayer((Entity)this.dragon, 20.0, 10.0);
      if (entitylivingbase != null) {
         ...
         entitylivingbase = this.dragon.world.getNearestAttackablePlayer((Entity)this.dragon, 150.0, 150.0);
