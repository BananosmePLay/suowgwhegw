      ...
      static ICondition getOrAndCondition(JsonObject json) {
         ...
         if (set.isEmpty()) {
            ...
            if (json.has("OR")) {
               ...
               return (ICondition)(json.has("AND") ? new ConditionAnd(Iterables.transform(JsonUtils.getJsonArray(json, "AND"), FUNCTION_OR_AND)) : makePropertyValue((Map.Entry)set.iterator().next()));
            }
         } else {
