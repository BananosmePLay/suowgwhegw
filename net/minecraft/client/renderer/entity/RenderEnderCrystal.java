...
public class RenderEnderCrystal extends Render<EntityEnderCrystal> {
   ...
   public void doRender(EntityEnderCrystal entity, double x, double y, double z, float entityYaw, float partialTicks) {
      ...
      if (blockpos != null) {
         ...
         RenderDragon.renderCrystalBeams(x + d0, y - 0.3 + (double)(f1 * 0.4F) + d1, z + d2, partialTicks, (double)f2, (double)f3, (double)f4, entity.innerRotation, entity.posX, entity.posY, entity.posZ);
      }
   ...
   public boolean shouldRender(Entity var1, ICamera var2, double var3, double var5, double var7) {
      return this.shouldRender((EntityEnderCrystal)var1, var2, var3, var5, var7);
   }
}
