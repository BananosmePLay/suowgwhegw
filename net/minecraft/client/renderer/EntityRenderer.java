...
public class EntityRenderer implements IResourceManagerReloadListener {
   ...
   public void updateRenderer() {
      ...
      var10000 = this.mc;
      float f3 = (float)Minecraft.gameSettings.renderDistanceChunks / 16.0F;
   ...
   public void getMouseOver(float partialTicks) {
      ...
      if (entity != null && this.mc.world != null) {
         ...
         Vec3d vec3d3 = null;
         float f = 1.0F;
         List<Entity> list = this.mc.world.getEntitiesInAABBexcluding(entity, entity.getEntityBoundingBox().expand(vec3d1.x * d0, vec3d1.y * d0, vec3d1.z * d0).grow(1.0, 1.0, 1.0), Predicates.and(EntitySelectors.NOT_SPECTATING, new Predicate<Entity>() {
   ...
   private float getFOVModifier(float partialTicks, boolean useFOVSetting) {
      if (this.debugView) {
         ...
         if (useFOVSetting) {
            var10000 = this.mc;
            f = Minecraft.gameSettings.fovSetting;
         ...
         if (flag) {
            ...
            var10000 = this.mc;
            Minecraft.gameSettings.smoothCamera = Config.zoomSmoothCamera;
   ...
   private void hurtCameraEffect(float partialTicks) {
      if (!0bK.getInstance().moduleManager.getModule(0cx.class).isModuleState() || !0cx.noHurtCam.value) {
            ...
            if (Minecraft.gameSettings.debugCamEnable) {
               ...
               for(int i = 0; i < 8; ++i) {
                  ...
                  if (raytraceresult != null) {
                     ...
                     if ((!0bK.getInstance().moduleManager.getModule(0cx.class).isModuleState() || !0cx.cameraClip.value) && d7 < d3) {
                        d3 = d7;
                     }
                  }
               }
   ...
   public void setupCameraTransform(float partialTicks, int pass) {
      Minecraft var10001 = this.mc;
      this.farPlaneDistance = (float)(Minecraft.gameSettings.renderDistanceChunks * 16);
         ...
         if (p_renderHand_3_) {
            ...
            if (flag1) {
               ...
               if (Minecraft.gameSettings.thirdPersonView == 0 && !flag) {
                  var10000 = this.mc;
                  if (!Minecraft.gameSettings.hideGUI && !this.mc.playerController.isSpectator()) {
                     this.enableLightmap();
                     if (Config.isShaders()) {
      ...
      if (this.lightmapUpdateNeeded) {
         ...
         if (world != null) {
            if (Config.isCustomColors()) {
               ...
               if (CustomColors.updateLightmap(world, this.torchFlickerX, this.lightmapColors, Minecraft.player.isPotionActive(MobEffects.NIGHT_VISION), partialTicks)) {
            ...
            float f = ((World)world).getSunBrightness(1.0F);
            float f1 = f * 0.95F + 0.05F;
            int i;
            if (0bK.getInstance().moduleManager.getModule(0cz.class).isModuleState() && 0cz.worldColor.value) {
               i = 0cz.worldColors.getColorValue();
               int r = i >> 16 & 255;
               int g = i >> 8 & 255;
               int b = i & 255;
               int a = i >> 24 & 255;
               ...
               for(i = 0; i < 256; ++i) {
                  ...
                  if (((World)world).getLastLightningBolt() > 0) {
                  ...
                  var10000 = this.mc;
                  f16 = Minecraft.gameSettings.gammaSetting;
                  f17 = 1.0F - f8;
                  float f13 = 1.0F - f9;
                  float f14 = 1.0F - f10;
   ...
   public void updateCameraAndRender(float partialTicks, long nanoTime) {
      ...
      label115: {
         ...
         if (!flag) {
            ...
            if (Minecraft.gameSettings.pauseOnLostFocus) {
               var10000 = this.mc;
               if (!Minecraft.gameSettings.touchscreen || !Mouse.isButtonDown(1)) {
      ...
      if (this.mc.inGameHasFocus && flag) {
         ...
         if (Minecraft.gameSettings.smoothCamera) {
            ...
            var10000 = this.mc;
            Minecraft.player.turn(f2, f3 * (float)l1);
         } else {
            this.smoothCamYaw = 0.0F;
            this.smoothCamPitch = 0.0F;
            var10000 = this.mc;
      ...
      if (!this.mc.skipRenderWorld) {
         ...
         if (this.mc.world == null) {
            ...
            if (!Minecraft.gameSettings.hideGUI || this.mc.currentScreen != null) {
               ...
               var10000 = this.mc;
               if (Minecraft.gameSettings.ofShowFps) {
                  var10000 = this.mc;
   ...
   private void renderWorldPass(int pass, float partialTicks, long finishTimeNano) {
      ...
      if (Reflector.ActiveRenderInfo_updateRenderInfo2.exists()) {
         ReflectorMethod var10000 = Reflector.ActiveRenderInfo_updateRenderInfo2;
         Object[] var10001 = new Object[]{this.mc.getRenderViewEntity(), null};
         var10004 = this.mc;
         var10001[1] = Minecraft.gameSettings.thirdPersonView == 2;
         Reflector.call(var10000, var10001);
      } else {
         var19 = this.mc;
         Minecraft var21 = this.mc;
      ...
      Minecraft var10002 = this.mc;
      if (var20 < 128.0 + (double)(Minecraft.gameSettings.ofCloudsHeight * 128.0F)) {
      ...
      if (flag) {
         ...
         var10005 = this.mc;
         ShadersRender.setupTerrain(renderglobal, entity, var23, icamera, var10006, Minecraft.player.isSpectator());
      } else {
         var23 = (double)partialTicks;
         var10006 = this.frameCount++;
         var10005 = this.mc;
         renderglobal.setupTerrain(entity, var23, icamera, var10006, Minecraft.player.isSpectator());
      }
      ...
      ITextureObject var22 = this.mc.getTextureManager().getTexture(TextureMap.LOCATION_BLOCKS_TEXTURE);
      var10002 = this.mc;
      var22.setBlurMipmap(false, Minecraft.gameSettings.mipmapLevels > 0);
   ...
   private void renderCloudsCheck(RenderGlobal renderGlobalIn, float partialTicks, int pass, double x, double y, double z) {
      ...
      if (Minecraft.gameSettings.renderDistanceChunks >= 4 && !Config.isCloudsOff()) {
         var10000 = this.mc;
         if (Shaders.shouldRenderClouds(Minecraft.gameSettings)) {
   ...
   private void addRainParticles() {
      ...
      if (f != 0.0F && Config.isRainSplash()) {
         ...
         for(int l = 0; l < k; ++l) {
            BlockPos blockpos1 = ((World)world).getPrecipitationHeight(blockpos.add(this.random.nextInt(10) - this.random.nextInt(10), 0, this.random.nextInt(10) - this.random.nextInt(10)));
            Biome biome = ((World)world).getBiome(blockpos1);
            BlockPos blockpos2 = blockpos1.down();
            IBlockState iblockstate = ((World)world).getBlockState(blockpos2);
         ...
         if (j > 0 && this.random.nextInt(3) < this.rainSoundCounter++) {
            ...
            if (d1 > (double)(blockpos.getY() + 1) && ((World)world).getPrecipitationHeight(blockpos).getY() > MathHelper.floor((float)blockpos.getY())) {
   ...
   protected void renderRainSnow(float partialTicks) {
      ...
      double d11;
      double d12;
      if (0bK.getInstance().moduleManager.getModule(0cz.class).isModuleState() && 0cz.snow.value) {
         int hexColor = 0cz.weatherColor.getColorValue();
         ...
         if (f > 0.0F) {
            ...
            for(int k1 = k - i1; k1 <= k + i1; ++k1) {
               for(int l1 = i - i1; l1 <= i + i1; ++l1) {
                  ...
                  boolean check = 0bK.getInstance().moduleManager.getModule(0cz.class).isModuleState() && 0cz.snow.value ? true : biome.canRain() || biome.getEnableSnow();
                  if (check) {
                     int j2 = worldClient.getPrecipitationHeight(blockpos$mutableblockpos).getY();
                     int k2 = j - i1;
                     int l2 = j + i1;
                     if (k2 < j2) {
                        k2 = j2;
                     ...
                     if (k2 != l2) {
                        ...
                        d11 = (double)(-((float)(this.rendererUpdateCount & 511) + partialTicks) / 512.0F);
                        d12 = this.random.nextDouble() + (double)f1 * 0.01 * (double)((float)this.random.nextGaussian());
                        ...
                        int j4 = i4 >> 16 & '\uffff';
                        int k4 = i4 & '\uffff';
                        bufferbuilder.pos((double)l1 - d3 + 0.5, (double)l2, (double)k1 - d4 + 0.5).tex(0.0 + d12, (double)k2 * 0.25 + d11 + d10).color(red, green, blue, f5).lightmap(j4, k4).endVertex();
                        bufferbuilder.pos((double)l1 + d3 + 0.5, (double)l2, (double)k1 + d4 + 0.5).tex(1.0 + d12, (double)k2 * 0.25 + d11 + d10).color(red, green, blue, f5).lightmap(j4, k4).endVertex();
                        bufferbuilder.pos((double)l1 + d3 + 0.5, (double)k2, (double)k1 + d4 + 0.5).tex(1.0 + d12, (double)l2 * 0.25 + d11 + d10).color(red, green, blue, f5).lightmap(j4, k4).endVertex();
                        bufferbuilder.pos((double)l1 - d3 + 0.5, (double)k2, (double)k1 - d4 + 0.5).tex(0.0 + d12, (double)l2 * 0.25 + d11 + d10).color(red, green, blue, f5).lightmap(j4, k4).endVertex();
                     }
                  }
               }
            }
                  ...
                  if (biome.canRain() || biome.getEnableSnow()) {
                     ...
                     if (k2 != l2) {
                        ...
                        if (worldClient.getBiomeProvider().getTemperatureAtHeight(f1, j2) >= 0.15F) {
                           ...
                           d5 = (double)(-((float)(this.rendererUpdateCount + l1 * l1 * 3121 + l1 * 45238971 + k1 * k1 * 418711 + k1 * 13761 & 31) + partialTicks)) / 32.0 * (3.0 + this.random.nextDouble());
                           ...
                           blockpos$mutableblockpos.setPos(l1, i3, k1);
                           int j3 = worldClient.getCombinedLight(blockpos$mutableblockpos, 0);
                           int k3 = j3 >> 16 & '\uffff';
                           int l3 = j3 & '\uffff';
                           ...
                           d11 = (double)((float)l1 + 0.5F) - entity.posX;
                           d12 = (double)((float)k1 + 0.5F) - entity.posZ;
                           float f6 = MathHelper.sqrt(d11 * d11 + d12 * d12) / (float)i1;
                           float f4 = ((1.0F - f6 * f6) * 0.3F + 0.5F) * f5;
                           blockpos$mutableblockpos.setPos(l1, i3, k1);
                           int i4 = (worldClient.getCombinedLight(blockpos$mutableblockpos, 0) * 3 + 15728880) / 4;
                           int j4 = i4 >> 16 & '\uffff';
                           int k4 = i4 & '\uffff';
   ...
   private void updateFogColor(float partialTicks) {
      ...
      Entity entity = this.mc.getRenderViewEntity();
      Minecraft var10002 = this.mc;
      float f = 0.25F + 0.75F * (float)Minecraft.gameSettings.renderDistanceChunks / 32.0F;
      f = 1.0F - (float)Math.pow((double)f, 0.25);
      Vec3d vec3d = ((World)world).getSkyColor(this.mc.getRenderViewEntity(), partialTicks);
      ...
      Vec3d vec3d1 = ((World)world).getFogColor(partialTicks);
      ...
      if (Minecraft.gameSettings.renderDistanceChunks >= 4) {
         double d0 = MathHelper.sin(((World)world).getCelestialAngleRadians(partialTicks)) > 0.0F ? -1.0 : 1.0;
         ...
         if (f12 > 0.0F) {
            float[] afloat = world.provider.calcSunriseSunsetColors(((World)world).getCelestialAngle(partialTicks), partialTicks);
            if (afloat != null) {
               f12 *= afloat[3];
      ...
      float f8 = ((World)world).getRainStrength(partialTicks);
      float f9;
      float f11;
      if (f8 > 0.0F) {
         f9 = 1.0F - f8 * 0.5F;
      ...
      f9 = ((World)world).getThunderStrength(partialTicks);
      if (f9 > 0.0F) {
         f11 = 1.0F - f9 * 0.5F;
      ...
      Vec3d vec3d7;
      if (this.cloudFog) {
         vec3d7 = ((World)world).getCloudColour(partialTicks);
         ...
         vec3d7 = ActiveRenderInfo.projectViewFromEntity(entity, (double)partialTicks);
      ...
      if (iblockstate1.getMaterial() == Material.WATER) {
         vec3d7 = CustomColors.getUnderwaterColor(this.mc.world, this.mc.getRenderViewEntity().posX, this.mc.getRenderViewEntity().posY + 1.0, this.mc.getRenderViewEntity().posZ);
         if (vec3d7 != null) {
            this.fogColorRed = (float)vec3d7.x;
            this.fogColorGreen = (float)vec3d7.y;
            this.fogColorBlue = (float)vec3d7.z;
         ...
         vec3d7 = CustomColors.getUnderlavaColor(this.mc.world, this.mc.getRenderViewEntity().posX, this.mc.getRenderViewEntity().posY + 1.0, this.mc.getRenderViewEntity().posZ);
         if (vec3d7 != null) {
            this.fogColorRed = (float)vec3d7.x;
            this.fogColorGreen = (float)vec3d7.y;
            this.fogColorBlue = (float)vec3d7.z;
   ...
   private void frameInit() {
      ...
      if (this.mc.currentScreen instanceof 0bE) {
         this.updateMainMenu((0bE)this.mc.currentScreen);
      }
   ...
   private void updateMainMenu(0bE p_updateMainMenu_1_) {
      try {
         String s = null;
   ...
   private void checkLoadVisibleChunks(Entity p_checkLoadVisibleChunks_1_, float p_checkLoadVisibleChunks_2_, ICamera p_checkLoadVisibleChunks_3_, boolean p_checkLoadVisibleChunks_4_) {
      ...
      if (Keyboard.isKeyDown(61) && Keyboard.isKeyDown(38)) {
         Minecraft var10000 = this.mc;
         if (Minecraft.gameSettings.keyBindAdvancements.getKeyCode() == 38) {
   ...
   private void loadAllVisibleChunks(Entity p_loadAllVisibleChunks_1_, double p_loadAllVisibleChunks_2_, ICamera p_loadAllVisibleChunks_4_, boolean p_loadAllVisibleChunks_5_) {
      Minecraft var10000 = this.mc;
      int i = Minecraft.gameSettings.ofChunkUpdates;
      var10000 = this.mc;
      boolean flag = Minecraft.gameSettings.ofLazyChunkLoading;

      try {
         var10000 = this.mc;
         Minecraft.gameSettings.ofChunkUpdates = 1000;
         var10000 = this.mc;
         Minecraft.gameSettings.ofLazyChunkLoading = false;
         ...
         var10000 = this.mc;
         Minecraft.gameSettings.ofChunkUpdates = i;
         var10000 = this.mc;
         Minecraft.gameSettings.ofLazyChunkLoading = flag;
      }
   ...
   public void displayItemActivation(ItemStack stack) {
      if (!0bK.getInstance().moduleManager.getModule(0cx.class).isModuleState() || !0cx.antiTotem.value) {
