...
public class EntityPlayerSP extends AbstractClientPlayer {
   ...
   public void onUpdate() {
      if (this.world.isBlockLoaded(new BlockPos(this.posX, 0.0, this.posZ))) {
         ...
         if (this.isRiding()) {
            ...
            if (!0bK.getInstance().moduleManager.getModule(0cq.class).isModuleState()) {
   ...
   private void onUpdateWalkingPlayer() {
      if (!0bK.getInstance().moduleManager.getModule(0cq.class).isModuleState()) {
         0x event = new 0x(this.rotationYaw, this.rotationPitch, this.posX, this.posY, this.posZ, this.onGround);
         0m.call(event);
         if (!event.isCanceled()) {
            boolean flag = this.isSprinting();
            0E eventPreRotation = new 0E(this.posX, this.posY, this.posZ, this.rotationYaw, this.rotationPitch, this.onGround);
            0m.call(eventPreRotation);
            0G eventPre = new 0G(this.rotationYaw, this.rotationPitch, this.posX, this.posY, this.posZ, this.onGround);
            0m.call(eventPre);
            new 0F(this.rotationYaw, this.rotationPitch);
   ...
   protected boolean pushOutOfBlocks(double x, double y, double z) {
      if ((!0bK.getInstance().moduleManager.getModule(0cr.class).isModuleState() || !0cr.blocks.value) && !0bK.getInstance().moduleManager.getModule(0cq.class).isModuleState()) {
         if (this.noClip) {
            return false;
         } else {
   ...
   public void onLivingUpdate() {
      ...
      if (this.isHandActive() && !this.isRiding()) {
         0D event = new 0D(0.20000000298023224, 0.20000000298023224);
         0m.call(event);
      ...
      if (!this.isSprinting() && this.movementInput.moveForward >= 0.8F && flag4 && !this.isHandActive() && !this.isPotionActive(MobEffects.BLINDNESS) && Minecraft.gameSettings.keyBindSprint.isKeyDown()) {
         this.setSprinting(true);
      }
