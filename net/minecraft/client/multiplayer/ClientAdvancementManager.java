...
public class ClientAdvancementManager {
   ...
   public void read(SPacketAdvancementInfo packetIn) {
      ...
      while(var2.hasNext()) {
         Map.Entry<ResourceLocation, AdvancementProgress> entry = (Map.Entry)var2.next();
         Advancement advancement = this.advancementList.getAdvancement((ResourceLocation)entry.getKey());
         if (advancement != null) {
   ...
   public void setListener(@Nullable IListener listenerIn) {
      ...
      if (listenerIn != null) {
         ...
         while(var2.hasNext()) {
            ...
            listenerIn.onUpdateAdvancementProgress((Advancement)entry.getKey(), (AdvancementProgress)entry.getValue());
         }
   ...
   public interface IListener extends AdvancementList.Listener {
      ...
      void setSelectedTab(Advancement var1);
   }
}
