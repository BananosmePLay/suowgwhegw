...
public class GuiCustomizeSkin extends GuiScreen {
   ...
   public void initGui() {
      ...
      Minecraft var10007 = this.mc;
      this.buttonList.add(new GuiOptionButton(199, var10004, var10005, GameSettings.Options.MAIN_HAND, Minecraft.gameSettings.getKeyBinding(GameSettings.Options.MAIN_HAND)));
      ++i;
      if (i % 2 == 1) {
         ++i;
      }
   ...
   protected void actionPerformed(GuiButton button) throws IOException {
      if (button.enabled) {
         ...
         if (button.id == 200) {
            ...
            button.displayString = Minecraft.gameSettings.getKeyBinding(GameSettings.Options.MAIN_HAND);
            var10000 = this.mc;
