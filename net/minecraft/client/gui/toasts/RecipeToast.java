...
public class RecipeToast implements IToast {
   ...
   public IToast.Visibility draw(GuiToast toastGui, long delta) {
      ...
      if (this.recipesOutputs.isEmpty()) {
         ...
         toastGui.getMinecraft().getRenderItem().renderItemAndEffectIntoGUI((EntityLivingBase)null, (ItemStack)this.recipesOutputs.get((int)(delta / (5000L / (long)this.recipesOutputs.size()) % (long)this.recipesOutputs.size())), 8, 8);
