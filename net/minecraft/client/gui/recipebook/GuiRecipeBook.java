...
public class GuiRecipeBook extends Gui implements IRecipeUpdateListener {
   ...
   public GuiRecipeBook() {
      this.recipeTabs = Lists.newArrayList((Object[])(new GuiButtonRecipeTab(0, CreativeTabs.SEARCH), new GuiButtonRecipeTab(0, CreativeTabs.TOOLS), new GuiButtonRecipeTab(0, CreativeTabs.BUILDING_BLOCKS), new GuiButtonRecipeTab(0, CreativeTabs.MISC), new GuiButtonRecipeTab(0, CreativeTabs.REDSTONE)));
      this.lastSearch = "";
   ...
   public void func_194303_a(int p_194303_1_, int p_194303_2_, Minecraft p_194303_3_, boolean p_194303_4_, InventoryCrafting p_194303_5_) {
      ...
      this.currentTab = (GuiButtonRecipeTab)this.recipeTabs.get(0);
   ...
   private void updateCollections(boolean p_193003_1_) {
      ...
      List<RecipeList> list1 = Lists.newArrayList((Iterable)list);
   ...
   public void tick() {
      if (this.isVisible()) {
         ...
         if (this.timesInventoryChanged != Minecraft.player.inventory.getTimesChanged()) {
            this.updateStackedContents();
            var10001 = this.mc;
            this.timesInventoryChanged = Minecraft.player.inventory.getTimesChanged();
         }
         ...
         if (!Minecraft.player.isSpectator()) {
            if (this.recipeBookPage.mouseClicked(p_191862_1_, p_191862_2_, p_191862_3_, (this.width - 147) / 2 - this.xOffset, (this.height - 166) / 2, 147, 166)) {
               ...
               if (irecipe != null && recipelist != null) {
                  ...
                  this.ghostRecipe.clear();
                  PlayerControllerMP var9 = this.mc.playerController;
                  Minecraft var10001 = this.mc;
   ...
   public boolean keyPressed(char typedChar, int keycode) {
      if (this.isVisible()) {
         ...
         if (!Minecraft.player.isSpectator()) {
            ...
            var10000 = this.mc;
            if (GameSettings.isKeyDown(Minecraft.gameSettings.keyBindChat) && !this.searchBar.isFocused()) {
   ...
   private void pirateRecipe(String text) {
      if ("excitedze".equals(text)) {
         ...
         label17: {
            ...
            var10000 = this.mc;
            Minecraft.gameSettings.language = language.getLanguageCode();
            this.mc.refreshResources();
            var4 = this.mc.fontRenderer;
            if (!this.mc.getLanguageManager().isCurrentLocaleUnicode()) {
               Minecraft var10001 = this.mc;
               if (!Minecraft.gameSettings.forceUnicodeFont) {
                  var5 = false;
                  break label17;
               }
            }
