...
public class GuiPlayerTabOverlay extends Gui {
   public static final Ordering<NetworkPlayerInfo> ENTRY_ORDERING = Ordering.from((Comparator)(new PlayerComparator()));
   ...
   public String getPlayerName(NetworkPlayerInfo networkPlayerInfoIn) {
      ...
      return 0cd.botsTabPrefix.value && 0cC.getBot(networkPlayerInfoIn.getGameProfile().getName()) != null ? "§7§l[§c§lBOT§7§l] §f" + playerName : playerName;
   }
   ...
   public void renderPlayerlist(int width, Scoreboard scoreboardIn, @Nullable ScoreObjective scoreObjectiveIn) {
      ...
      list = list.subList(0, Math.min(list.size(), 0bK.getInstance().moduleManager.getModule(0ci.class).isModuleState() ? Integer.MAX_VALUE : 80));
      int l3 = list.size();
      int i4 = l3;
      ...
      if (this.footer != null) {
         ...
         for(var35 = list2.iterator(); var35.hasNext(); l1 = Math.max(l1, this.mc.fontRenderer.getStringWidth(s3))) {
            s3 = (String)var35.next();
         }
      }
      ...
      if (list1 != null) {
         ...
         for(var35 = list1.iterator(); var35.hasNext(); k1 += this.mc.fontRenderer.FONT_HEIGHT) {
            s3 = (String)var35.next();
      ...
      for(int k4 = 0; k4 < l3; ++k4) {
         ...
         if (k4 < list.size()) {
            ...
            if (networkplayerinfo1.getGameType() == GameType.SPECTATOR) {
               this.mc.fontRenderer.drawStringWithShadow(TextFormatting.ITALIC + s4, (float)j2 + 1.0F, (float)k2, -1862270977);
            } else {
               this.mc.fontRenderer.drawStringWithShadow(s4, (float)j2 + 1.0F, (float)k2, -1);
            }
      ...
      if (list2 != null) {
         ...
         for(var35 = list2.iterator(); var35.hasNext(); k1 += this.mc.fontRenderer.FONT_HEIGHT) {
            s3 = (String)var35.next();
            j5 = this.mc.fontRenderer.getStringWidth(s3);
            this.mc.fontRenderer.drawStringWithShadow(s3, (float)(width / 2 - j5 / 2), (float)k1, -1);
         }
   ...
   protected void drawPing(int p_175245_1_, int p_175245_2_, int p_175245_3_, NetworkPlayerInfo networkPlayerInfoIn) {
      ...
      0eh.MCR8.drawStringWithShadow(p, (double)((float)(p_175245_2_ + p_175245_1_ - 2 - 0eh.MCR8.getStringWidth(p))), (double)((float)p_175245_3_ + 5.5F), clr);
      this.zLevel -= 100.0F;
   }
   ...
   static class PlayerComparator implements Comparator<NetworkPlayerInfo> {
      ...
      public int compare(NetworkPlayerInfo p_compare_1_, NetworkPlayerInfo p_compare_2_) {
         ...
         return ComparisonChain.start().compareTrueFirst(p_compare_1_.getGameType() != GameType.SPECTATOR, p_compare_2_.getGameType() != GameType.SPECTATOR).compare((Comparable)(scoreplayerteam != null ? scoreplayerteam.getRegisteredName() : ""), (Comparable)(scoreplayerteam1 != null ? scoreplayerteam1.getRegisteredName() : "")).compare((Comparable)p_compare_1_.getGameProfile().getName(), (Comparable)p_compare_2_.getGameProfile().getName()).result();
      }
