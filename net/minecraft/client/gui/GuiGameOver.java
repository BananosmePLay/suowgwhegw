...
public class GuiGameOver extends GuiScreen {
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      StringBuilder var10002 = (new StringBuilder()).append(I18n.format("deathScreen.score")).append(": ").append(TextFormatting.YELLOW);
      Minecraft var10003 = this.mc;
      this.drawCenteredString(var10001, var10002.append(Minecraft.player.getScore()).toString(), this.width / 2, 100, 16777215);
