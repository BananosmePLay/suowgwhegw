      ...
      if (this.buttonsNotDrawn && i >= 0) {
         ...
         for(int k = 0; k <= 2; ++k) {
            ...
            for(j2 = 0; j2 < l1; ++j2) {
               ...
               guibeacon$powerbutton2 = new PowerButton(j++, this.guiLeft + 76 + j2 * 24 - i2 / 2, this.guiTop + 22 + k * 25, potion3, k);
         ...
         for(j2 = 0; j2 < l1 - 1; ++j2) {
            ...
            guibeacon$powerbutton2 = new PowerButton(j++, this.guiLeft + 167 + j2 * 24 - i2 / 2, this.guiTop + 47, potion3, 3);
            this.buttonList.add(guibeacon$powerbutton2);
            if (3 >= i) {
               guibeacon$powerbutton2.enabled = false;
