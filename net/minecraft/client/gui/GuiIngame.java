...
public class GuiIngame extends Gui {
   ...
   public GuiIngame(Minecraft mcIn) {
      ...
      ((List)this.chatListeners.get(ChatType.CHAT)).add(new NormalChatListener(mcIn));
      ((List)this.chatListeners.get(ChatType.CHAT)).add(ichatlistener);
      ((List)this.chatListeners.get(ChatType.SYSTEM)).add(new NormalChatListener(mcIn));
      ((List)this.chatListeners.get(ChatType.SYSTEM)).add(ichatlistener);
      ((List)this.chatListeners.get(ChatType.GAME_INFO)).add(new OverlayChatListener(mcIn));
   ...
   public void renderGameOverlay(float partialTicks) {
      ...
      var10000 = this.mc;
      if (Minecraft.gameSettings.thirdPersonView == 0 && itemstack.getItem() == Item.getItemFromBlock(Blocks.PUMPKIN)) {
      ...
      0m.call(new 0P(scaledresolution));
      ...
      var10000 = this.mc;
      if (Minecraft.gameSettings.heldItemTooltips && !this.mc.playerController.isSpectator()) {
   ...
   private void renderAttackIndicator(float partialTicks, ScaledResolution p_184045_2_) {
      ...
      if (gamesettings.thirdPersonView == 0) {
         ...
         GlStateManager.enableAlpha();
         if (!0bK.getInstance().moduleManager.getModule(0cu.class).isModuleState()) {
