   ...
   public void renderSubtitles(ScaledResolution resolution) {
      label58: {
         ...
         if (!this.enabled) {
            ...
            if (Minecraft.gameSettings.showSubtitles) {
      ...
      if (this.enabled && !this.subtitles.isEmpty()) {
         ...
         double var29 = Minecraft.player.posY + (double)Minecraft.player.getEyeHeight();
         var10004 = this.client;
         Vec3d vec3d = new Vec3d(var28, var29, Minecraft.player.posZ);
         Vec3d var27 = new Vec3d(0.0, 0.0, -1.0);
         Minecraft var10001 = this.client;
         var27 = var27.rotatePitch(-Minecraft.player.rotationPitch * 0.017453292F);
         var10001 = this.client;
         Vec3d vec3d1 = var27.rotateYaw(-Minecraft.player.rotationYaw * 0.017453292F);
         var27 = new Vec3d(0.0, 1.0, 0.0);
         var10001 = this.client;
         var27 = var27.rotatePitch(-Minecraft.player.rotationPitch * 0.017453292F);
         var10001 = this.client;
         Vec3d vec3d2 = var27.rotateYaw(-Minecraft.player.rotationYaw * 0.017453292F);
         ...
         while(iterator.hasNext()) {
            Subtitle guisubtitleoverlay$subtitle = (Subtitle)iterator.next();
         ...
         for(Iterator var26 = this.subtitles.iterator(); var26.hasNext(); ++i) {
            Subtitle guisubtitleoverlay$subtitle1 = (Subtitle)var26.next();
            int k = true;
            ...
            int l1 = MathHelper.floor(MathHelper.clampedLerp(255.0, 75.0, (double)((float)(Minecraft.getSystemTime() - guisubtitleoverlay$subtitle1.getStartTime()) / 3000.0F)));
   ...
   public void soundPlay(ISound soundIn, SoundEventAccessor accessor) {
      if (accessor.getSubtitle() != null) {
         ...
         if (!this.subtitles.isEmpty()) {
            ...
            while(var4.hasNext()) {
               Subtitle guisubtitleoverlay$subtitle = (Subtitle)var4.next();
