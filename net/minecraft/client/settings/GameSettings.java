...
public class GameSettings {
      ...
      try {
         ...
         while(var4.hasNext()) {
            ...
            try {
               ...
               KeyBinding[] var24 = this.keyBindings;
               int var8 = var24.length;

               int var9;
               for(var9 = 0; var9 < var8; ++var9) {
                  KeyBinding keybinding = var24[var9];
               ...
               EnumPlayerModelParts[] var26 = EnumPlayerModelParts.values();
               var8 = var26.length;

               for(var9 = 0; var9 < var8; ++var9) {
                  EnumPlayerModelParts enumplayermodelparts = var26[var9];
   ...
   public void saveOptions() {
      ...
      try {
         ...
         KeyBinding[] var15 = this.keyBindings;
         int var3 = var15.length;

         int var4;
         for(var4 = 0; var4 < var3; ++var4) {
            KeyBinding keybinding = var15[var4];
         ...
         for(var4 = 0; var4 < var3; ++var4) {
            EnumPlayerModelParts enumplayermodelparts = var17[var4];
