...
public class TileEntityBeacon extends TileEntityLockable implements ITickable, ISidedInventory {
   ...
   private void updateSegmentColors() {
      ...
      if (!this.world.isRemote && l < this.levels) {
         Iterator var14 = this.world.getEntitiesWithinAABB(EntityPlayerMP.class, (new AxisAlignedBB((double)i, (double)j, (double)k, (double)i, (double)(j - 4), (double)k)).grow(10.0, 5.0, 10.0)).iterator();
