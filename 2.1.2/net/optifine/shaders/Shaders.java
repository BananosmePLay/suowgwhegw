...
public class Shaders {
      ...
      if (activeProgram != program) {
         ...
         if (i != 0) {
            ...
            if (Minecraft.player != null) {
               var10000 = mc;
               var13 = Minecraft.player.getHeldItemMainhand();
            } else {
               var13 = null;
            }

            ItemStack itemstack = var13;
            Item item = itemstack != null ? itemstack.getItem() : null;
            int j = -1;
            Block block = null;
            if (item != null) {
               j = Item.REGISTRY.getIDForObject(item);
               block = (Block)Block.REGISTRY.getObjectById(j);
            ...
            if (Minecraft.player != null) {
               var10000 = mc;
               var13 = Minecraft.player.getHeldItemOffhand();
            } else {
               var13 = null;
            }

            ItemStack itemstack1 = var13;
            Item item1 = itemstack1 != null ? itemstack1.getItem() : null;
            int l = -1;
            Block block1 = null;
            if (item1 != null) {
               l = Item.REGISTRY.getIDForObject(item1);
               block1 = (Block)Block.REGISTRY.getObjectById(l);
            ...
            setProgramUniform1f(uniform_far, (float)(Minecraft.gameSettings.renderDistanceChunks * 16));
            ...
            var10001 = mc;
            setProgramUniform1f(uniform_screenBrightness, Minecraft.gameSettings.gammaSetting);
            var10001 = mc;
            setProgramUniform1i(uniform_hideGUI, Minecraft.gameSettings.hideGUI ? 1 : 0);
   ...
   private static void loadEntityDataMap() {
      ...
      if (mapBlockToEntityData.isEmpty()) {
         Iterator var0 = Block.REGISTRY.getKeys().iterator();
   ...
   public static void drawHorizon() {
      ...
      Minecraft var10000 = mc;
      float f = (float)(Minecraft.gameSettings.renderDistanceChunks * 16);
   ...
   public static void pushEntity(Block block) {
      ...
      entityData[entityDataIndex * 2] = Block.REGISTRY.getIDForObject(block) & '\uffff' | i << 16;
      entityData[entityDataIndex * 2 + 1] = 0;
   }
