...
public class Reflector {
   ...
   static {
      ...
      FMLClientHandler_refreshResources = new ReflectorMethod(FMLClientHandler, "refreshResources", new Class[]{IResourceType[].class});
      ...
      ActiveRenderInfo = new ReflectorClass(ActiveRenderInfo.class);
      ActiveRenderInfo_getCameraPosition = new ReflectorMethod(ActiveRenderInfo, "getCameraPosition");
      ActiveRenderInfo_updateRenderInfo2 = new ReflectorMethod(ActiveRenderInfo, "updateRenderInfo", new Class[]{Entity.class, Boolean.TYPE});
      ...
      ForgeBiomeSpawnListEntry = new ReflectorClass(Biome.SpawnListEntry.class);
      ...
      ForgeIBakedModel = new ReflectorClass(IBakedModel.class);
      ForgeIBakedModel_isAmbientOcclusion2 = new ReflectorMethod(ForgeIBakedModel, "isAmbientOcclusion", new Class[]{IBlockState.class});
      ...
      ForgeEntityList = new ReflectorClass(EntityList.class);
      ForgeEntityList_getClass = new ReflectorMethod(ForgeEntityList, "getClass", new Class[]{ResourceLocation.class});
      ForgeEntityList_getID = new ReflectorMethod(ForgeEntityList, "getID", new Class[]{Class.class});
      ForgeEventFactory = new ReflectorClass("net.minecraftforge.event.ForgeEventFactory");
      ForgeEventFactory_canEntitySpawn = new ReflectorMethod(ForgeEventFactory, "canEntitySpawn", new Class[]{EntityLiving.class, World.class, Float.TYPE, Float.TYPE, Float.TYPE, Boolean.TYPE});
      ...
      ForgeHooksClient_applyTransform_MR = new ReflectorMethod(ForgeHooksClient, "applyTransform", new Class[]{ModelRotation.class, Optional.class});
      ...
      ForgeHooksClient_renderLitItem = new ReflectorMethod(ForgeHooksClient, "renderLitItem");
      ...
      ForgeModContainer_allowEmissiveItems = new ReflectorField(ForgeModContainer, "allowEmissiveItems");
      ...
      ForgePotion_renderHUDEffect = ForgePotion.makeMethod("renderHUDEffect", new Class[]{PotionEffect.class, Gui.class, Integer.TYPE, Integer.TYPE, Float.TYPE, Float.TYPE});
      ...
      IForgeRegistryEntry_Impl = new ReflectorClass("net.minecraftforge.registries.IForgeRegistryEntry$Impl");
      IForgeRegistryEntry_Impl_getRegistryName = new ReflectorMethod(IForgeRegistryEntry_Impl, "getRegistryName");
      ...
      VanillaResourceType = new ReflectorClass("net.minecraftforge.client.resource.VanillaResourceType");
      VanillaResourceType_TEXTURES = new ReflectorField(VanillaResourceType, "TEXTURES");
      ...
      GuiMainMenu = new ReflectorClass(0bE.class);
      GuiMainMenu_splashText = new ReflectorField(GuiMainMenu, String.class);
      GuiShulkerBox = new ReflectorClass(GuiShulkerBox.class);
      GuiShulkerBox_inventory = new ReflectorField(GuiShulkerBox, IInventory.class);
      ...
      ModelParrot = new ReflectorClass(ModelParrot.class);
      ModelParrot_ModelRenderers = new ReflectorFields(ModelParrot, ModelRenderer.class, 11);
      ...
      TileEntityBedRenderer = new ReflectorClass(TileEntityBedRenderer.class);
      TileEntityBedRenderer_model = new ReflectorField(TileEntityBedRenderer, ModelBed.class);
      ...
      TileEntityLockableLoot = new ReflectorClass(TileEntityLockableLoot.class);
