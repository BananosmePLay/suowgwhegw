...
public class ItemMonsterPlacer extends Item {
   ...
   public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
      ...
      if (worldIn.isRemote) {
         ...
         Entity entity = spawnCreature(worldIn, getNamedIdFrom(itemstack), (double)blockpos.getX() + 0.5, (double)blockpos.getY() + d0, (double)blockpos.getZ() + 0.5);
         if (entity != null) {
      ...
      if (worldIn.isRemote) {
         ...
         if (raytraceresult != null && raytraceresult.typeOfHit == RayTraceResult.Type.BLOCK) {
            ...
            if (!(worldIn.getBlockState(blockpos).getBlock() instanceof BlockLiquid)) {
               ...
               Entity entity = spawnCreature(worldIn, getNamedIdFrom(itemstack), (double)blockpos.getX() + 0.5, (double)blockpos.getY() + 0.5, (double)blockpos.getZ() + 0.5);
               if (entity == null) {
                  return new ActionResult(EnumActionResult.PASS, itemstack);
               } else {
                  if (entity instanceof EntityLivingBase && itemstack.hasDisplayName()) {
