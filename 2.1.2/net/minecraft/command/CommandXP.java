      ...
      if (args.length <= 0) {
         ...
         if (flag) {
            ...
            if (flag1) {
               ...
               notifyCommandListener(sender, this, "commands.xp.success.negative.levels", new Object[]{i, ((EntityPlayer)entityplayer).getName()});
            } else {
               ((EntityPlayer)entityplayer).addExperienceLevel(i);
               notifyCommandListener(sender, this, "commands.xp.success.levels", new Object[]{i, ((EntityPlayer)entityplayer).getName()});
            }
         } else {
            ...
            ((EntityPlayer)entityplayer).addExperience(i);
            notifyCommandListener(sender, this, "commands.xp.success", new Object[]{i, ((EntityPlayer)entityplayer).getName()});
         }
