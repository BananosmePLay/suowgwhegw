...
public class CommandScoreboard extends CommandBase {
   ...
   private boolean handleUserWildcards(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
      ...
      if (i < 0) {
         ...
         List<String> list1 = Lists.newArrayList((Iterable)this.getScoreboard(server).getObjectiveNames());
         String s = args[i];
         ...
         while(var8.hasNext()) {
            ...
            try {
               ...
               CommandException commandexception = var12;
   ...
   protected void emptyTeam(ICommandSender sender, String[] args, int startIndex, MinecraftServer server) throws CommandException {
      ...
      ScorePlayerTeam scoreplayerteam = this.convertToTeam(args[startIndex], server);
      if (scoreplayerteam != null) {
         Collection<String> collection = Lists.newArrayList((Iterable)scoreplayerteam.getMembershipCollection());
      ...
      if (s1.length() > 40) {
         ...
         if (args.length > startIndex) {
            ...
            try {
               ...
               NBTException nbtexception = var13;
      ...
      if ("list".equals(s1)) {
         ...
         if (args.length > startIndex) {
            try {
               ...
               NBTException nbtexception = var12;
