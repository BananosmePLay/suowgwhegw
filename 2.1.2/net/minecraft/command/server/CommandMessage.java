   ...
   public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
      if (args.length < 2) {
         ...
         if (entityplayer == sender) {
            ...
            TextComponentTranslation textcomponenttranslation1 = new TextComponentTranslation("commands.message.display.outgoing", new Object[]{((EntityPlayer)entityplayer).getDisplayName(), itextcomponent.createCopy()});
            ...
            ((EntityPlayer)entityplayer).sendMessage(textcomponenttranslation);
