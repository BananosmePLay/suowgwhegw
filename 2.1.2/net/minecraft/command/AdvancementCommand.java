...
public class AdvancementCommand extends CommandBase {
   ...
   public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
      if (args.length < 1) {
         ...
         ActionType advancementcommand$actiontype = AdvancementCommand.ActionType.byName(args[0]);
         if (advancementcommand$actiontype != null) {
            ...
            Mode advancementcommand$mode = AdvancementCommand.Mode.byName(args[2]);
   ...
   static enum Mode {
      ...
      static Mode byName(String nameIn) {
         ...
         for(int var3 = 0; var3 < var2; ++var3) {
            Mode advancementcommand$mode = var1[var3];
   ...
   static enum ActionType {
      ...
      static ActionType byName(String nameIn) {
         ActionType[] var1 = values();
         int var2 = var1.length;

         for(int var3 = 0; var3 < var2; ++var3) {
            ActionType advancementcommand$actiontype = var1[var3];
