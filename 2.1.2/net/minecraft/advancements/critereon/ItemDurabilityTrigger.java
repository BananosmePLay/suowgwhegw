...
public class ItemDurabilityTrigger implements ICriterionTrigger<Instance> {
   ...
   public void addListener(PlayerAdvancements playerAdvancementsIn, ICriterionTrigger.Listener<Instance> listener) {
      Listeners itemdurabilitytrigger$listeners = (Listeners)this.listeners.get(playerAdvancementsIn);
   ...
   public void trigger(EntityPlayerMP player, ItemStack itemIn, int newDurability) {
      Listeners itemdurabilitytrigger$listeners = (Listeners)this.listeners.get(player.getAdvancements());
      if (itemdurabilitytrigger$listeners != null) {
   ...
   static class Listeners {
      ...
      public void trigger(ItemStack item, int newDurability) {
         ...
         while(var4.hasNext()) {
            ...
            if (((Instance)listener1.getCriterionInstance()).test(item, newDurability)) {
               if (list == null) {
