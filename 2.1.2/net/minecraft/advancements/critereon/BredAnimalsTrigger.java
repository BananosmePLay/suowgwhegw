...
public class BredAnimalsTrigger implements ICriterionTrigger<Instance> {
   ...
   public void addListener(PlayerAdvancements playerAdvancementsIn, ICriterionTrigger.Listener<Instance> listener) {
      Listeners bredanimalstrigger$listeners = (Listeners)this.listeners.get(playerAdvancementsIn);
   ...
   public void trigger(EntityPlayerMP player, EntityAnimal parent1, EntityAnimal parent2, EntityAgeable child) {
      Listeners bredanimalstrigger$listeners = (Listeners)this.listeners.get(player.getAdvancements());
      if (bredanimalstrigger$listeners != null) {
   ...
   static class Listeners {
      ...
      public void trigger(EntityPlayerMP player, EntityAnimal parent1, EntityAnimal parent2, EntityAgeable child) {
         ...
         while(var6.hasNext()) {
            ...
            if (((Instance)listener1.getCriterionInstance()).test(player, parent1, parent2, child)) {
               if (list == null) {
