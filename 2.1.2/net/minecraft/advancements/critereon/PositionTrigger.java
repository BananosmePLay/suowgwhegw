...
public class PositionTrigger implements ICriterionTrigger<Instance> {
   ...
   public void addListener(PlayerAdvancements playerAdvancementsIn, ICriterionTrigger.Listener<Instance> listener) {
      Listeners positiontrigger$listeners = (Listeners)this.listeners.get(playerAdvancementsIn);
   ...
   public void trigger(EntityPlayerMP player) {
      Listeners positiontrigger$listeners = (Listeners)this.listeners.get(player.getAdvancements());
      if (positiontrigger$listeners != null) {
   ...
   static class Listeners {
      ...
      public void trigger(WorldServer world, double x, double y, double z) {
         ...
         while(var9.hasNext()) {
            ...
            if (((Instance)listener1.getCriterionInstance()).test(world, x, y, z)) {
               if (list == null) {
