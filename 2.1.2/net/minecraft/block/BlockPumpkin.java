...
public class BlockPumpkin extends BlockHorizontal {
   ...
   private void trySpawnGolem(World worldIn, BlockPos pos) {
      ...
      if (blockpattern$patternhelper != null) {
         ...
         var6 = worldIn.getEntitiesWithinAABB(EntityPlayerMP.class, entitysnowman.getEntityBoundingBox().grow(5.0)).iterator();

         while(var6.hasNext()) {
            entityplayermp1 = (EntityPlayerMP)var6.next();
            CriteriaTriggers.SUMMONED_ENTITY.trigger(entityplayermp1, entitysnowman);
         }
         ...
         if (blockpattern$patternhelper != null) {
            ...
            var6 = worldIn.getEntitiesWithinAABB(EntityPlayerMP.class, entityirongolem.getEntityBoundingBox().grow(5.0)).iterator();
