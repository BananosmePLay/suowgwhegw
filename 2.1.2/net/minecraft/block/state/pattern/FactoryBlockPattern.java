...
public class FactoryBlockPattern {
   ...
   private Predicate<BlockWorldState>[][][] makePredicateArray() {
      ...
      Predicate<BlockWorldState>[][][] predicate = (Predicate[][][])((Predicate[][][])((Predicate[][][])Array.newInstance(Predicate.class, new int[]{this.depth.size(), this.aisleHeight, this.rowWidth})));
   ...
   private void checkMissingPredicates() {
      ...
      while(var2.hasNext()) {
         Map.Entry<Character, Predicate<BlockWorldState>> entry = (Map.Entry)var2.next();
