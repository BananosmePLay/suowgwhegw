...
public class Minecraft implements IThreadListener, ISnooperInfo {
   ...
   public void run() {
      ...
      try {
         ...
         throwable1 = var11;
         crashreport1 = CrashReport.makeCrashReport(throwable1, "Initializing game");
      ...
      try {
         ...
         throwable1 = var14;
         crashreport1 = this.addGraphicsAndWorldToCrashReport(new CrashReport("Unexpected error", throwable1));
         this.freeMemory();
   ...
   private void init() throws LWJGLException, IOException {
      gameSettings = new GameSettings(this, this.gameDir);
      ...
      this.resourcePackRepository = new ResourcePackRepository(this.fileResourcepacks, new File(this.gameDir, "server-resource-packs"), this.defaultResourcePack, this.metadataSerializer, gameSettings);
      this.resourceManager = new SimpleReloadableResourceManager(this.metadataSerializer);
      this.languageManager = new LanguageManager(this.metadataSerializer, gameSettings.language);
      ...
      this.soundHandler = new SoundHandler(this.resourceManager, gameSettings);
      this.resourceManager.registerReloadListener(this.soundHandler);
      this.musicTicker = new MusicTicker(this);
      this.fontRenderer = new FontRenderer(gameSettings, new ResourceLocation("textures/font/ascii.png"), this.renderEngine, false);
      0bJ.setProgress(1);
      this.main.startClient();
      ...
      if (this.serverName != null) {
         this.displayGuiScreen(new GuiConnecting(new 0bE(), this, this.serverName, this.serverPort));
      } else {
         this.displayGuiScreen(new 0bE());
      }
   ...
   private void createDisplay() throws LWJGLException {
      ...
      Display.setTitle("NeoWare v" + 0bK.VERSION_TYPE);
   ...
   public void refreshResources() {
      List<IResourcePack> list = Lists.newArrayList((Iterable)this.defaultResourcePacks);
   ...
   public void displayGuiScreen(@Nullable GuiScreen guiScreenIn) {
      ...
      if (guiScreenIn instanceof 0bE || guiScreenIn instanceof GuiMultiplayer) {
         ...
         if (!player.isRowingBoat()) {
            ...
            for(int var3 = 0; var3 < var2; ++var3) {
               ...
               if (this.objectMouseOver != null) {
                  switch (this.objectMouseOver.typeOfHit) {
                     case ENTITY:
                        0z eiwe = new 0z(this.objectMouseOver.entityHit);
                        0m.call(eiwe);
                        if (!eiwe.isCanceled()) {
   ...
   public void runTick() throws IOException {
      ...
      if (this.currentScreen != null) {
         try {
            ...
            throwable2 = var5;
            crashreport2 = CrashReport.makeCrashReport(throwable2, "Updating screen events");
         ...
         if (this.currentScreen != null) {
            try {
               ...
               throwable2 = var4;
               crashreport2 = CrashReport.makeCrashReport(throwable2, "Ticking screen");
               crashreportcategory2 = crashreport2.makeCategory("Affected screen");
               crashreportcategory2.addDetail("Screen name", new ICrashReportDetail<String>() {
                  public String call() throws Exception {
                     return Minecraft.this.currentScreen.getClass().getCanonicalName();
   ...
   private void processKeyBinds() {
      ...
      while(gameSettings.keyBindAdvancements.isPressed()) {
         this.displayGuiScreen(new GuiScreenAdvancements(player.connection.getAdvancementManager()));
      }
   ...
   private void runTickMouse() throws IOException {
      while(Mouse.next()) {
         ...
         if (Mouse.getEventButtonState()) {
            if (0d.mirror) {
               Iterator var2 = 0cC.getOnline().iterator();

               while(var2.hasNext()) {
                  0cC bot = (0cC)var2.next();
                  bot.changeSlot(player.inventory.currentItem);
                  bot.useItem();
               }
            } else if (0cc.mouseclicks.value && i == 1) {
               if (0bK.getInstance().moduleManager.getModule(0bY.class).isModuleState()) {
                  0bY.records.add(new 0bW(0bX.HOTBARCLICK, player.inventory.currentItem));
               }

               0dK.formatMsg("Slot " + player.inventory.currentItem + " | .bots hotbar " + player.inventory.currentItem);
            }

            0s eventMouse = new 0s(i);
            0m.call(eventMouse);
   ...
   public void loadWorld(@Nullable WorldClient worldClientIn, String loadingMessage) {
      ...
      if (worldClientIn != null) {
         ...
         if (player == null) {
            player = this.playerController.createPlayer(worldClientIn, new StatisticsManager(), new RecipeBookClient());
   ...
   public void setDimensionAndSpawnPlayer(int dimension) {
      ...
      player = this.playerController.createPlayer(this.world, player == null ? new StatisticsManager() : player.getStatFileWriter(), player == null ? new RecipeBook() : player.getRecipeBook());
   ...
   public CrashReport addGraphicsAndWorldToCrashReport(CrashReport theCrash) {
      ...
      theCrash.getCategory().addDetail("Using VBOs", new ICrashReportDetail<String>() {
         public String call() {
            Minecraft var10000 = Minecraft.this;
      ...
      theCrash.getCategory().addDetail("Resource Packs", new ICrashReportDetail<String>() {
         public String call() throws Exception {
            StringBuilder stringbuilder = new StringBuilder();
            Minecraft var10000 = Minecraft.this;
            Iterator var2 = Minecraft.gameSettings.resourcePacks.iterator();
            ...
            while(var2.hasNext()) {
               ...
               var10000 = Minecraft.this;
               if (Minecraft.gameSettings.incompatibleResourcePacks.contains(s)) {
   ...
   static {
      ...
      MAC_DISPLAY_MODES = Lists.newArrayList((Object[])(new DisplayMode(2560, 1600), new DisplayMode(2880, 1800)));
   }
}
