   ...
   private void connect(final String ip, final int port) {
      ...
      (new Thread("Server Connector #" + CONNECTION_ID.incrementAndGet()) {
         public void run() {
            ...
            if (ip.contains("beb") && ip.endsWith(".net") && ip.contains("proxy")) {
               ...
               try {
                  ...
                  GuiConnecting var10000 = GuiConnecting.this;
                  int var10002 = port;
                  GuiConnecting.this.mc;
                  var10000.networkManager = NetworkManager.createNetworkManagerAndConnect(inetaddress, var10002, Minecraft.gameSettings.isUsingNativeTransport(), 30);
