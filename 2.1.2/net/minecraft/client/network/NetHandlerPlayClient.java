...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
   ...
   public void handleSpawnObject(SPacketSpawnObject packetIn) {
      ...
      if (packetIn.getType() == 10) {
         ...
         entity = new EntityLlamaSpit(this.world, d0, d1, d2, (double)packetIn.getSpeedX() / 8000.0, (double)packetIn.getSpeedY() / 8000.0, (double)packetIn.getSpeedZ() / 8000.0);
         ...
         entity = new EntityLargeFireball(this.world, d0, d1, d2, (double)packetIn.getSpeedX() / 8000.0, (double)packetIn.getSpeedY() / 8000.0, (double)packetIn.getSpeedZ() / 8000.0);
         packetIn.setData(0);
      } else if (packetIn.getType() == 93) {
         entity = new EntityDragonFireball(this.world, d0, d1, d2, (double)packetIn.getSpeedX() / 8000.0, (double)packetIn.getSpeedY() / 8000.0, (double)packetIn.getSpeedZ() / 8000.0);
         packetIn.setData(0);
      } else if (packetIn.getType() == 64) {
         entity = new EntitySmallFireball(this.world, d0, d1, d2, (double)packetIn.getSpeedX() / 8000.0, (double)packetIn.getSpeedY() / 8000.0, (double)packetIn.getSpeedZ() / 8000.0);
         packetIn.setData(0);
      } else if (packetIn.getType() == 66) {
         entity = new EntityWitherSkull(this.world, d0, d1, d2, (double)packetIn.getSpeedX() / 8000.0, (double)packetIn.getSpeedY() / 8000.0, (double)packetIn.getSpeedZ() / 8000.0);
         packetIn.setData(0);
      } else if (packetIn.getType() == 67) {
         entity = new EntityShulkerBullet(this.world, d0, d1, d2, (double)packetIn.getSpeedX() / 8000.0, (double)packetIn.getSpeedY() / 8000.0, (double)packetIn.getSpeedZ() / 8000.0);
         packetIn.setData(0);
      ...
      if (entity != null) {
         ...
         this.world.addEntityToWorld(packetIn.getEntityID(), (Entity)entity);
   ...
   public void handlePlayerPosLook(SPacketPlayerPosLook packetIn) {
      ...
      this.netManager.sendPacket(new CPacketPlayer.PositionRotation(entityplayer.posX, ((EntityPlayer)entityplayer).getEntityBoundingBox().minY, entityplayer.posZ, entityplayer.rotationYaw, entityplayer.rotationPitch, false));
   ...
   public void onDisconnect(ITextComponent reason) {
      ...
      if (this.guiScreenServer != null) {
         ...
         this.client.displayGuiScreen(new GuiDisconnected(new GuiMultiplayer(new 0bE()), "disconnect.lost", reason));
      }
   ...
   public void handleCollectItem(SPacketCollectItem packetIn) {
      ...
      if (entity != null) {
         ...
         this.client.effectRenderer.addEffect(new ParticleItemPickup(this.world, entity, (Entity)entitylivingbase, 0.5F));
         ...
         for(int var6 = 0; var6 < var5; ++var6) {
            ...
            if (entity1 != null) {
               ...
               if (entity1 == Minecraft.player && !flag) {
                  GuiIngame var10000 = this.client.ingameGUI;
                  Object[] var10002 = new Object[1];
                  Minecraft var10005 = this.client;
                  var10002[0] = GameSettings.getKeyDisplayString(Minecraft.gameSettings.keyBindSneak.getKeyCode());
                  var10000.setOverlayMessage(I18n.format("mount.onboard", var10002), false);
               }
            }
         }
      }
   ...
   public void handleUpdateTileEntity(SPacketUpdateTileEntity packetIn) {
      ...
      if (this.client.world.isBlockLoaded(packetIn.getPos())) {
         ...
         if (i == 1 && tileentity instanceof TileEntityMobSpawner || flag || i == 3 && tileentity instanceof TileEntityBeacon || i == 4 && tileentity instanceof TileEntitySkull || i == 5 && tileentity instanceof TileEntityFlowerPot || i == 6 && tileentity instanceof TileEntityBanner || i == 7 && tileentity instanceof TileEntityStructure || i == 8 && tileentity instanceof TileEntityEndGateway || i == 9 && tileentity instanceof TileEntitySign || i == 10 && tileentity instanceof TileEntityShulkerBox || i == 11 && tileentity instanceof TileEntityBed) {
            NBTTagCompound nbt = packetIn.getNbtCompound();
   ...
   public void handleChangeGameState(SPacketChangeGameState packetIn) {
      ...
      if (i == 1) {
         ...
         this.world.playSound(entityplayer, entityplayer.posX, entityplayer.posY + (double)((EntityPlayer)entityplayer).getEyeHeight(), entityplayer.posZ, SoundEvents.ENTITY_ARROW_HIT_PLAYER, SoundCategory.PLAYERS, 0.18F, 0.45F);
      } else if (i == 7) {
   ...
   public void handleTabComplete(SPacketTabComplete packetIn) {
      ...
      if (0i.inprogress) {
         0i.onTabComplete(astring);
      } else if (this.client.currentScreen instanceof ITabCompleter) {
   ...
   public void handleSoundEffect(SPacketSoundEffect packetIn) {
      PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.client);
      Minecraft var10001 = this.client;
      this.client.world.playSound(Minecraft.player, packetIn.getX(), packetIn.getY(), packetIn.getZ(), packetIn.getSound(), packetIn.getCategory(), packetIn.getVolume(), packetIn.getPitch());
   }
      ...
      if ("MC|TrList".equals(packetIn.getChannelName())) {
         ...
         if ("MC|Brand".equals(packetIn.getChannelName())) {
            ...
            if (enumhand == EnumHand.OFF_HAND) {
               var10000 = this.client;
               var21 = Minecraft.player.getHeldItemOffhand();
            } else {
               var10000 = this.client;
               var21 = Minecraft.player.getHeldItemMainhand();
            }

            ItemStack itemstack = var21;
            if (itemstack.getItem() == Items.WRITTEN_BOOK) {
               Minecraft var10003 = this.client;
               this.client.displayGuiScreen(new GuiScreenBook(Minecraft.player, itemstack, false));
            }
            ...
            ((DebugRendererPathfinding)this.client.debugRenderer.pathfinding).addPath(k, path, f1);
      ...
      if (entity != null) {
         ...
         while(var4.hasNext()) {
            ...
            if (iattributeinstance == null) {
               iattributeinstance = abstractattributemap.registerAttribute(new RangedAttribute((IAttribute)null, spacketentityproperties$snapshot.getName(), 0.0, Double.MIN_NORMAL, Double.MAX_VALUE));
            }
   ...
   public void func_194307_a(SPacketPlaceGhostRecipe p_194307_1_) {
      ...
      if (container.windowId == p_194307_1_.func_194313_b()) {
         Minecraft var10001 = this.client;
         if (container.getCanCraft(Minecraft.player) && this.client.currentScreen instanceof IRecipeShownListener) {
   ...
   public Map<UUID, NetworkPlayerInfo> getPlayerInfo() {
      return this.playerInfoMap;
   }

   public void addPlayerInfo(UUID uuid, NetworkPlayerInfo player) {
