...
public class DebugRendererWater implements DebugRenderer.IDebugRenderer {
   ...
   public void render(float partialTicks, long finishTimeNano) {
      ...
      while(true) {
         ...
         do {
            if (!var6.hasNext()) {
               ...
               while(true) {
                  ...
                  DebugRenderer.renderDebugText(s + " " + integer, (double)blockpos2.getX() + 0.5, (double)blockpos2.getY() + d1, (double)blockpos2.getZ() + 0.5, partialTicks, -16777216);
               }
            }
         ...
         double d0 = (double)BlockLiquid.getLiquidHeight(iblockstate1, world, blockpos2);
