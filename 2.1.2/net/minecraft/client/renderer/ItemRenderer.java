...
public class ItemRenderer {
   ...
   private void setLightmap() {
      ...
      int i = this.mc.world.getCombinedLight(new BlockPos(abstractclientplayer.posX, abstractclientplayer.posY + (double)((AbstractClientPlayer)abstractclientplayer).getEyeHeight(), abstractclientplayer.posZ), 0);
   ...
   private void renderArmFirstPerson(float p_187456_1_, float p_187456_2_, EnumHandSide p_187456_3_) {
      ...
      Minecraft var10000 = this.mc;
      AbstractClientPlayer abstractclientplayer = Minecraft.player;
      this.mc.getTextureManager().bindTexture(((AbstractClientPlayer)abstractclientplayer).getLocationSkin());
   ...
   public void renderItemInFirstPerson(float partialTicks) {
      Minecraft var10000 = this.mc;
      AbstractClientPlayer abstractclientplayer = Minecraft.player;
      float f = ((AbstractClientPlayer)abstractclientplayer).getSwingProgress(partialTicks);
      ...
      boolean flag = true;
      boolean flag1 = true;
      if (((AbstractClientPlayer)abstractclientplayer).isHandActive()) {
         ItemStack itemstack = ((AbstractClientPlayer)abstractclientplayer).getActiveItemStack();
         if (itemstack.getItem() instanceof ItemBow) {
            EnumHand enumhand1 = ((AbstractClientPlayer)abstractclientplayer).getActiveHand();
   ...
   public void renderItemInFirstPerson(AbstractClientPlayer player, float p_187457_2_, float p_187457_3_, EnumHand hand, float p_187457_5_, ItemStack stack, float p_187457_7_) {
      if (!Config.isShaders() || !Shaders.isSkipRenderHand(hand)) {
         Minecraft var10000 = this.mc;
         AbstractClientPlayer abstractclientplayer = Minecraft.player;
         float f1 = ((AbstractClientPlayer)abstractclientplayer).getSwingProgress(this.mc.getRenderPartialTicks());
            ...
            if (player.isHandActive() && player.getItemInUseCount() > 0 && player.getActiveHand() == hand) {
               ...
               switch (stack.getItemUseAction()) {
                  ...
                  case BOW:
                     ...
                     float var27 = (float)stack.getMaxItemUseDuration();
                     Minecraft var10001 = this.mc;
                     f5 = var27 - ((float)Minecraft.player.getItemInUseCount() - p_187457_2_ + 1.0F);
                     f6 = f5 / 20.0F;
               ...
               int i = flag1 ? 1 : -1;
               f3 = 1.0F - (this.prevEquippedProgressMainHand + (this.equippedProgressMainHand - this.prevEquippedProgressMainHand) * p_187457_2_);
               var10000 = this.mc;
               f4 = Minecraft.player.getSwingProgress(p_187457_2_);
               float smooth = f4 * 0.8F - f4 * f4 * 0.8F;
               float sin1 = MathHelper.sin(f4 * f4 * 3.1415927F);
               float var15 = MathHelper.sin(f1 * f1 * 3.1415927F);
               float sin2 = MathHelper.sin(MathHelper.sqrt(f4) * 3.1415927F);
               if (0bK.getInstance().moduleManager.getModule(0cw.class).isModuleState() && enumhandside != EnumHandSide.LEFT) {
                  float var3;
                  if (0cw.anim.is("Default")) {
                     this.transformSideFirstPerson(enumhandside, 0.0F);
                     var3 = MathHelper.sin(MathHelper.sqrt(f4) * 3.1415927F);
                     GlStateManager.rotate(var3 * -70.0F, var3 * 70.0F, 0.0F, var3 * -90.0F);
                  } else if (0cw.anim.is("Block")) {
                     this.transformSideFirstPerson(enumhandside, 0.0F);
                     this.transformFirstPersonItem(f3 / 10.0F, f4);
                     this.translate();
                  } else if (0cw.anim.is("Swing")) {
                     this.transformSideFirstPerson(enumhandside, 0.0F);
                     GlStateManager.translate(0.46F, -0.3F, -0.71999997F);
                     ...
                     GlStateManager.rotate(40.0F, 0.0F, 0.0F, 0.0F);
                  } else {
                     float var4;
                     if (0cw.anim.is("Fap")) {
                        this.transformSideFirstPerson(enumhandside, 0.0F);
                        ...
                        GlStateManager.rotate(45.0F, 0.0F, 1.0F, 0.0F);
                        var3 = MathHelper.sin(0.0F);
                        var4 = MathHelper.sin(MathHelper.sqrt(0.0F) * 3.1415927F);
                        ...
                        var10000 = this.mc;
                        GlStateManager.rotate(Minecraft.player.isSwingInProgress ? (float)(-alpha) / 0cw.swingSpeed.value : 0.0F, 1.0F, -0.0F, 1.0F);
                        GlStateManager.translate(0.0, 0.0, 0.5);
                     } else if (0cw.anim.is("Wrap")) {
                        this.transformSideFirstPerson(enumhandside, 0.0F);
                        this.transformFirstPersonItem(0.0F, 0.0F);
                        this.translate();
                        GlStateManager.rotate(f5 * 0cw.wrapSpeed.value * 50.0F, 1.0F, 0.0F, 0.0F);
                     } else if (0cw.anim.is("Spin")) {
                        this.transformSideFirstPerson(enumhandside, 0.0F);
                        GlStateManager.rotate((float)(System.currentTimeMillis() / 16L * (long)((int)0cw.spinSpeed.value) % 360L), 0.0F, 0.0F, -0.1F);
                        this.transformFirstPersonItem(0.0F, 0.0F);
                        this.translate();
                     } else if (0cw.anim.is("y")) {
                        this.transformSideFirstPerson(enumhandside, 0.0F);
                        this.transformFirstPersonItem(0.0F, 0.0F);
                        this.translate3();
                        var3 = MathHelper.sin(f4 * f4 * 3.1415927F);
                        var4 = MathHelper.sin(MathHelper.sqrt(f4) * 3.1415927F);
                        GlStateManager.rotate(var4 * -70.0F, var4 * 40.0F, 0.0F, 0.0F);
                        GlStateManager.rotate(40.0F, -30.0F, 0.0F, 0.0F);
                     } else if (0cw.anim.is("None")) {
                        this.transformSideFirstPerson(enumhandside, 0.0F);
   ...
   public void renderOverlays(float partialTicks) {
      ...
      if (Minecraft.player.isEntityInsideOpaqueBlock()) {
         ...
         for(int i = 0; i < 8; ++i) {
            ...
            BlockPos blockpos1 = new BlockPos(d0, d1 + (double)((EntityPlayer)entityplayer).getEyeHeight(), d2);
      ...
      if (!Minecraft.player.isSpectator()) {
         ...
         if (!0bK.getInstance().moduleManager.getModule(0cx.class).isModuleState() && !0cx.noFire.value) {
            var10000 = this.mc;
