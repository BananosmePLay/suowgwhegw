   ...
   private void renderDebugBoundingBox(Entity entityIn, double x, double y, double z, float entityYaw, float partialTicks) {
      if (!Shaders.isShadowPass) {
         ...
         if (entityIn instanceof EntityLivingBase) {
            float f1 = 0.01F;
            RenderGlobal.drawBoundingBox(x - (double)f, y + (double)entityIn.getEyeHeight() - 0.009999999776482582, z - (double)f, x + (double)f, y + (double)entityIn.getEyeHeight() + 0.009999999776482582, z + (double)f, 1.0F, 0.0F, 0.0F, 1.0F);
         }
