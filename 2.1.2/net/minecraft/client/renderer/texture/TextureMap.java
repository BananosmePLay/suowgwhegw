...
public class TextureMap extends AbstractTexture implements ITickableTextureObject {
   ...
   private void initMissingImage() {
      ...
      aint1[0] = aint;
      this.missingImage.setFramesTextureData(Lists.newArrayList((Object[])(aint1)));
   ...
   public void loadTextureAtlas(IResourceManager resourceManager) {
      ...
      for(j2 = 0; j2 < list.size(); ++j2) {
         TextureAtlasSprite textureatlassprite1 = SpriteDependencies.resolveDependencies(list, j2, this);
         ...
         if (textureatlassprite1.hasCustomLoader(resourceManager, resourcelocation)) {
            ...
            try {
               ...
               ReflectorForge.FMLClientHandler_trackBrokenTexture(resourcelocation, var30.getMessage());
               continue;
         ...
         if (j3 >= 1 && k3 >= 1) {
            ...
            if (j3 < j || this.mipmapLevels > 0) {
               k1 = this.mipmapLevels > 0 ? TextureUtils.scaleToGrid(j3, j) : TextureUtils.scaleToMin(j3, j);
               if (k1 != j3) {
                  if (!TextureUtils.isPowerOfTwo(j3)) {
                     Config.log("Scaled non power of 2: " + textureatlassprite1.getIconName() + ", " + j3 + " -> " + k1);
                  } else {
                     Config.log("Scaled too small texture: " + textureatlassprite1.getIconName() + ", " + j3 + " -> " + k1);
                  }
      ...
      while(var38.hasNext()) {
         textureatlassprite2 = (TextureAtlasSprite)var38.next();
         ...
         try {
            ...
            CrashReport crashreport = CrashReport.makeCrashReport(var28, "Stitching texture atlas");
      ...
      if (Config.isMultiTexture()) {
         ...
         while(var46.hasNext()) {
            TextureAtlasSprite textureatlassprite4 = (TextureAtlasSprite)var46.next();
   ...
   public void updateAnimations() {
      ...
      while(var4.hasNext()) {
         textureatlassprite10 = (TextureAtlasSprite)var4.next();
