...
public class ModelBakery {
   ...
   protected void loadBlock(BlockStateMapper p_loadBlock_1_, Block p_loadBlock_2_, final ResourceLocation p_loadBlock_3_) {
      ...
      if (modelblockdefinition.hasMultipartData()) {
         Collection<ModelResourceLocation> collection = Sets.newHashSet((Iterable)map.values());
         ...
         ((Collection)collection1).addAll(Lists.newArrayList(Iterables.filter(collection, (Predicate)(new Predicate<ModelResourceLocation>() {
            ...
            public boolean apply(@Nullable Object var1) {
               return this.apply((ModelResourceLocation)var1);
            }
         }))));
      ...
      while(true) {
         ...
         do {
            ...
            Map.Entry<IBlockState, ModelResourceLocation> entry = (Map.Entry)var11.next();
   ...
   private void loadVariantItemModels() {
      this.variants.put(MODEL_MISSING, new VariantList(Lists.newArrayList((Object[])(new Variant(new ResourceLocation(MODEL_MISSING.getPath()), ModelRotation.X0_Y0, false, 1)))));
   ...
   private void loadVariantModels() {
      ...
      while(var1.hasNext()) {
         Map.Entry<ModelResourceLocation, VariantList> entry = (Map.Entry)var1.next();
   ...
   private void loadMultipartVariantModels() {
      ...
      while(var1.hasNext()) {
         Map.Entry<ModelBlockDefinition, Collection<ModelResourceLocation>> entry = (Map.Entry)var1.next();
      ...
      try {
         ...
         if (!"builtin/generated".equals(s)) {
            if (!"builtin/entity".equals(s)) {
               ...
               s1 = TextureUtils.getBasePath(location.getPath());
               fixModelLocations(modelblock3, s1);
               ModelBlock modelblock2 = modelblock3;
               ModelBlock var9 = modelblock2;
               return var9;
            }
   ...
   private void registerVariantNames() {
      ...
      this.variantNames.put(Items.POTIONITEM, Lists.newArrayList((Object[])("bottle_drinkable")));
      this.variantNames.put(Items.SKULL, Lists.newArrayList((Object[])("skull_skeleton", "skull_wither", "skull_zombie", "skull_char", "skull_creeper", "skull_dragon")));
      this.variantNames.put(Items.SPLASH_POTION, Lists.newArrayList((Object[])("bottle_splash")));
      this.variantNames.put(Items.LINGERING_POTION, Lists.newArrayList((Object[])("bottle_lingering")));
      this.variantNames.put(Item.getItemFromBlock(Blocks.CONCRETE), Lists.newArrayList((Object[])("black_concrete", "red_concrete", "green_concrete", "brown_concrete", "blue_concrete", "purple_concrete", "cyan_concrete", "silver_concrete", "gray_concrete", "pink_concrete", "lime_concrete", "yellow_concrete", "light_blue_concrete", "magenta_concrete", "orange_concrete", "white_concrete")));
      this.variantNames.put(Item.getItemFromBlock(Blocks.CONCRETE_POWDER), Lists.newArrayList((Object[])("black_concrete_powder", "red_concrete_powder", "green_concrete_powder", "brown_concrete_powder", "blue_concrete_powder", "purple_concrete_powder", "cyan_concrete_powder", "silver_concrete_powder", "gray_concrete_powder", "pink_concrete_powder", "lime_concrete_powder", "yellow_concrete_powder", "light_blue_concrete_powder", "magenta_concrete_powder", "orange_concrete_powder", "white_concrete_powder")));
      ...
      this.variantNames.put(Items.BOAT, Lists.newArrayList((Object[])("oak_boat")));
      this.variantNames.put(Items.TOTEM_OF_UNDYING, Lists.newArrayList((Object[])("totem")));
      Iterator var1 = customVariantNames.entrySet().iterator();

      while(var1.hasNext()) {
         Map.Entry<IRegistryDelegate<Item>, Set<String>> entry = (Map.Entry)var1.next();
   ...
   private Set<ResourceLocation> getVariantsTextureLocations() {
      ...
      List<ModelResourceLocation> list = Lists.newArrayList((Iterable)this.variants.keySet());
   ...
   private void loadModels() {
      ...
      while(!deque.isEmpty()) {
         ...
         try {
            ...
            LOGGER.warn("In parent chain: {}; unable to load model: '{}'", JOINER.join((Iterable)this.getParentPath(resourcelocation1)), resourcelocation1);
         }
