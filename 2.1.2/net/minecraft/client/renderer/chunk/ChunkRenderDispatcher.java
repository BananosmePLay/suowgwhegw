...
public class ChunkRenderDispatcher {
   ...
   public boolean runChunkUploads(long finishTimeNano) {
      ...
      do {
         ...
         PendingUpload chunkrenderdispatcher$pendingupload;
         synchronized(this.queueChunkUploads) {
            chunkrenderdispatcher$pendingupload = (PendingUpload)this.queueChunkUploads.poll();
         }
   ...
   class PendingUpload implements Comparable<PendingUpload> {
      ...
      public int compareTo(Object var1) {
         return this.compareTo((PendingUpload)var1);
      }
   }
}
