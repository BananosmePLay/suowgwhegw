...
public class BlockModelRenderer {
   ...
   public static enum EnumNeighborInfo {
      DOWN(new EnumFacing[]{EnumFacing.WEST, EnumFacing.EAST, EnumFacing.NORTH, EnumFacing.SOUTH}, 0.5F, true, new Orientation[]{BlockModelRenderer.Orientation.FLIP_WEST, BlockModelRenderer.Orientation.SOUTH, BlockModelRenderer.Orientation.FLIP_WEST, BlockModelRenderer.Orientation.FLIP_SOUTH, BlockModelRenderer.Orientation.WEST, BlockModelRenderer.Orientation.FLIP_SOUTH, BlockModelRenderer.Orientation.WEST, BlockModelRenderer.Orientation.SOUTH}, new Orientation[]{BlockModelRenderer.Orientation.FLIP_WEST, BlockModelRenderer.Orientation.NORTH, BlockModelRenderer.Orientation.FLIP_WEST, BlockModelRenderer.Orientation.FLIP_NORTH, BlockModelRenderer.Orientation.WEST, BlockModelRenderer.Orientation.FLIP_NORTH, BlockModelRenderer.Orientation.WEST, BlockModelRenderer.Orientation.NORTH}, new Orientation[]{BlockModelRenderer.Orientation.FLIP_EAST, BlockModelRenderer.Orientation.NORTH, BlockModelRenderer.Orientation.FLIP_EAST, BlockModelRenderer.Orientation.FLIP_NORTH, BlockModelRenderer.Orientation.EAST, BlockModelRenderer.Orientation.FLIP_NORTH, BlockModelRenderer.Orientation.EAST, BlockModelRenderer.Orientation.NORTH}, new Orientation[]{BlockModelRenderer.Orientation.FLIP_EAST, BlockModelRenderer.Orientation.SOUTH, BlockModelRenderer.Orientation.FLIP_EAST, BlockModelRenderer.Orientation.FLIP_SOUTH, BlockModelRenderer.Orientation.EAST, BlockModelRenderer.Orientation.FLIP_SOUTH, BlockModelRenderer.Orientation.EAST, BlockModelRenderer.Orientation.SOUTH}),
      UP(new EnumFacing[]{EnumFacing.EAST, EnumFacing.WEST, EnumFacing.NORTH, EnumFacing.SOUTH}, 1.0F, true, new Orientation[]{BlockModelRenderer.Orientation.EAST, BlockModelRenderer.Orientation.SOUTH, BlockModelRenderer.Orientation.EAST, BlockModelRenderer.Orientation.FLIP_SOUTH, BlockModelRenderer.Orientation.FLIP_EAST, BlockModelRenderer.Orientation.FLIP_SOUTH, BlockModelRenderer.Orientation.FLIP_EAST, BlockModelRenderer.Orientation.SOUTH}, new Orientation[]{BlockModelRenderer.Orientation.EAST, BlockModelRenderer.Orientation.NORTH, BlockModelRenderer.Orientation.EAST, BlockModelRenderer.Orientation.FLIP_NORTH, BlockModelRenderer.Orientation.FLIP_EAST, BlockModelRenderer.Orientation.FLIP_NORTH, BlockModelRenderer.Orientation.FLIP_EAST, BlockModelRenderer.Orientation.NORTH}, new Orientation[]{BlockModelRenderer.Orientation.WEST, BlockModelRenderer.Orientation.NORTH, BlockModelRenderer.Orientation.WEST, BlockModelRenderer.Orientation.FLIP_NORTH, BlockModelRenderer.Orientation.FLIP_WEST, BlockModelRenderer.Orientation.FLIP_NORTH, BlockModelRenderer.Orientation.FLIP_WEST, BlockModelRenderer.Orientation.NORTH}, new Orientation[]{BlockModelRenderer.Orientation.WEST, BlockModelRenderer.Orientation.SOUTH, BlockModelRenderer.Orientation.WEST, BlockModelRenderer.Orientation.FLIP_SOUTH, BlockModelRenderer.Orientation.FLIP_WEST, BlockModelRenderer.Orientation.FLIP_SOUTH, BlockModelRenderer.Orientation.FLIP_WEST, BlockModelRenderer.Orientation.SOUTH}),
   ...
   public static class AmbientOcclusionFace {
      ...
      public void updateVertexBrightness(IBlockAccess worldIn, IBlockState state, BlockPos centerPos, EnumFacing direction, float[] faceShape, BitSet shapeState) {
         ...
         EnumNeighborInfo blockmodelrenderer$enumneighborinfo = BlockModelRenderer.EnumNeighborInfo.getNeighbourInfo(direction);
         BlockPos.MutableBlockPos blockpos$mutableblockpos1 = this.blockPosArr[1].setPos((Vec3i)blockpos).move(blockmodelrenderer$enumneighborinfo.corners[0]);
         BlockPos.MutableBlockPos blockpos$mutableblockpos2 = this.blockPosArr[2].setPos((Vec3i)blockpos).move(blockmodelrenderer$enumneighborinfo.corners[1]);
         BlockPos.MutableBlockPos blockpos$mutableblockpos3 = this.blockPosArr[3].setPos((Vec3i)blockpos).move(blockmodelrenderer$enumneighborinfo.corners[2]);
         BlockPos.MutableBlockPos blockpos$mutableblockpos4 = this.blockPosArr[4].setPos((Vec3i)blockpos).move(blockmodelrenderer$enumneighborinfo.corners[3]);
         ...
         if (!flag2 && !flag) {
            ...
            BlockPos blockpos1 = blockpos$mutableblockpos.setPos((Vec3i)blockpos$mutableblockpos1).move(blockmodelrenderer$enumneighborinfo.corners[2]);
         ...
         if (!flag3 && !flag) {
            ...
            BlockPos blockpos2 = blockpos$mutableblockpos.setPos((Vec3i)blockpos$mutableblockpos1).move(blockmodelrenderer$enumneighborinfo.corners[3]);
         ...
         if (!flag2 && !flag1) {
            ...
            BlockPos blockpos3 = blockpos$mutableblockpos.setPos((Vec3i)blockpos$mutableblockpos2).move(blockmodelrenderer$enumneighborinfo.corners[2]);
         ...
         if (!flag3 && !flag1) {
            ...
            BlockPos blockpos4 = blockpos$mutableblockpos.setPos((Vec3i)blockpos$mutableblockpos2).move(blockmodelrenderer$enumneighborinfo.corners[3]);
         ...
         VertexTranslations blockmodelrenderer$vertextranslations = BlockModelRenderer.VertexTranslations.getVertexTranslations(direction);
         float f5;
         float f6;
         float f7;
         float f8;
