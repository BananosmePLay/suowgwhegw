...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback {
   ...
   private static final Set<String> PROTOCOLS = Sets.newHashSet((Object[])("http", "https"));
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      for(j = 0; j < this.buttonList.size(); ++j) {
         ((GuiButton)this.buttonList.get(j)).drawButton(this.mc, mouseX, mouseY, partialTicks);
      }
   ...
   protected void renderToolTip(ItemStack stack, int x, int y) {
      0W renderToolTipEvent = new 0W(stack, x, y);
      0m.call(renderToolTipEvent);
   ...
   public List<String> getItemToolTip(ItemStack p_191927_1_) {
      ...
      List<String> list = p_191927_1_.getTooltip(Minecraft.player, Minecraft.gameSettings.advancedItemTooltips ? ITooltipFlag.TooltipFlags.ADVANCED : ITooltipFlag.TooltipFlags.NORMAL);
