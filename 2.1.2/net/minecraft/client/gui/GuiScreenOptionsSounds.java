   ...
   protected void actionPerformed(GuiButton button) throws IOException {
      if (button.enabled) {
         ...
         if (button.id == 200) {
            ...
            button.displayString = Minecraft.gameSettings.getKeyBinding(GameSettings.Options.SHOW_SUBTITLES);
            var10000 = this.mc;
            Minecraft.gameSettings.saveOptions();
         }
      }
      ...
      protected void mouseDragged(Minecraft mc, int mouseX, int mouseY) {
         if (this.visible) {
            if (this.pressed) {
               ...
               Minecraft.gameSettings.setSoundLevel(this.category, this.volume);
               Minecraft.gameSettings.saveOptions();
