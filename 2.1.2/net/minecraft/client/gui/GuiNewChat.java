...
public class GuiNewChat extends Gui {
   ...
   public void printChatMessage(ITextComponent chatComponent) {
      ...
      0H event = new 0H(chatComponent.getUnformattedText());
      0m.call(event);
   }
   ...
   public int getChatWidth() {
      Minecraft var10000 = this.mc;
      return calculateChatboxWidth(Minecraft.gameSettings.chatWidth * 2.0F);
   }
   ...
   public int getChatHeight() {
      ...
      if (this.getChatOpen()) {
         var10000 = this.mc;
         var1 = Minecraft.gameSettings.chatHeightFocused;
      } else {
         var10000 = this.mc;
         var1 = Minecraft.gameSettings.chatHeightUnfocused;
      }
