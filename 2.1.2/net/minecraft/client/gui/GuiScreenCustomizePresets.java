...
public class GuiScreenCustomizePresets extends GuiScreen {
   ...
   class ListPreset extends GuiSlot {
      ...
      protected void elementClicked(int slotIndex, boolean isDoubleClick, int mouseX, int mouseY) {
         ...
         GuiScreenCustomizePresets.this.export.setText(((Info)GuiScreenCustomizePresets.PRESETS.get(GuiScreenCustomizePresets.this.list.selected)).settings.toString());
      }
      ...
      protected void drawSlot(int slotIndex, int xPos, int yPos, int heightIn, int mouseXIn, int mouseYIn, float partialTicks) {
         Info guiscreencustomizepresets$info = (Info)GuiScreenCustomizePresets.PRESETS.get(slotIndex);
