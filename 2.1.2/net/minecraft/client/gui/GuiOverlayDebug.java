...
public class GuiOverlayDebug extends Gui {
   ...
   public void renderDebugInfo(ScaledResolution scaledResolutionIn) {
      ...
      if (Minecraft.gameSettings.showLagometer) {
   ...
   protected void renderDebugInfoLeft() {
      ...
      if (list == null || System.currentTimeMillis() > this.updateInfoLeftTimeMs) {
         ...
         var10001 = var10001.append(Minecraft.gameSettings.showDebugProfilerChart ? "visible" : "hidden").append(" FPS [alt]: ");
         var10002 = this.mc;
         list.add(var10001.append(Minecraft.gameSettings.showLagometer ? "visible" : "hidden").toString());
   ...
   protected <T extends Comparable<T>> List<String> getDebugInfoRight() {
      ...
      long l = j - k;
      List<String> list = Lists.newArrayList((Object[])(String.format("Java: %s %dbit", System.getProperty("java.version"), this.mc.isJava64bit() ? 64 : 32), String.format("Mem: % 2d%% %03d/%03dMB", l * 100L / i, bytesToMb(l), bytesToMb(i)), String.format("Allocated: % 2d%% %03dMB", j * 100L / i, bytesToMb(j)), "", String.format("CPU: %s", OpenGlHelper.getCpu()), "", String.format("Display: %dx%d (%s)", Display.getWidth(), Display.getHeight(), GlStateManager.glGetString(7936)), GlStateManager.glGetString(7937), GlStateManager.glGetString(7938)));
