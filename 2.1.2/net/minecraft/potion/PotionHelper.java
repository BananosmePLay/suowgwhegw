...
public class PotionHelper {
   ...
   protected static boolean isItemConversionReagent(ItemStack stack) {
      ...
      for(int j = POTION_ITEM_CONVERSIONS.size(); i < j; ++i) {
         if (((MixPredicate)POTION_ITEM_CONVERSIONS.get(i)).reagent.apply(stack)) {
            return true;
         }
      }
   ...
   protected static boolean isTypeConversionReagent(ItemStack stack) {
      ...
      for(int j = POTION_TYPE_CONVERSIONS.size(); i < j; ++i) {
         if (((MixPredicate)POTION_TYPE_CONVERSIONS.get(i)).reagent.apply(stack)) {
            return true;
         }
      }
   ...
   public static ItemStack doReaction(ItemStack reagent, ItemStack potionIn) {
      if (!potionIn.isEmpty()) {
         ...
         int k;
         MixPredicate mixpredicate1;
         for(k = POTION_ITEM_CONVERSIONS.size(); i < k; ++i) {
            mixpredicate1 = (MixPredicate)POTION_ITEM_CONVERSIONS.get(i);
         ...
         for(k = POTION_TYPE_CONVERSIONS.size(); i < k; ++i) {
            mixpredicate1 = (MixPredicate)POTION_TYPE_CONVERSIONS.get(i);
