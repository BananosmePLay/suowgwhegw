...
public class ServerWorldEventHandler implements IWorldEventListener {
   ...
   public void playEvent(EntityPlayer player, int type, BlockPos blockPosIn, int data) {
      this.server.getPlayerList().sendToAllNearExcept(player, (double)blockPosIn.getX(), (double)blockPosIn.getY(), (double)blockPosIn.getZ(), 64.0, this.world.provider.getDimensionType().getId(), new SPacketEffect(type, blockPosIn, data, false));
   }
