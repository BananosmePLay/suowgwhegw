...
public class BiomeProvider {
   ...
   protected BiomeProvider() {
      ...
      this.biomesToSpawnIn = Lists.newArrayList((Object[])(Biomes.FOREST, Biomes.PLAINS, Biomes.TAIGA, Biomes.TAIGA_HILLS, Biomes.FOREST_HILLS, Biomes.JUNGLE, Biomes.JUNGLE_HILLS));
   }
