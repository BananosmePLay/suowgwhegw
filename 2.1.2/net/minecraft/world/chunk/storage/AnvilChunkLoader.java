...
public class AnvilChunkLoader implements IChunkLoader, IThreadedFileIO {
   ...
   public boolean writeNextIO() {
      if (this.chunksToSave.isEmpty()) {
         ...
         try {
            ...
            NBTTagCompound nbttagcompound = (NBTTagCompound)this.chunksToSave.remove(chunkpos);
            if (nbttagcompound != null) {
               try {
   ...
   private Chunk readChunkFromNBT(World worldIn, NBTTagCompound compound) {
      ...
      for(int l = 0; l < nbttaglist.tagCount(); ++l) {
         ...
         ExtendedBlockStorage extendedblockstorage = new ExtendedBlockStorage(k1 << 4, flag);
