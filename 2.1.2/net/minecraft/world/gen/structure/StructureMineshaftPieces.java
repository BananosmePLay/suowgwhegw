   ...
   private static Peice createRandomShaftPiece(List<StructureComponent> p_189940_0_, Random p_189940_1_, int p_189940_2_, int p_189940_3_, int p_189940_4_, @Nullable EnumFacing p_189940_5_, int p_189940_6_, MapGenMineshaft.Type p_189940_7_) {
      ...
      if (i >= 80) {
         ...
         if (structureboundingbox1 != null) {
            return new Cross(p_189940_6_, p_189940_1_, structureboundingbox1, p_189940_5_, p_189940_7_);
         }
      } else if (i >= 70) {
         ...
         if (structureboundingbox1 != null) {
            return new Corridor(p_189940_6_, p_189940_1_, structureboundingbox1, p_189940_5_, p_189940_7_);
         }
      }
   ...
   public static class Room extends Peice {
      ...
      public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand) {
         ...
         for(k = 0; k < this.boundingBox.getXSize(); k += 4) {
            ...
            structurecomponent = StructureMineshaftPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX + k, this.boundingBox.minY + rand.nextInt(j) + 1, this.boundingBox.minZ - 1, EnumFacing.NORTH, i);
            if (structurecomponent != null) {
               structureboundingbox3 = structurecomponent.getBoundingBox();
               this.connectedRooms.add(new StructureBoundingBox(structureboundingbox3.minX, structureboundingbox3.minY, this.boundingBox.minZ, structureboundingbox3.maxX, structureboundingbox3.maxY, this.boundingBox.minZ + 1));
            }
         }
         ...
         for(k = 0; k < this.boundingBox.getXSize(); k += 4) {
            ...
            structurecomponent = StructureMineshaftPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX + k, this.boundingBox.minY + rand.nextInt(j) + 1, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, i);
            if (structurecomponent != null) {
               structureboundingbox3 = structurecomponent.getBoundingBox();
               this.connectedRooms.add(new StructureBoundingBox(structureboundingbox3.minX, structureboundingbox3.minY, this.boundingBox.maxZ - 1, structureboundingbox3.maxX, structureboundingbox3.maxY, this.boundingBox.maxZ));
            }
         }
         ...
         for(k = 0; k < this.boundingBox.getZSize(); k += 4) {
            ...
            structurecomponent = StructureMineshaftPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY + rand.nextInt(j) + 1, this.boundingBox.minZ + k, EnumFacing.WEST, i);
            if (structurecomponent != null) {
               structureboundingbox3 = structurecomponent.getBoundingBox();
         ...
         for(k = 0; k < this.boundingBox.getZSize(); k += 4) {
            ...
            structurecomponent = StructureMineshaftPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY + rand.nextInt(j) + 1, this.boundingBox.minZ + k, EnumFacing.EAST, i);
            if (structurecomponent != null) {
               structureboundingbox3 = ((StructureComponent)structurecomponent).getBoundingBox();
         ...
         if (i < 8) {
            ...
            if (enumfacing != EnumFacing.NORTH && enumfacing != EnumFacing.SOUTH) {
               for(k = this.boundingBox.minX + 3; k + 3 <= this.boundingBox.maxX; k += 5) {
                  l = rand.nextInt(5);
                  if (l == 0) {
                     StructureMineshaftPieces.generateAndAddPiece(componentIn, listIn, rand, k, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, i + 1);
                  } else if (l == 1) {
                     StructureMineshaftPieces.generateAndAddPiece(componentIn, listIn, rand, k, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, i + 1);
                  }
               }
            } else {
         ...
         if (this.isLiquidInStructureBoundingBox(worldIn, structureBoundingBoxIn)) {
            ...
            for(l2 = 0; l2 <= 2; ++l2) {
               for(j3 = 0; j3 <= i1; ++j3) {
                  ...
                  if (iblockstate3.getMaterial() == Material.AIR && this.getSkyBrightness(worldIn, l2, -1, j3, structureBoundingBoxIn) < 8) {
                     int l3 = true;
