...
public class StructureEndCityPieces {
            ...
            if (structureendcitypieces$citytemplate1 != null) {
               ...
               while(var14.hasNext()) {
                  ...
                  if (p_191086_6_.nextBoolean()) {
                     CityTemplate structureendcitypieces$citytemplate2 = StructureEndCityPieces.addHelper(p_191086_5_, StructureEndCityPieces.addPiece(p_191086_1_, structureendcitypieces$citytemplate1, (BlockPos)tuple.getSecond(), "bridge_end", rotation.add((Rotation)tuple.getFirst()), true));
         ...
         public boolean generate(TemplateManager p_191086_1_, int p_191086_2_, CityTemplate p_191086_3_, BlockPos p_191086_4_, List<StructureComponent> p_191086_5_, Random p_191086_6_) {
            ...
            for(int i = 0; i < 2 && p_191086_6_.nextInt(3) != 0; ++i) {
               ...
               while(var10.hasNext()) {
                  ...
                  if (p_191086_6_.nextBoolean()) {
                     CityTemplate structureendcitypieces$citytemplate1 = StructureEndCityPieces.addHelper(p_191086_5_, StructureEndCityPieces.addPiece(p_191086_1_, structureendcitypieces$citytemplate, (BlockPos)tuple.getSecond(), "bridge_end", rotation.add((Rotation)tuple.getFirst()), true));
   ...
   interface IGenerator {
      ...
      boolean generate(TemplateManager var1, int var2, CityTemplate var3, BlockPos var4, List<StructureComponent> var5, Random var6);
   }
