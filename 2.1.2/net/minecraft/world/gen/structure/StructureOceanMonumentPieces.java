...
public class StructureOceanMonumentPieces {
   ...
   interface MonumentRoomFitHelper {
      ...
      Piece create(EnumFacing var1, RoomDefinition var2, Random var3);
   }
   ...
   public static class MonumentBuilding extends Piece {
         ...
         while(true) {
            while(true) {
               ...
               do {
                  do {
                     if (!var8.hasNext()) {
                        ...
                        while(var18.hasNext()) {
                           Piece structureoceanmonumentpieces$piece = (Piece)var18.next();
                     ...
                     structureoceanmonumentpieces$roomdefinition = (RoomDefinition)var8.next();
               ...
               while(lvt_10_1_.hasNext()) {
                  MonumentRoomFitHelper structureoceanmonumentpieces$monumentroomfithelper = (MonumentRoomFitHelper)lvt_10_1_.next();
      ...
      private List<RoomDefinition> generateRoomGraph(Random p_175836_1_) {
         ...
         RoomDefinition[] var20 = astructureoceanmonumentpieces$roomdefinition;
         var8 = astructureoceanmonumentpieces$roomdefinition.length;

         for(var9 = 0; var9 < var8; ++var9) {
            RoomDefinition structureoceanmonumentpieces$roomdefinition4 = var20[var9];
         ...
         label93:
         while(var22.hasNext()) {
            RoomDefinition structureoceanmonumentpieces$roomdefinition3 = (RoomDefinition)var22.next();
            int j5 = 0;
            i1 = 0;
