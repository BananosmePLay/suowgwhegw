...
public class ComponentScatteredFeaturePieces {
   ...
   public static class DesertPyramid extends Feature {
      ...
      public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
         ...
         int i2;
         for(i2 = 1; i2 <= 9; ++i2) {
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, i2, i2, i2, this.width - 1 - i2, i2, this.depth - 1 - i2, Blocks.SANDSTONE.getDefaultState(), Blocks.SANDSTONE.getDefaultState(), false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, i2 + 1, i2, i2 + 1, this.width - 2 - i2, i2, this.depth - 2 - i2, Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false);
         }
         ...
         for(k2 = 5; k2 <= 17; k2 += 2) {
            ...
            this.setBlockState(worldIn, Blocks.SANDSTONE.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), this.width - 5, 1, k2, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.SANDSTONE.getStateFromMeta(BlockSandStone.EnumType.CHISELED.getMetadata()), this.width - 5, 2, k2, structureBoundingBoxIn);
         }
