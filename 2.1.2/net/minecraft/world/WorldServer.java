...
public class WorldServer extends World implements IThreadListener {
   ...
   protected BlockPos adjustPosToNearbyEntity(BlockPos pos) {
      ...
      AxisAlignedBB axisalignedbb = (new AxisAlignedBB(blockpos, new BlockPos(blockpos.getX(), this.getHeight(), blockpos.getZ()))).grow(3.0);
      ...
      if (this.worldInfo.getTerrainType() == WorldType.DEBUG_ALL_BLOCK_STATES) {
         ...
         if (i != this.pendingTickListEntriesHashSet.size()) {
            ...
            for(int j = 0; j < i; ++j) {
               ...
               if (!runAllPending && nextticklistentry1.scheduledTime > this.worldInfo.getWorldTotalTime()) {
                  break;
               }
   ...
   public void saveAllChunks(boolean all, @Nullable IProgressUpdate progressCallback) throws MinecraftException {
      ...
      if (chunkproviderserver.canSave()) {
         ...
         Iterator var4 = Lists.newArrayList((Iterable)chunkproviderserver.getLoadedChunks()).iterator();
   ...
   protected void saveLevel() throws MinecraftException {
      ...
      WorldServer[] var1 = this.server.worlds;
   ...
   public void loadEntities(Collection<Entity> entityCollection) {
      Iterator var2 = Lists.newArrayList((Iterable)entityCollection).iterator();
   ...
   public boolean addWeatherEffect(Entity entityIn) {
      if (super.addWeatherEffect(entityIn)) {
         this.server.getPlayerList().sendToAllNearExcept((EntityPlayer)null, entityIn.posX, entityIn.posY, entityIn.posZ, 512.0, this.provider.getDimensionType().getId(), new SPacketSpawnGlobalEntity(entityIn));
         return true;
      } else {
         return false;
      }
      ...
      while(!this.blockEventQueue[this.blockEventCacheIndex].isEmpty()) {
         ...
         while(var2.hasNext()) {
            ...
            if (this.fireBlockEvent(blockeventdata)) {
               this.server.getPlayerList().sendToAllNearExcept((EntityPlayer)null, (double)blockeventdata.getPosition().getX(), (double)blockeventdata.getPosition().getY(), (double)blockeventdata.getPosition().getZ(), 64.0, this.provider.getDimensionType().getId(), new SPacketBlockAction(blockeventdata.getPosition(), blockeventdata.getBlock(), blockeventdata.getEventID(), blockeventdata.getEventParameter()));
            }
         }
