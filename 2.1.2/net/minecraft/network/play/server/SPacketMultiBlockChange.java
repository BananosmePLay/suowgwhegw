...
public class SPacketMultiBlockChange implements Packet<INetHandlerPlayClient> {
   ...
   public void readPacketData(PacketBuffer buf) throws IOException {
      ...
      for(int i = 0; i < this.changedBlocks.length; ++i) {
         this.changedBlocks[i] = new BlockUpdateData(buf.readShort(), (IBlockState)Block.BLOCK_STATE_IDS.getByValue(buf.readVarInt()));
      }
   ...
   public void writePacketData(PacketBuffer buf) throws IOException {
      ...
      for(int var4 = 0; var4 < var3; ++var4) {
         BlockUpdateData spacketmultiblockchange$blockupdatedata = var2[var4];
