...
public class DataSerializers {
   ...
   public static final DataSerializer<Byte> BYTE = new DataSerializer<Byte>() {
      ...
      // $FF: synthetic method
      // $FF: bridge method
      public Object read(PacketBuffer var1) throws IOException {
         return this.read(var1);
      }

      // $FF: synthetic method
      // $FF: bridge method
      public void write(PacketBuffer var1, Object var2) {
   ...
   public static final DataSerializer<ItemStack> ITEM_STACK = new DataSerializer<ItemStack>() {
      ...
      // $FF: bridge method
      public Object copyValue(Object var1) {
         return this.copyValue((ItemStack)var1);
      }
   ...
   public static final DataSerializer<NBTTagCompound> COMPOUND_TAG = new DataSerializer<NBTTagCompound>() {
      ...
      // $FF: bridge method
      public Object copyValue(Object var1) {
         return this.copyValue((NBTTagCompound)var1);
      }
      ...
      // $FF: bridge method
      public void write(PacketBuffer var1, Object var2) {
         this.write(var1, (NBTTagCompound)var2);
      }
   };
