...
public abstract class PathNavigate {
   ...
   public Path getPathToPos(BlockPos pos) {
      if (!this.canNavigate()) {
         ...
         Path path = this.pathFinder.findPath(chunkcache, this.entity, (BlockPos)this.targetPos, f);
   ...
   public Path getPathToEntityLiving(Entity entityIn) {
      if (!this.canNavigate()) {
         ...
         if (this.currentPath != null && !this.currentPath.isFinished() && blockpos.equals(this.targetPos)) {
            ...
            Path path = this.pathFinder.findPath(chunkcache, this.entity, (Entity)entityIn, f);
            this.world.profiler.endSection();
            return path;
         }
      }
