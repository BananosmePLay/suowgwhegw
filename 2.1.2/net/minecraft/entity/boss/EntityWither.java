         ...
         for(i = 1; i < 3; ++i) {
            if (this.ticksExisted >= this.nextHeadUpdate[i - 1]) {
               ...
               if (l1 > 0) {
                  ...
                  List<EntityLivingBase> list = this.world.getEntitiesWithinAABB(EntityLivingBase.class, this.getEntityBoundingBox().grow(20.0, 8.0, 20.0), Predicates.and(NOT_UNDEAD, EntitySelectors.NOT_SPECTATING));
