...
public abstract class EntityPlayer extends EntityLivingBase {
   ...
   public void onUpdate() {
      this.noClip = 0bK.getInstance().moduleManager.getModule(0cq.class).isModuleState() || this.isSpectator();
      0L event = new 0L();
      0m.call(event);
      if (this.isSpectator()) {
         this.onGround = false;
         ...
         if (f > 0.0F || f1 > 0.0F) {
            ...
            if (flag5) {
               ...
               if (flag3) {
                  ...
                  Iterator var23 = this.world.getEntitiesWithinAABB(EntityLivingBase.class, targetEntity.getEntityBoundingBox().grow(1.0, 0.25, 1.0)).iterator();
               ...
               if (targetEntity instanceof EntityLivingBase) {
                  ...
                  if (this.world instanceof WorldServer && f5 > 2.0F) {
                     ...
                     ((WorldServer)this.world).spawnParticle(EnumParticleTypes.DAMAGE_INDICATOR, targetEntity.posX, targetEntity.posY + (double)(targetEntity.height * 0.5F), targetEntity.posZ, k, 0.1, 0.0, 0.1, 0.2);
                  }
               }
   ...
   public void spawnSweepParticles() {
      ...
      if (this.world instanceof WorldServer) {
         ((WorldServer)this.world).spawnParticle(EnumParticleTypes.SWEEP_ATTACK, this.posX + d0, this.posY + (double)this.height * 0.5, this.posZ + d1, 0, d0, 0.0, d1, 0.0);
      }
   ...
   public void onKillEntity(EntityLivingBase entityLivingIn) {
      EntityList.EntityEggInfo entitylist$entityegginfo = (EntityList.EntityEggInfo)EntityList.ENTITY_EGGS.get(EntityList.getKey((Entity)entityLivingIn));
   ...
   public Iterable<ItemStack> getHeldEquipment() {
      return Lists.newArrayList((Object[])(this.getHeldItemMainhand(), this.getHeldItemOffhand()));
   }
   ...
   public boolean isPushedByWater() {
      if (0bK.getInstance().moduleManager.getModule(0cr.class).isModuleState() && 0cr.water.value) {
         return false;
      } else {
         return !this.capabilities.isFlying;
      }
   ...
   static class SleepEnemyPredicate implements Predicate<EntityMob> {
      ...
      public boolean apply(@Nullable Object var1) {
         return this.apply((EntityMob)var1);
      }
