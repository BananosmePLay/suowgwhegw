...
public class ModifiableAttributeInstance implements IAttributeInstance {
   ...
   public void removeAllModifiers() {
      ...
      if (collection != null) {
         Iterator var2 = Lists.newArrayList((Iterable)collection).iterator();
   ...
   private Collection<AttributeModifier> getAppliedModifiers(int operation) {
      Set<AttributeModifier> set = Sets.newHashSet((Iterable)this.getModifiersByOperation(operation));
