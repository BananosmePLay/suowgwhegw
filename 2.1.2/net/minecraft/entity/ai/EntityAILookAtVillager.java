...
public class EntityAILookAtVillager extends EntityAIBase {
   ...
   public boolean shouldExecute() {
      if (!this.ironGolem.world.isDaytime()) {
         ...
         this.villager = (EntityVillager)this.ironGolem.world.findNearestEntityWithinAABB(EntityVillager.class, this.ironGolem.getEntityBoundingBox().grow(6.0, 2.0, 6.0), this.ironGolem);
