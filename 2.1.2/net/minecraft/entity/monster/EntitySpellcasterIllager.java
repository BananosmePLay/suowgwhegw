...
public abstract class EntitySpellcasterIllager extends AbstractIllager {
   ...
   protected SpellType getSpellType() {
      return !this.world.isRemote ? this.activeSpell : EntitySpellcasterIllager.SpellType.getFromId((Byte)this.dataManager.get(SPELL));
   }
   ...
   public static enum SpellType {
      ...
      public static SpellType getFromId(int idIn) {
         ...
         for(int var3 = 0; var3 < var2; ++var3) {
            SpellType entityspellcasterillager$spelltype = var1[var3];
