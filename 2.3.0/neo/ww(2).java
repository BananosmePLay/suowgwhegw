...
public abstract class ww<T extends Iu> extends wy<T> {
   public ww(wC rendermanagerIn, nH modelbaseIn, float shadowsizeIn) {
      super(rendermanagerIn, modelbaseIn, shadowsizeIn);
   }

   protected boolean canRenderName(T entity) {
      return super.canRenderName((Iw)entity) && (entity.getAlwaysRenderNameTagForRender() || entity.hasCustomName() && entity == this.renderManager.pointedEntity);
   }
   ...
   public boolean shouldRender(T livingEntity, uO camera, double camX, double camY, double camZ) {
      if (super.shouldRender(livingEntity, camera, camX, camY, camZ)) {
         ...
         Ig entity = livingEntity.getLeashHolder();
   ...
   protected void renderLeash(T entityLivingIn, double x, double y, double z, float entityYaw, float partialTicks) {
      if (!XH.isShaders() || !bpq.isShadowPass) {
         Ig entity = entityLivingIn.getLeashHolder();
         if (entity != null) {
   ...
   public boolean shouldRender(Ig var1, uO var2, double var3, double var5, double var7) {
      return this.shouldRender((Iu)var1, var2, var3, var5, var7);
   }
}
