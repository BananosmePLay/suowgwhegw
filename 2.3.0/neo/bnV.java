...
public class bnV {
   ...
   public static void setupBlend(int blend, float brightness) {
      switch (blend) {
         case 0:
            ...
            yh.color(1.0F, 1.0F, 1.0F, brightness);
            break;
         case 1:
            yh.disableAlpha();
            yh.enableBlend();
         ...
         case 3:
            yh.disableAlpha();
            yh.enableBlend();
            yh.blendFunc(774, 771);
            yh.color(brightness, brightness, brightness, brightness);
            break;
         case 4:
            yh.disableAlpha();
            yh.enableBlend();
   ...
   public static void clearBlend(float rainBrightness) {
      ...
      yh.enableBlend();
      yh.blendFunc(770, 1);
      yh.color(1.0F, 1.0F, 1.0F, rainBrightness);
   }
}
