...
public class Lz extends Lx {
   private static final Rd<Byte> HANGING;
   private BlockPos spawnPosition;

   public Lz(bij worldIn) {
      super(worldIn);
   ...
   public SoundEvent getAmbientSound() {
      return this.getIsBatHanging() && this.rand.nextInt(4) != 0 ? null : NO.ENTITY_BAT_AMBIENT;
   }

   protected SoundEvent getHurtSound(DamageSource damageSourceIn) {
      return NO.ENTITY_BAT_HURT;
   }

   protected SoundEvent getDeathSound() {
      return NO.ENTITY_BAT_DEATH;
   }
      ...
      if (this.getIsBatHanging()) {
         if (this.world.getBlockState(blockpos1).isNormalCube()) {
            ...
            if (this.world.getNearestPlayerNotCreative(this, 4.0) != null) {
               ...
               this.world.playEvent((ME)null, 1025, blockpos, 0);
            }
         } else {
            this.setIsBatHanging(false);
            this.world.playEvent((ME)null, 1025, blockpos, 0);
   ...
   public static void registerFixesBat(DataFixer fixer) {
      Iu.registerFixesMob(fixer, Lz.class);
   }
   ...
   protected ResourceLocation getLootTable() {
      return bhq.ENTITIES_BAT;
   }

   static {
      HANGING = Rv.createKey(Lz.class, Rt.BYTE);
   }
}
