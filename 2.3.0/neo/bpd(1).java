...
public class bpd implements Iterator<BlockPos> {
   ...
   private biN pos = new biN(0, 0, 0);
   private boolean hasNext = false;

   public bpd(BlockPos posStart, BlockPos posEnd, double yDelta, double zDelta) {
      this.yDelta = yDelta;
      this.zDelta = zDelta;
   ...
   public static void main(String[] args) throws Exception {
      ...
      double d0 = -0.5;
      double d1 = 0.5;
      bpd iteratoraxis = new bpd(blockpos, blockpos1, d0, d1);
