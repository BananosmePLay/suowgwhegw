...
public class om extends nH {
   ow[] segments = new ow[8];
   ow core;
   ...
   public om() {
      for(int i = 0; i < this.segments.length; ++i) {
         ...
         this.segments[i] = new ow(this, j, k);
         this.segments[i].addBox(-4.0F, (float)(16 + i), -4.0F, 8, 1, 8);
      }

      this.core = new ow(this, 0, 16);
   ...
   public void setLivingAnimations(Iw entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
      Kk entitymagmacube = (Kk)entitylivingbaseIn;
