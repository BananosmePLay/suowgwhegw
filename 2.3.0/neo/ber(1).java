...
public class ber extends beB {
   ...
   public ber(EnumFacing p_i45595_1_, beC p_i45595_2_, Random p_i45595_3_) {
   ...
   public boolean addComponentParts(bij worldIn, Random randomIn, bdy structureBoundingBoxIn) {
      ...
      beC structureoceanmonumentpieces$roomdefinition = this.roomDefinition.connections[EnumFacing.UP.getIndex()];
