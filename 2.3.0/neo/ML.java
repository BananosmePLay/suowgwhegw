...
public class ML {
   ...
   public void writeCapabilitiesToNBT(QQ tagCompound) {
   ...
   public void readCapabilitiesFromNBT(QQ tagCompound) {
      if (tagCompound.hasKey("abilities", 10)) {
         QQ nbttagcompound = tagCompound.getCompoundTag("abilities");
