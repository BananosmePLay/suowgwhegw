...
public abstract class Xn<T> extends Xm<T> {
   ...
   public Xn(T valueIn, Date startDate, String banner, Date endDate, String banReason) {
      super(valueIn);
   ...
   protected Xn(T valueIn, JsonObject json) {
      super(valueIn, json);
