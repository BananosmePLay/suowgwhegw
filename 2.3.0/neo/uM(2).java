...
public class uM extends uL {
   ...
   private final FloatBuffer projectionMatrixBuffer = xE.createDirectFloatBuffer(16);
   private final FloatBuffer modelviewMatrixBuffer = xE.createDirectFloatBuffer(16);
   private final FloatBuffer floatBuffer16 = xE.createDirectFloatBuffer(16);
   ...
   public void init() {
      ...
      yh.getFloat(2983, this.projectionMatrixBuffer);
      yh.getFloat(2982, this.modelviewMatrixBuffer);
