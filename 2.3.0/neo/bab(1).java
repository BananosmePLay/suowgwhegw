...
public class bab {
   private final List<ZZ> listeners = Lists.newArrayList();
   ...
   public double getClosestDistance(Ig entityIn) {
   ...
   public ZY getStatus() {
      if (this.endDiameter < this.startDiameter) {
         ...
         return this.endDiameter > this.startDiameter ? ZY.GROWING : ZY.STATIONARY;
      }
   }
   ...
   public void setCenter(double x, double z) {
      ...
      while(var5.hasNext()) {
         ZZ iborderlistener = (ZZ)var5.next();
   ...
   public double getDiameter() {
      if (this.getStatus() != ZY.STATIONARY) {
   ...
   public long getTimeUntilTarget() {
      return this.getStatus() == ZY.STATIONARY ? 0L : this.endTime - System.currentTimeMillis();
   }
   ...
   public void setTransition(double newSize) {
      ...
      while(var3.hasNext()) {
         ZZ iborderlistener = (ZZ)var3.next();
   ...
   public void setTransition(double oldSize, double newSize, long time) {
      ...
      while(var7.hasNext()) {
         ZZ iborderlistener = (ZZ)var7.next();
         iborderlistener.onTransitionStarted(this, oldSize, newSize, time);
      }

   }

   protected List<ZZ> getListeners() {
      return Lists.newArrayList(this.listeners);
   }

   public void addListener(ZZ listener) {
   ...
   public void setWarningTime(int warningTime) {
      ...
      while(var2.hasNext()) {
         ZZ iborderlistener = (ZZ)var2.next();
