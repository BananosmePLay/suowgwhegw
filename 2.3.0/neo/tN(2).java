...
public class tN {
   ...
   private zR vertexFormatElement;
   ...
   private zO vertexFormat;
   private boolean isDrawing;
   private BlockRenderLayer blockLayer = null;
   private boolean[] drawnIcons = new boolean[256];
   private zd[] quadSprites = null;
   private zd[] quadSpritesPrev = null;
   private zd quadSprite = null;
   public bpz sVertexBuilder;
   public boa renderEnv = null;
   ...
   public tN(int bufferSizeIn) {
      this.byteBuffer = xE.createDirectByteBuffer(bufferSizeIn * 4);
      this.rawIntBuffer = this.byteBuffer.asIntBuffer();
      this.rawShortBuffer = this.byteBuffer.asShortBuffer();
      this.rawFloatBuffer = this.byteBuffer.asFloatBuffer();
      bpz.initVertexBuilder(this);
   }
   ...
   private void growBuffer(int increaseAmount) {
      if (MathHelper.roundUp(increaseAmount, 4) / 4 > this.rawIntBuffer.remaining() || this.vertexCount * this.vertexFormat.getSize() + increaseAmount > this.byteBuffer.capacity()) {
         ...
         ByteBuffer bytebuffer = xE.createDirectByteBuffer(j);
         ...
         if (this.quadSprites != null) {
            zd[] atextureatlassprite = this.quadSprites;
            int l = this.getBufferQuadSize();
            this.quadSprites = new zd[l];
   ...
   public void sortVertexData(float cameraX, float cameraY, float cameraZ) {
      ...
      if (this.quadSprites != null) {
         zd[] atextureatlassprite = new zd[this.vertexCount / 4];
   ...
   public tM getVertexState() {
      ...
      zd[] atextureatlassprite = null;
      if (this.quadSprites != null) {
         int j = this.vertexCount / 4;
         atextureatlassprite = new zd[j];
         System.arraycopy(this.quadSprites, 0, atextureatlassprite, 0, j);
      }

      return new tM(this, aint, new zO(this.vertexFormat), atextureatlassprite);
   }
   ...
   public void setVertexState(tM state) {
      this.rawIntBuffer.clear();
      this.growBuffer(state.getRawBuffer().length * 4);
      this.rawIntBuffer.put(state.getRawBuffer());
      this.vertexCount = state.getVertexCount();
      this.vertexFormat = new zO(state.getVertexFormat());
      if (tM.access$000(state) != null) {
         if (this.quadSprites == null) {
            this.quadSprites = this.quadSpritesPrev;
         }

         if (this.quadSprites == null || this.quadSprites.length < this.getBufferQuadSize()) {
            this.quadSprites = new zd[this.getBufferQuadSize()];
         }

         zd[] atextureatlassprite = tM.access$000(state);
         System.arraycopy(atextureatlassprite, 0, this.quadSprites, 0, atextureatlassprite.length);
      } else {
         if (this.quadSprites != null) {
   ...
   public void begin(int glMode, zO format) {
      if (this.isDrawing) {
   ...
   public tN tex(double u, double v) {
   ...
   public tN lightmap(int skyLight, int blockLight) {
      int i = this.vertexCount * this.vertexFormat.getSize() + this.vertexFormat.getOffset(this.vertexFormatIndex);
      switch (this.vertexFormatElement.getType()) {
         case FLOAT:
   ...
   public tN color(float red, float green, float blue, float alpha) {
      return this.color((int)(red * 255.0F), (int)(green * 255.0F), (int)(blue * 255.0F), (int)(alpha * 255.0F));
   }

   public tN color(int red, int green, int blue, int alpha) {
      if (this.noColor) {
         return this;
      } else {
         int i = this.vertexCount * this.vertexFormat.getSize() + this.vertexFormat.getOffset(this.vertexFormatIndex);
   ...
   public void addVertexData(int[] vertexData) {
      if (XH.isShaders()) {
         bpz.beginAddVertexData(this, vertexData);
      }
   ...
   public void endVertex() {
      ...
      if (XH.isShaders()) {
         bpz.endAddVertex(this);
      }

   }

   public tN pos(double x, double y, double z) {
      if (XH.isShaders()) {
         bpz.beginAddVertex(this);
      }
   ...
   private void nextVertexFormatIndex() {
      ...
      this.vertexFormatElement = this.vertexFormat.getElement(this.vertexFormatIndex);
      if (this.vertexFormatElement.getUsage() == zQ.PADDING) {
         this.nextVertexFormatIndex();
      }

   }

   public tN normal(float x, float y, float z) {
      int i = this.vertexCount * this.vertexFormat.getSize() + this.vertexFormat.getOffset(this.vertexFormatIndex);
      switch (this.vertexFormatElement.getType()) {
         case FLOAT:
   ...
   public void putSprite(zd p_putSprite_1_) {
   ...
   public void setSprite(zd p_setSprite_1_) {
   ...
   public void drawMultiTexture() {
      if (this.quadSprites != null) {
         int i = XH.getMinecraft().getTextureMapBlocks().getCountRegisteredSprites();
         ...
         for(int i1 = 0; i1 < l; ++i1) {
            zd textureatlassprite = this.quadSprites[i1];
            if (textureatlassprite != null) {
               int j1 = textureatlassprite.getIndexInMap();
               if (!this.drawnIcons[j1]) {
                  if (textureatlassprite == bqS.iconGrassSideOverlay) {
                     if (k < 0) {
                        k = i1;
                     }
                  } else {
         ...
         if (k >= 0) {
            this.drawForIcon(bqS.iconGrassSideOverlay, k);
            ++j;
         }
   ...
   private int drawForIcon(zd p_drawForIcon_1_, int p_drawForIcon_2_) {
      ...
      for(int l = p_drawForIcon_2_; l < k; ++l) {
         zd textureatlassprite = this.quadSprites[l];
   ...
   public boa getRenderEnv(in p_getRenderEnv_1_, BlockPos p_getRenderEnv_2_) {
      if (this.renderEnv == null) {
         this.renderEnv = new boa(p_getRenderEnv_1_, p_getRenderEnv_2_);
   ...
   public void quadsToTriangles() {
      if (this.drawMode == 7) {
         if (this.byteBufferTriangles == null) {
            this.byteBufferTriangles = xE.createDirectByteBuffer(this.byteBuffer.capacity() * 2);
         }
   ...
   public void putBulkData(ByteBuffer p_putBulkData_1_) {
      if (XH.isShaders()) {
         bpz.beginAddVertexData(this, p_putBulkData_1_);
      }
