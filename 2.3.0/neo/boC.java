...
public class boC extends boB {
   ...
   public boC(String name, String type, String description, String value, String[] values, String path) {
   ...
   public static bou parseOption(String line, String path) {
      ...
      if (!matcher.matches()) {
         ...
         if (s1 != null && s1.length() > 0) {
            ...
            bou shaderoption = new boC(s1, s, s3, s2, astring, path);
            return shaderoption;
         } else {
            return null;
         }
