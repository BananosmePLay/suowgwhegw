...
public class AH {
   ...
   public static final Pattern PATTERN = Pattern.compile("%(\\d+\\$)?[\\d\\.]*[df]");
   ...
   public synchronized void loadLocaleDataFiles(AA resourceManager, List<String> languageList) {
   ...
   private void loadLocaleData(List<Az> resourcesList) throws IOException {
      Iterator var2 = resourcesList.iterator();

      while(var2.hasNext()) {
         Az iresource = (Az)var2.next();
