...
public abstract class ky extends ly {
   public ky(nC mcIn, int widthIn, int heightIn, int topIn, int bottomIn, int slotHeightIn) {
   ...
   public abstract kx getListEntry(int var1);
}
