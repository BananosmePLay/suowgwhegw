...
public class Gd extends Gi {
   ...
   public Gd(Ik creature, double speedIn, boolean useLongMemory) {
   ...
   public boolean shouldExecute() {
      Iw entitylivingbase = this.attacker.getAttackTarget();
   ...
   public boolean shouldContinueExecuting() {
      ...
      if (entitylivingbase == null) {
         ...
         return !(entitylivingbase instanceof ME) || !((ME)entitylivingbase).isSpectator() && !((ME)entitylivingbase).isCreative();
      }
   }
   ...
   public void resetTask() {
      Iw entitylivingbase = this.attacker.getAttackTarget();
      if (entitylivingbase instanceof ME && (((ME)entitylivingbase).isSpectator() || ((ME)entitylivingbase).isCreative())) {
