...
public abstract class Ik extends Iu {
   ...
   static {
      FLEEING_SPEED_MODIFIER = (new FW(FLEEING_SPEED_MODIFIER_UUID, "Fleeing speed bonus", 2.0, 2)).setSaved(false);
   }
}
