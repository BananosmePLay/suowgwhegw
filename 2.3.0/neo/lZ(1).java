...
public class lZ extends lU implements mx {
   private static final ResourceLocation CRAFTING_TABLE_GUI_TEXTURES = new ResourceLocation("textures/gui/container/crafting_table.png");
   private jL recipeButton;
   private final mu recipeBookGui;
   private boolean widthTooNarrow;

   public lZ(MJ playerInv, bij worldIn) {
      this(playerInv, worldIn, BlockPos.ORIGIN);
   }

   public lZ(MJ playerInv, bij worldIn, BlockPos blockPosition) {
      super(new ContainerWorkbench(playerInv, worldIn, blockPosition));
      this.recipeBookGui = new mu();
   }
   ...
   public void initGui() {
      ...
      this.recipeButton = new jL(10, this.guiLeft + 5, this.height / 2 - 49, 20, 18, 0, 168, 19, CRAFTING_TABLE_GUI_TEXTURES);
   ...
   protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
      this.fontRenderer.drawString(Ax.format("container.crafting"), 28, 6, 4210752);
