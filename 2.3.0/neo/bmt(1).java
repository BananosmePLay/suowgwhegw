...
public class bmt extends lg {
   ...
   public bmt(lg guiscreen, Bj gamesettings) {
      this.prevScreen = guiscreen;
      this.settings = gamesettings;
   }

   public void initGui() {
      this.title = Ax.format("of.options.performanceTitle");
   ...
   static {
      enumOptions = new Bi[]{Bi.SMOOTH_FPS, Bi.SMOOTH_WORLD, Bi.FAST_RENDER, Bi.FAST_MATH, Bi.CHUNK_UPDATES, Bi.CHUNK_UPDATES_DYNAMIC, Bi.RENDER_REGIONS, Bi.LAZY_CHUNK_LOADING, Bi.SMART_ANIMATIONS};
   }
}
