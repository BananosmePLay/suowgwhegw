...
public class qi extends pM {
   private final Ig attachedEntity;
   private int age;
   private final int lifetime;
   private final EnumParticleTypes particleTypes;

   public qi(bij worldIn, Ig p_i46279_2_, EnumParticleTypes particleTypesIn) {
      this(worldIn, p_i46279_2_, particleTypesIn, 3);
   }

   public qi(bij p_i47219_1_, Ig p_i47219_2_, EnumParticleTypes p_i47219_3_, int p_i47219_4_) {
   ...
   public void onUpdate() {
      for(int i = 0; i < 16; ++i) {
         ...
         if (d0 * d0 + d1 * d1 + d2 * d2 <= 1.0) {
            ...
            this.world.spawnParticle(this.particleTypes, false, d3, d4, d5, d0, d1 + 0.2, d2);
         }
      }
