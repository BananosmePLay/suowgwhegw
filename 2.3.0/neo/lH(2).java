...
public class lH extends lg {
   ...
   public lH(boolean poemIn, Runnable onFinishedIn) {
      this.poem = poemIn;
   ...
   private void drawWinGameScreen(int p_146575_1_, int p_146575_2_, float p_146575_3_) {
      ...
      f3 *= f3;
      f3 = f3 * 96.0F / 255.0F;
      bufferbuilder.pos(0.0, (double)this.height, (double)this.zLevel).tex(0.0, (double)(f * 0.015625F)).color(f3, f3, f3, 1.0F).endVertex();
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      yh.enableBlend();
      yh.blendFunc(ya.ZERO, xR.ONE_MINUS_SRC_COLOR);
      i1 = this.width;
      int k1 = this.height;
      bufferbuilder.begin(7, zK.POSITION_TEX_COLOR);
      bufferbuilder.pos(0.0, (double)k1, (double)this.zLevel).tex(0.0, 1.0).color(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
      bufferbuilder.pos((double)i1, (double)k1, (double)this.zLevel).tex(1.0, 1.0).color(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
      bufferbuilder.pos((double)i1, 0.0, (double)this.zLevel).tex(1.0, 0.0).color(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
