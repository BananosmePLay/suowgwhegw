...
public class bmj implements ARBDebugOutputCallback.Handler {
   public bmj() {
   }
   ...
   public static void createDisplayDebug() throws LWJGLException {
      ...
      ARBDebugOutput.glDebugMessageCallbackARB(new ARBDebugOutputCallback(new bmj()));
   ...
   public void handleMessage(int source, int type, int id, int severity, String message) {
      if (!message.contains("glBindFramebuffer") && !message.contains("Wide lines") && !message.contains("shader recompiled")) {
         XH.dbg("[LWJGL] source: " + this.getSource(source) + ", type: " + this.getType(type) + ", id: " + id + ", severity: " + this.getSeverity(severity) + ", message: " + message);
