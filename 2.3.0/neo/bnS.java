...
public class bnS {
   ...
   public static Object getFieldValue(Object obj, Class cls, Class fieldType) {
      bnN reflectorfield = getReflectorField(cls, fieldType);
      if (reflectorfield == null) {
         return null;
      } else {
         return !reflectorfield.exists() ? null : bnK.getFieldValue(obj, reflectorfield);
      }
   }

   public static Object getFieldValue(Object obj, Class cls, Class fieldType, int index) {
      bnN reflectorfield = getReflectorField(cls, fieldType, index);
      if (reflectorfield == null) {
         return null;
      } else {
         return !reflectorfield.exists() ? null : bnK.getFieldValue(obj, reflectorfield);
   ...
   public static boolean setFieldValue(Object obj, Class cls, Class fieldType, Object value) {
      ...
      if (reflectorfield == null) {
         ...
         return !reflectorfield.exists() ? false : bnK.setFieldValue(obj, reflectorfield, value);
      }
   }
   ...
   public static bnN getReflectorField(Class cls, Class fieldType) {
      Field field = getField(cls, fieldType);
      if (field == null) {
         return null;
      } else {
         bnL reflectorclass = new bnL(cls);
         return new bnN(reflectorclass, field.getName());
      }
   }

   public static bnN getReflectorField(Class cls, Class fieldType, int index) {
