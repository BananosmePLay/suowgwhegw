...
enum ju {
   ...
   private ju(int p_i47386_3_, int p_i47386_4_, int widthIn, int heightIn, int p_i47386_7_) {
   ...
   public void draw(jI guiIn, int x, int y, boolean p_192651_4_, int p_192651_5_) {
      int i = this.textureX;
      if (p_192651_5_ > 0) {
         i += this.width;
      }
   ...
   public void drawIcon(int p_192652_1_, int p_192652_2_, int p_192652_3_, yK renderItemIn, Qy stack) {
      ...
      renderItemIn.renderItemAndEffectIntoGUI((Iw)null, stack, i, j);
   }
   ...
   static {
      ...
      for(int var3 = 0; var3 < var2; ++var3) {
         ju advancementtabtype = var1[var3];
