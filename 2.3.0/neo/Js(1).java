...
public class Js extends Ig {
   public int xpColor;
   public int xpOrbAge;
   public int delayBeforeCanPickup;
   private int xpOrbHealth = 5;
   private int xpValue;
   private ME closestPlayer;
   private int xpTargetColor;

   public Js(bij worldIn, double x, double y, double z, int expValue) {
      super(worldIn);
   ...
   public boolean handleWaterMovement() {
      return this.world.handleMaterialAcceleration(this.getEntityBoundingBox(), hM.WATER, this);
   }
   ...
   public void onCollideWithPlayer(ME entityIn) {
      if (!this.world.isRemote && this.delayBeforeCanPickup == 0 && entityIn.xpCooldown == 0) {
         ...
         Qy itemstack = Ft.getEnchantedItem(NJ.MENDING, entityIn);
