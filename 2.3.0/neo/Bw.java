...
public class Bw {
   ...
   private final Bv shaderManager;

   public Bw(String name, int type, int count, Bv manager) {
   ...
   private void uploadInt() {
      switch (this.uniformType) {
         case 0:
            ys.glUniform1(this.uniformLocation, this.uniformIntBuffer);
            break;
         case 1:
            ys.glUniform2(this.uniformLocation, this.uniformIntBuffer);
            break;
         case 2:
            ys.glUniform3(this.uniformLocation, this.uniformIntBuffer);
            break;
         case 3:
            ys.glUniform4(this.uniformLocation, this.uniformIntBuffer);
            break;
         default:
   ...
   private void uploadFloat() {
      switch (this.uniformType) {
         case 4:
            ys.glUniform1(this.uniformLocation, this.uniformFloatBuffer);
            break;
         case 5:
            ys.glUniform2(this.uniformLocation, this.uniformFloatBuffer);
            break;
         case 6:
            ys.glUniform3(this.uniformLocation, this.uniformFloatBuffer);
            break;
         case 7:
            ys.glUniform4(this.uniformLocation, this.uniformFloatBuffer);
            break;
         default:
            LOGGER.warn("Uniform.upload called, but count value ({}) is not in the range of 1 to 4. Ignoring.", this.uniformCount);
      }
   ...
   private void uploadFloatMatrix() {
      switch (this.uniformType) {
         case 8:
            ys.glUniformMatrix2(this.uniformLocation, true, this.uniformFloatBuffer);
            break;
         case 9:
            ys.glUniformMatrix3(this.uniformLocation, true, this.uniformFloatBuffer);
            break;
         case 10:
            ys.glUniformMatrix4(this.uniformLocation, true, this.uniformFloatBuffer);
      }
