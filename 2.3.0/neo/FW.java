...
public class FW {
   ...
   public FW(String nameIn, double amountIn, int operationIn) {
      this(MathHelper.getRandomUUID(ThreadLocalRandom.current()), nameIn, amountIn, operationIn);
   }

   public FW(UUID idIn, String nameIn, double amountIn, int operationIn) {
      this.isSaved = true;
      this.id = idIn;
      this.name = nameIn;
   ...
   public FW setSaved(boolean saved) {
      this.isSaved = saved;
      return this;
   }
   ...
   public boolean equals(Object p_equals_1_) {
      if (this == p_equals_1_) {
         ...
         FW attributemodifier = (FW)p_equals_1_;
         if (this.id != null) {
