...
public class bmY {
   private bmX lightMap;
   private bmX lightMapRain;
   private bmX lightMapThunder;
   private int[] colorBuffer1 = new int[0];
   private int[] colorBuffer2 = new int[0];

   public bmY(bmX lightMap, bmX lightMapRain, bmX lightMapThunder) {
   ...
   public boolean updateLightmap(bij world, float torchFlickerX, int[] lmColors, boolean nightvision, float partialTicks) {
      if (this.lightMapRain == null && this.lightMapThunder == null) {
         ...
         if (dimensiontype != baM.THE_END && dimensiontype != baM.NETHER) {
