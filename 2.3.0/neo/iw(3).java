...
public class iw {
   ...
   private final Map<Character, Predicate<ik>> symbolMap = Maps.newHashMap();
   ...
   public static iw start() {
      return new iw();
   }

   public iw where(char symbol, Predicate<ik> blockMatcher) {
      this.symbolMap.put(symbol, blockMatcher);
      return this;
   }

   public it build() {
      return new it(this.makePredicateArray());
   }

   private Predicate<ik>[][][] makePredicateArray() {
      this.checkMissingPredicates();
      Predicate<ik>[][][] predicate = (Predicate[][][])((Predicate[][][])((Predicate[][][])Array.newInstance(Predicate.class, new int[]{this.depth.size(), this.aisleHeight, this.rowWidth})));
   ...
   private void checkMissingPredicates() {
      ...
      while(var2.hasNext()) {
         Map.Entry<Character, Predicate<ik>> entry = (Map.Entry)var2.next();
