...
public class oe extends nH {
   private final ow head;
   private final ow upperMouth;
   private final ow lowerMouth;
   private final ow horseLeftEar;
   private final ow horseRightEar;
   private final ow muleLeftEar;
   private final ow muleRightEar;
   private final ow neck;
   private final ow horseFaceRopes;
   private final ow mane;
   private final ow body;
   private final ow tailBase;
   private final ow tailMiddle;
   private final ow tailTip;
   private final ow backLeftLeg;
   private final ow backLeftShin;
   private final ow backLeftHoof;
   private final ow backRightLeg;
   private final ow backRightShin;
   private final ow backRightHoof;
   private final ow frontLeftLeg;
   private final ow frontLeftShin;
   private final ow frontLeftHoof;
   private final ow frontRightLeg;
   private final ow frontRightShin;
   private final ow frontRightHoof;
   private final ow muleLeftChest;
   private final ow muleRightChest;
   private final ow horseSaddleBottom;
   private final ow horseSaddleFront;
   private final ow horseSaddleBack;
   private final ow horseLeftSaddleRope;
   private final ow horseLeftSaddleMetal;
   private final ow horseRightSaddleRope;
   private final ow horseRightSaddleMetal;
   private final ow horseLeftFaceMetal;
   private final ow horseRightFaceMetal;
   private final ow horseLeftRein;
   private final ow horseRightRein;

   public oe() {
      this.textureWidth = 128;
      this.textureHeight = 128;
      this.body = new ow(this, 0, 34);
      this.body.addBox(-5.0F, -8.0F, -19.0F, 10, 10, 24);
      this.body.setRotationPoint(0.0F, 11.0F, 9.0F);
      this.tailBase = new ow(this, 44, 0);
      ...
      this.tailMiddle = new ow(this, 38, 7);
      ...
      this.upperMouth = new ow(this, 24, 18);
      ...
      this.lowerMouth = new ow(this, 24, 27);
      ...
      this.horseLeftEar = new ow(this, 0, 0);
      ...
      this.horseRightEar = new ow(this, 0, 0);
      ...
      this.muleLeftEar = new ow(this, 0, 12);
      ...
      this.muleRightEar = new ow(this, 0, 12);
      ...
      this.muleRightChest = new ow(this, 0, 47);
      ...
      this.horseRightFaceMetal = new ow(this, 74, 13);
   ...
   public void render(Ig entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
      ...
      boolean flag2 = abstracthorse instanceof Lu;
      boolean flag3 = !flag && flag2 && ((Lu)abstracthorse).hasChest();
      ...
      if (flag) {
         yh.pushMatrix();
         yh.scale(f1, 0.5F + f1 * 0.5F, f1);
         yh.translate(0.0F, 0.95F * (1.0F - f1), 0.0F);
      }
      ...
      if (flag) {
         ...
         yh.pushMatrix();
         yh.scale(f1, f1, f1);
         yh.translate(0.0F, 1.35F * (1.0F - f1), 0.0F);
      }
      ...
      if (flag) {
         ...
         if (f <= 0.0F) {
            ...
            yh.translate(0.0F, 0.9F * (1.0F - f1) * f + 1.35F * (1.0F - f1) * (1.0F - f), 0.15F * (1.0F - f1) * f);
         }
      }
   ...
   public void setLivingAnimations(Iw entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
      ...
      Lw abstracthorse = (Lw)entitylivingbaseIn;
