...
public class pS extends pM {
   protected pS(bij worldIn, double posXIn, double posYIn, double posZIn, OL itemIn) {
      this(worldIn, posXIn, posYIn, posZIn, itemIn, 0);
   }

   protected pS(bij worldIn, double posXIn, double posYIn, double posZIn, double xSpeedIn, double ySpeedIn, double zSpeedIn, OL itemIn, int meta) {
   ...
   protected pS(bij worldIn, double posXIn, double posYIn, double posZIn, OL itemIn, int meta) {
      super(worldIn, posXIn, posYIn, posZIn, 0.0, 0.0, 0.0);
      this.setParticleTexture(nC.getMinecraft().getRenderItem().getItemModelMesher().getParticleIcon(itemIn, meta));
      this.particleRed = 1.0F;
      this.particleGreen = 1.0F;
      this.particleBlue = 1.0F;
      this.particleGravity = Nk.SNOW.blockParticleGravity;
