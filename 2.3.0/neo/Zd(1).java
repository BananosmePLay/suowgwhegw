...
public class Zd {
   ...
   private boolean trySetupSiege() {
      List<ME> list = this.world.playerEntities;
   ...
   private boolean spawnZombie() {
      ...
      if (vec3d == null) {
         ...
         Lk entityzombie;
         try {
            entityzombie = new Lk(this.world);
   ...
   private Vec3d findRandomSpawnPos(BlockPos pos) {
      for(int i = 0; i < 10; ++i) {
         ...
         if (this.village.isBlockPosWithinSqVillageRadius(blockpos) && bik.canCreatureTypeSpawnAtLocation(It.ON_GROUND, this.world, blockpos)) {
