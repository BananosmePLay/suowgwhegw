...
abstract class bcY extends bdB {
   protected int width;
   ...
   protected bcY(Random rand, int x, int y, int z, int sizeX, int sizeY, int sizeZ) {
      super(0);
      this.width = sizeX;
      this.height = sizeY;
      this.depth = sizeZ;
      ...
      if (this.getCoordBaseMode().getAxis() == EnumFacing.Axis.Z) {
         this.boundingBox = new bdy(x, y, z, x + sizeX - 1, y + sizeY - 1, z + sizeZ - 1);
      } else {
         this.boundingBox = new bdy(x, y, z, x + sizeZ - 1, y + sizeY - 1, z + sizeX - 1);
      }
   ...
   protected boolean offsetToAverageGroundLevel(bij worldIn, bdy structurebb, int yOffset) {
