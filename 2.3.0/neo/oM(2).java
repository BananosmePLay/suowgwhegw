...
public class oM extends oL {
   ...
   private final ow mole = (new ow(this)).setTextureSize(64, 128);
   private final ow witchHat;

   public oM(float scale) {
      ...
      this.witchHat = (new ow(this)).setTextureSize(64, 128);
      this.witchHat.setRotationPoint(-5.0F, -10.03125F, -5.0F);
      this.witchHat.setTextureOffset(0, 64).addBox(0.0F, 0.0F, 0.0F, 10, 2, 10);
      this.villagerHead.addChild(this.witchHat);
      ow modelrenderer = (new ow(this)).setTextureSize(64, 128);
      ...
      ow modelrenderer1 = (new ow(this)).setTextureSize(64, 128);
      ...
      ow modelrenderer2 = (new ow(this)).setTextureSize(64, 128);
