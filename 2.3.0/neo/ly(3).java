...
public abstract class ly {
   ...
   public ly(nC mcIn, int width, int height, int topIn, int bottomIn, int slotHeightIn) {
      this.mc = mcIn;
      this.width = width;
      this.height = height;
      this.top = topIn;
   ...
   public void actionPerformed(jK button) {
      if (button.enabled) {
            ...
            if (this.initialClickY != -1) {
               ...
               if (this.mouseY >= this.top && this.mouseY <= this.bottom) {
                  ...
                  if (i1 < this.getSize() && this.mouseX >= j2 && this.mouseX <= k2 && i1 >= 0 && l2 >= 0) {
                     boolean flag = i1 == this.selectedElement && nC.getSystemTime() - this.lastClicked < 250L;
                     this.elementClicked(i1, flag, this.mouseX, this.mouseY);
                     this.selectedElement = i1;
                     this.lastClicked = nC.getSystemTime();
   ...
   protected void drawSelectionBox(int insideLeft, int insideTop, int mouseXIn, int mouseYIn, float partialTicks) {
      ...
      for(int j = 0; j < i; ++j) {
         ...
         if (!(this instanceof le) || k >= this.top - this.slotHeight && k <= this.bottom) {
   ...
   protected void drawContainerBackground(yN p_drawContainerBackground_1_) {
      tN bufferbuilder = p_drawContainerBackground_1_.getBuffer();
      this.mc.getTextureManager().bindTexture(jI.OPTIONS_BACKGROUND);
      yh.color(1.0F, 1.0F, 1.0F, 1.0F);
      float f = 32.0F;
      bufferbuilder.begin(7, zK.POSITION_TEX_COLOR);
