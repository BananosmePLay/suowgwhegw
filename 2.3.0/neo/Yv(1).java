...
public class Yv extends Yg implements ITickable, bga {
   ...
   public void update() {
      ...
      ME entityplayer = this.world.getClosestPlayer((double)((float)this.pos.getX() + 0.5F), (double)((float)this.pos.getY() + 0.5F), (double)((float)this.pos.getZ() + 0.5F), 3.0, false);
