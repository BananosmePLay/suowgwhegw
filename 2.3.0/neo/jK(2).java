...
public class jK extends jI {
   ...
   public jK(int buttonId, int x, int y, String buttonText) {
      this(buttonId, x, y, 200, 20, buttonText);
   }

   public jK(int buttonId, int x, int y, int widthIn, int heightIn, String buttonText) {
      this.enabled = true;
      this.visible = true;
      this.id = buttonId;
      this.x = x;
   ...
   public void drawButton(nC mc, int mouseX, int mouseY, float partialTicks) {
      if (this.visible) {
         jH fontrenderer = mc.fontRenderer;
   ...
   public void playPressSound(iU soundHandlerIn) {
      soundHandlerIn.playSound(iN.getMasterRecord(NO.UI_BUTTON_CLICK, 1.0F));
   }
