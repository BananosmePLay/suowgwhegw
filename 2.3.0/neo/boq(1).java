...
public class boq {
   ...
   public boq(int type, String name, String value, String line) {
      this.type = type;
      this.name = name;
      this.value = value;
      this.line = line;
      ...
      if (this.value == null) {
         ...
         if (astring.length != 4) {
            ...
            for(int i = 0; i < astring.length; ++i) {
               String s1 = astring[i];
               s1 = bqP.removeSuffix(s1, new String[]{"F", "f"});
               float f = XH.parseFloat(s1, Float.MAX_VALUE);
