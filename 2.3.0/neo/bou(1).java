...
public abstract class bou {
   ...
   public bou(String name, String description, String value, String[] values, String valueDefault, String path) {
      this.name = name;
   ...
   public String getDescriptionText() {
      String s = XH.normalize(this.description);
      s = bqP.removePrefix(s, "//");
      s = bpq.translate("option." + this.getName() + ".comment", s);
      return s;
   }
   ...
   public void addPaths(String[] newPaths) {
      ...
      for(int i = 0; i < newPaths.length; ++i) {
         String s = newPaths[i];
         if (!list.contains(s)) {
            this.paths = (String[])((String[])XH.addObjectToArray(this.paths, s));
         }
      }
   ...
   public boolean isChanged() {
      return !XH.equals(this.value, this.valueDefault);
   }
   ...
   public String getNameText() {
      return bpq.translate("option." + this.name, this.name);
   }

   public String getValueText(String val) {
      return bpq.translate("value." + this.name + "." + val, val);
   }
   ...
   public String toString() {
      return "" + this.name + ", value: " + this.value + ", valueDefault: " + this.valueDefault + ", paths: " + XH.arrayToString((Object[])this.paths);
   }
}
