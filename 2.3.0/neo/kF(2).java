...
public class kF extends lg {
   public kF() {
   }

   public void initGui() {
      this.buttonList.clear();
      this.buttonList.add(new kK(0, this.width / 2 - 155, this.height / 4 + 120 + 12, Ax.format("gui.toTitle")));
      this.buttonList.add(new kK(1, this.width / 2 - 155 + 160, this.height / 4 + 120 + 12, Ax.format("menu.quit")));
   }
