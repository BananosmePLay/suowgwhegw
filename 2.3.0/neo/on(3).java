...
public class on extends nH {
   public ow[] sideModels = new ow[7];

   public on() {
      this.sideModels[0] = new ow(this, 0, 10);
      this.sideModels[1] = new ow(this, 0, 0);
      this.sideModels[2] = new ow(this, 0, 0);
      this.sideModels[3] = new ow(this, 0, 0);
      this.sideModels[4] = new ow(this, 0, 0);
      this.sideModels[5] = new ow(this, 44, 10);
      int i = true;
      int j = true;
      int k = true;
      int l = true;
