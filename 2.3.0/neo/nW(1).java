...
public class nW extends nH {
   private final ow head;
   private final ow jaw;

   public nW(float p_i46588_1_) {
   ...
   public void render(Ig entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
      this.jaw.rotateAngleX = (float)(Math.sin((double)(limbSwing * 3.1415927F * 0.2F)) + 1.0) * 0.2F;
      this.head.rotateAngleY = netHeadYaw * 0.017453292F;
      this.head.rotateAngleX = headPitch * 0.017453292F;
      yh.translate(0.0F, -0.374375F, 0.0F);
