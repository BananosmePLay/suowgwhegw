...
public class bof extends uL {
   private static bof instance = new bof();
   ...
   public void init() {
      ...
      System.arraycopy(bpq.faProjection, 0, afloat, 0, 16);
      System.arraycopy(bpq.faModelView, 0, afloat1, 0, 16);
      bpw.multiplyMat4xMat4(afloat2, afloat1, afloat);
      ...
      float[] afloat3 = bpq.shadowLightPositionVector;
