...
public class pW extends pM {
   float oSize;

   protected pW(bij worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double p_i1221_8_, double p_i1221_10_, double p_i1221_12_) {
      ...
      float f1 = 1.0F - (float)(Math.random() * 0.30000001192092896);
      this.particleRed = f1;
   ...
   public void onUpdate() {
      ...
      ME entityplayer = this.world.getClosestPlayer(this.posX, this.posY, this.posZ, 2.0, false);
