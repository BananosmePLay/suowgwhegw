...
public class nM extends nH {
   public ow bipedHead;
   public ow bipedHeadwear;
   public ow bipedBody;
   public ow bipedRightArm;
   public ow bipedLeftArm;
   public ow bipedRightLeg;
   public ow bipedLeftLeg;
   public nL leftArmPose;
   public nL rightArmPose;
   ...
   public nM(float modelSize) {
      this(modelSize, 0.0F, 64, 32);
   }

   public nM(float modelSize, float p_i1149_2_, int textureWidthIn, int textureHeightIn) {
   ...
   public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Ig entityIn) {
      boolean flag = entityIn instanceof Iw && ((Iw)entityIn).getTicksElytraFlying() > 4;
      ...
      if (this.swingProgress > 0.0F) {
         ...
         ow modelrenderer = this.getArmForSide(enumhandside);
      ...
      var10000 = this.bipedLeftArm;
      var10000.rotateAngleX -= MathHelper.sin(ageInTicks * 0.067F) * 0.05F;
      if (this.rightArmPose == nL.BOW_AND_ARROW) {
         this.bipedRightArm.rotateAngleY = -0.1F + this.bipedHead.rotateAngleY;
         this.bipedLeftArm.rotateAngleY = 0.1F + this.bipedHead.rotateAngleY + 0.4F;
         this.bipedRightArm.rotateAngleX = -1.5707964F + this.bipedHead.rotateAngleX;
         this.bipedLeftArm.rotateAngleX = -1.5707964F + this.bipedHead.rotateAngleX;
      } else if (this.leftArmPose == nL.BOW_AND_ARROW) {
   ...
   protected ow getArmForSide(EnumHandSide side) {
      return side == EnumHandSide.LEFT ? this.bipedLeftArm : this.bipedRightArm;
   }

   protected EnumHandSide getMainHand(Ig entityIn) {
