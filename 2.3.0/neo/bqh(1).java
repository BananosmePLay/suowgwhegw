...
public class bqh {
   ...
   public static Object[] addObjectsToArray(Object[] arr2, Object[] objs) {
      if (arr2 == null) {
         ...
         Object[] newArr = (Object[])((Object[])Array.newInstance(arr2.getClass().getComponentType(), newLen));
   ...
   public static Object[] addObjectToArray(Object[] arr2, Object obj, int index) {
      ArrayList<Object> list = new ArrayList(Arrays.asList(arr2));
      list.add(index, obj);
      Object[] newArr = (Object[])((Object[])Array.newInstance(arr2.getClass().getComponentType(), list.size()));
