...
public class GX extends Gi {
   protected final Ik creature;
   protected double speed;
   protected double randPosX;
   protected double randPosY;
   protected double randPosZ;

   public GX(Ik creature, double speedIn) {
   ...
   protected boolean findRandomPosition() {
      Vec3d vec3d = HA.findRandomTarget(this.creature, 5, 4);
      if (vec3d == null) {
         return false;
      } else {
   ...
   @Nullable
   private BlockPos getRandPos(bij worldIn, Ig entityIn, int horizontalRange, int verticalRange) {
