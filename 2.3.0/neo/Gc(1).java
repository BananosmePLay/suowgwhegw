...
public class Gc extends FX {
   ...
   public Gc(@Nullable FY parentIn, String unlocalizedNameIn, double defaultValue, double minimumValueIn, double maximumValueIn) {
   ...
   public Gc setDescription(String descriptionIn) {
