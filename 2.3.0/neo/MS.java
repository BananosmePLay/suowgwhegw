...
public abstract class MS extends Ig {
   public Iw shootingEntity;
   ...
   public MS(bij worldIn, double x, double y, double z, double accelX, double accelY, double accelZ) {
      super(worldIn);
      this.setSize(1.0F, 1.0F);
   ...
   public MS(bij worldIn, Iw shooter, double accelX, double accelY, double accelZ) {
      super(worldIn);
   ...
   public void onUpdate() {
      if (this.world.isRemote || (this.shootingEntity == null || !this.shootingEntity.isDead) && this.world.isBlockLoaded(new BlockPos(this))) {
         ...
         ++this.ticksInAir;
         RayTraceResult raytraceresult = Nh.forwardsRaycast(this, true, this.ticksInAir >= 25, this.shootingEntity);
         ...
         Nh.rotateTowardsMovement(this, 0.2F);
   ...
   public boolean attackEntityFrom(DamageSource source, float amount) {
      if (this.isEntityInvulnerable(source)) {
         ...
         if (source.getTrueSource() != null) {
            ...
            if (source.getTrueSource() instanceof Iw) {
               this.shootingEntity = (Iw)source.getTrueSource();
            }
