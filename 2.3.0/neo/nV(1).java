...
public class nV extends nH {
   ...
   private final ow spine;
   private final ow jaw;
   private final ow body;
   private final ow rearLeg;
   private final ow frontLeg;
   private final ow rearLegTip;
   private final ow frontLegTip;
   private final ow rearFoot;
   private final ow frontFoot;
   private final ow wing;
   private final ow wingTip;
   private float partialTicks;

   public nV(float p_i46360_1_) {
   ...
   public void render(Ig entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
      ...
      yh.rotate(-f6 * 1.5F, 0.0F, 0.0F, 1.0F);
      yh.translate(0.0F, -1.0F, 0.0F);
