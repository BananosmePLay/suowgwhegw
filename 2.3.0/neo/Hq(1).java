...
public class Hq extends Gi {
   protected Iu entity;
   protected Ig closestEntity;
   protected float maxDistance;
   private int lookTime;
   private final float chance;
   protected Class<? extends Ig> watchedClass;

   public Hq(Iu entityIn, Class<? extends Ig> watchTargetClass, float maxDistance) {
   ...
   public Hq(Iu entityIn, Class<? extends Ig> watchTargetClass, float maxDistance, float chanceIn) {
      this.entity = entityIn;
      this.watchedClass = watchTargetClass;
      this.maxDistance = maxDistance;
   ...
   public boolean shouldExecute() {
      if (this.entity.getRNG().nextFloat() >= this.chance) {
         ...
         if (this.watchedClass == ME.class) {
            ...
            this.closestEntity = this.entity.world.findNearestEntityWithinAABB(this.watchedClass, this.entity.getEntityBoundingBox().grow((double)this.maxDistance, 3.0, (double)this.maxDistance), this.entity);
         }
