...
public class QV extends QH {
   private int[] intArray;

   QV() {
   }

   public QV(int[] p_i45132_1_) {
      this.intArray = p_i45132_1_;
   }

   public QV(List<Integer> p_i47528_1_) {
   ...
   public boolean equals(Object p_equals_1_) {
      return super.equals(p_equals_1_) && Arrays.equals(this.intArray, ((QV)p_equals_1_).intArray);
   }
