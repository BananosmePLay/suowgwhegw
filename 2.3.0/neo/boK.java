...
public class boK implements boZ {
   private bqc type;
   private int textureUnit;
   private int textureId;

   public boK(bqc type, bpZ internalFormat, int width, int height, int depth, bqa pixelFormat, bqb pixelType, ByteBuffer data, int textureUnit, boolean blur, boolean clamp) {
      this.type = type;
