...
public class oo extends nH {
   private final ow ocelotBackLeftLeg;
   private final ow ocelotBackRightLeg;
   private final ow ocelotFrontLeftLeg;
   private final ow ocelotFrontRightLeg;
   private final ow ocelotTail;
   private final ow ocelotTail2;
   private final ow ocelotHead;
   private final ow ocelotBody;
   private int state = 1;
   ...
   public oo() {
      ...
      this.ocelotHead = new ow(this, "head");
   ...
   public void render(Ig entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
      ...
      if (this.isChild) {
         ...
         yh.translate(0.0F, 10.0F * scale, 4.0F * scale);
   ...
   public void setLivingAnimations(Iw entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
      LN entityocelot = (LN)entitylivingbaseIn;
