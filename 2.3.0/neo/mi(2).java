...
public class mi extends lU {
   ...
   private final Lw horseEntity;
   private float mousePosx;
   private float mousePosY;

   public mi(IInventory playerInv, IInventory horseInv, Lw horse) {
      nC.getMinecraft();
      super(new ContainerHorseInventory(playerInv, horseInv, horse, nC.player));
   ...
   protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
      ...
      if (this.horseEntity instanceof Lu) {
         Lu abstractchesthorse = (Lu)this.horseEntity;
      ...
      if (this.horseEntity.wearsArmor()) {
         if (this.horseEntity instanceof LK) {
      ...
      mh.drawEntityOnScreen(i + 51, j + 60, 17, (float)(i + 51) - this.mousePosx, (float)(j + 75 - 50) - this.mousePosY, this.horseEntity);
   }
