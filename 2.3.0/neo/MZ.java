...
public class MZ extends Ig {
   ...
   public MZ(bij worldIn, double x, double y, double z, double motionXIn, double motionYIn, double motionZIn) {
      this(worldIn);
   ...
   public MZ(bij worldIn, Iw ownerIn, Ig targetIn, EnumFacing.Axis p_i46772_4_) {
      this(worldIn);
      this.owner = ownerIn;
   ...
   protected void writeEntityToNBT(QQ compound) {
      ...
      if (this.owner != null) {
         ...
         nbttagcompound1 = Rb.createUUIDTag(this.owner.getUniqueID());
      ...
      if (this.target != null) {
         ...
         nbttagcompound1 = Rb.createUUIDTag(this.target.getUniqueID());
         nbttagcompound1.setInteger("X", blockpos1.getX());
         nbttagcompound1.setInteger("Y", blockpos1.getY());
         nbttagcompound1.setInteger("Z", blockpos1.getZ());
   ...
   protected void readEntityFromNBT(QQ compound) {
      ...
      if (compound.hasKey("Owner", 10)) {
         ...
         this.ownerUniqueId = Rb.getUUIDFromTag(nbttagcompound1);
      ...
      if (compound.hasKey("Target", 10)) {
         ...
         this.targetUniqueId = Rb.getUUIDFromTag(nbttagcompound1);
      ...
      if (!this.world.isRemote && this.world.getDifficulty() == baV.PEACEFUL) {
         ...
         if (!this.world.isRemote) {
            ...
            if (this.target == null && this.targetUniqueId != null) {
               var1 = this.world.getEntitiesWithinAABB(Iw.class, new AxisAlignedBB(this.targetBlockPos.add(-2, -2, -2), this.targetBlockPos.add(2, 2, 2))).iterator();

               while(var1.hasNext()) {
                  entitylivingbase1 = (Iw)var1.next();
            ...
            if (this.owner == null && this.ownerUniqueId != null) {
               var1 = this.world.getEntitiesWithinAABB(Iw.class, new AxisAlignedBB(this.ownerBlockPos.add(-2, -2, -2), this.ownerBlockPos.add(2, 2, 2))).iterator();
            ...
            if (this.target != null && this.target.isEntityAlive() && (!(this.target instanceof ME) || !((ME)this.target).isSpectator())) {
            ...
            RayTraceResult raytraceresult = Nh.forwardsRaycast(this, true, false, this.owner);
         ...
         Nh.rotateTowardsMovement(this, 0.5F);
         if (this.world.isRemote) {
            this.world.spawnParticle(EnumParticleTypes.END_ROD, this.posX - this.motionX, this.posY - this.motionY + 0.15, this.posZ - this.motionZ, 0.0, 0.0, 0.0);
   ...
   protected void bulletHit(RayTraceResult result) {
      if (result.entityHit == null) {
         ((bis)this.world).spawnParticle(EnumParticleTypes.EXPLOSION_LARGE, this.posX, this.posY, this.posZ, 2, 0.2, 0.2, 0.2, 0.0);
         this.playSound(NO.ENTITY_SHULKER_BULLET_HIT, 1.0F, 1.0F);
      } else {
         ...
         if (flag) {
            ...
            if (result.entityHit instanceof Iw) {
               ((Iw)result.entityHit).addPotionEffect(new VZ(NL.LEVITATION, 200));
            }
         }
      }
   ...
   public boolean attackEntityFrom(DamageSource source, float amount) {
      if (!this.world.isRemote) {
         this.playSound(NO.ENTITY_SHULKER_BULLET_HURT, 1.0F, 1.0F);
         ((bis)this.world).spawnParticle(EnumParticleTypes.CRIT, this.posX, this.posY, this.posZ, 15, 0.2, 0.2, 0.2, 0.0);
         this.setDead();
      }
