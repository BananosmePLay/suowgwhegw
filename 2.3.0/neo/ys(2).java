...
public class ys {
   ...
   private static yr framebufferType;
   ...
   public static void initializeTextures() {
      ...
      if (!vboRegions) {
         ...
         String s = "VboRegions not supported, missing: " + XH.listToString(list);
         XH.dbg(s);
         logText = logText + s + "\n";
      }
      ...
      String s1 = GL11.glGetString(7936).toLowerCase(Locale.ROOT);
   ...
   public static boolean useVbo() {
      if (XH.isMultiTexture()) {
         return false;
      } else if (XH.isRenderRegions() && !vboRegions) {
         return false;
      } else {
         boolean var10000;
         if (vboSupported) {
            nC.getMinecraft();
            if (nC.gameSettings.useVbo) {
               var10000 = true;
               return var10000;
            }
         }
