...
public class Ug implements Sz<Ts> {
   ...
   public Ug(double xIn, double yIn, double zIn, float strengthIn, List<BlockPos> affectedBlockPositionsIn, Vec3d motion) {
      this.posX = xIn;
      this.posY = yIn;
      this.posZ = zIn;
   ...
   public String toString() {
      return "SPacketExplosion{posX=" + this.posX + ", posY=" + this.posY + ", posZ=" + this.posZ + ", strength=" + this.strength + ", affectedBlockPositions=" + this.affectedBlockPositions + ", motionX=" + this.motionX + ", motionY=" + this.motionY + ", motionZ=" + this.motionZ + '}';
   }
