...
public class ok extends ou {
   private final ow chest1;
   private final ow chest2;

   public ok(float p_i47226_1_) {
   ...
   public void render(Ig entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
      Lu abstractchesthorse = (Lu)entityIn;
      boolean flag = !abstractchesthorse.isChild() && abstractchesthorse.hasChest();
      this.setRotationAngles(limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch, scale, entityIn);
      if (this.isChild) {
         float f = 2.0F;
         yh.pushMatrix();
         yh.translate(0.0F, this.childYOffset * scale, this.childZOffset * scale);
         yh.popMatrix();
         yh.pushMatrix();
         float f1 = 0.7F;
         yh.scale(0.71428573F, 0.64935064F, 0.7936508F);
         yh.translate(0.0F, 21.0F * scale, 0.22F);
         this.head.render(scale);
         yh.popMatrix();
         yh.pushMatrix();
         float f2 = 1.1F;
         yh.scale(0.625F, 0.45454544F, 0.45454544F);
         yh.translate(0.0F, 33.0F * scale, 0.0F);
         this.body.render(scale);
         yh.popMatrix();
         yh.pushMatrix();
         yh.scale(0.45454544F, 0.41322312F, 0.45454544F);
         yh.translate(0.0F, 33.0F * scale, 0.0F);
