...
public enum bkd implements blX {
   ...
   private static final bkd[] VALUES = values();

   private bkd(String name) {
      this.name = name;
   ...
   public static bkd parse(String str) {
      if (str == null) {
         return null;
      } else {
         for(int i = 0; i < VALUES.length; ++i) {
            bkd renderentityparameterfloat = VALUES[i];
