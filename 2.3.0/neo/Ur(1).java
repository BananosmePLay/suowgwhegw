...
public class Ur implements Sz<Ts> {
   ...
   public String toString() {
      return "SPacketPlayerAbilities{invulnerable=" + this.invulnerable + ", flying=" + this.flying + ", allowFlying=" + this.allowFlying + ", creativeMode=" + this.creativeMode + ", flySpeed=" + this.flySpeed + ", walkSpeed=" + this.walkSpeed + '}';
   }
