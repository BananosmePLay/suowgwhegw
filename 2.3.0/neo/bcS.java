...
public class bcS extends bcQ {
   private final bcR[] generatorCollection;
   private final int octaves;

   public bcS(Random seed, int octavesIn) {
      this.octaves = octavesIn;
      this.generatorCollection = new bcR[octavesIn];

      for(int i = 0; i < octavesIn; ++i) {
         this.generatorCollection[i] = new bcR(seed);
      }
