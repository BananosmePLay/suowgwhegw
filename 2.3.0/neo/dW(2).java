...
public class dW extends er {
   ...
   private int countNeighbors(bij worldIn, BlockPos pos) {
      int i = 0;
   ...
   protected void slightlyMelt(bij worldIn, BlockPos pos, in state, Random rand, boolean meltNeighbors) {
