...
public abstract class Nd extends Ig implements IJ {
   private int xTile;
   private int yTile;
   private int zTile;
   private co inTile;
   ...
   protected Iw thrower;
   private String throwerName;
   private int ticksInGround;
   private int ticksInAir;
   public Ig ignoreEntity;
   private int ignoreTime;

   public Nd(bij worldIn) {
      super(worldIn);
      this.xTile = -1;
      this.yTile = -1;
      this.zTile = -1;
   ...
   public Nd(bij worldIn, double x, double y, double z) {
      this(worldIn);
      this.setPosition(x, y, z);
   }

   public Nd(bij worldIn, Iw throwerIn) {
      this(worldIn, throwerIn.posX, throwerIn.posY + (double)throwerIn.getEyeHeight() - 0.10000000149011612, throwerIn.posZ);
   ...
   public void shoot(Ig entityThrower, float rotationPitchIn, float rotationYawIn, float pitchOffset, float velocity, float inaccuracy) {
   ...
   public void onUpdate() {
      ...
      if (raytraceresult != null) {
         if (raytraceresult.typeOfHit == RayTraceResult.Type.BLOCK && this.world.getBlockState(raytraceresult.getBlockPos()).getBlock() == Nk.PORTAL) {
   ...
   public void writeEntityToNBT(QQ compound) {
      ...
      if ((this.throwerName == null || this.throwerName.isEmpty()) && this.thrower instanceof ME) {
   ...
   @Nullable
   public Iw getThrower() {
      if (this.thrower == null && this.throwerName != null && !this.throwerName.isEmpty()) {
         this.thrower = this.world.getPlayerEntityByName(this.throwerName);
         if (this.thrower == null && this.world instanceof bis) {
            try {
               Ig entity = ((bis)this.world).getEntityFromUuid(UUID.fromString(this.throwerName));
               if (entity instanceof Iw) {
                  this.thrower = (Iw)entity;
               }
