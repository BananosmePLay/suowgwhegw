...
public class bmu extends lg {
   ...
   public bmu(lg guiscreen, Bj gamesettings) {
      this.prevScreen = guiscreen;
      this.settings = gamesettings;
   }

   public void initGui() {
      this.title = Ax.format("of.options.qualityTitle");
   ...
   protected void actionPerformed(jK guibutton) {
      if (guibutton.enabled) {
         ...
         if (guibutton.id != Bi.AA_LEVEL.ordinal()) {
   ...
   static {
      enumOptions = new Bi[]{Bi.MIPMAP_LEVELS, Bi.MIPMAP_TYPE, Bi.AF_LEVEL, Bi.AA_LEVEL, Bi.CLEAR_WATER, Bi.RANDOM_ENTITIES, Bi.BETTER_GRASS, Bi.BETTER_SNOW, Bi.CUSTOM_FONTS, Bi.CUSTOM_COLORS, Bi.CONNECTED_TEXTURES, Bi.NATURAL_TEXTURES, Bi.CUSTOM_SKY, Bi.CUSTOM_ITEMS, Bi.CUSTOM_ENTITY_MODELS, Bi.CUSTOM_GUIS, Bi.EMISSIVE_TEXTURES};
   }
}
