...
public class ot extends ou {
   public ot() {
      ...
      ow modelrenderer = this.head.setTextureOffset(26, 0);
      modelrenderer.mirror = true;
      modelrenderer.addBox(2.5F, -4.0F, -1.0F, 2, 2, 1, 0.0F);
      this.body = new ow(this);
   ...
   public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Ig entityIn) {
      ...
      float f1 = ((Kv)entityIn).getStandingAnimationScale(f);
      f1 *= f1;
      float f2 = 1.0F - f1;
