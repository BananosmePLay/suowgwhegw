...
public class bmL extends Thread {
   private bmI httpPipelineConnection = null;
   private static final String CRLF = "\r\n";
   private static Charset ASCII = Charset.forName("ASCII");

   public bmL(bmI httpPipelineConnection) {
   ...
   public void run() {
      ...
      try {
         ...
         while(!Thread.interrupted()) {
            ...
            bmM httprequest = httppipelinerequest.getHttpRequest();
   ...
   private void writeRequest(bmM req, OutputStream out) throws IOException {
