...
public class QY extends QH {
   private long[] data;

   QY() {
   }

   public QY(long[] p_i47524_1_) {
      this.data = p_i47524_1_;
   }

   public QY(List<Long> p_i47525_1_) {
   ...
   public boolean equals(Object p_equals_1_) {
      return super.equals(p_equals_1_) && Arrays.equals(this.data, ((QY)p_equals_1_).data);
   }
