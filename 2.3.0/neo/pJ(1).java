...
public class pJ extends pM {
   protected pJ(bij worldIn, double p_i46286_2_, double p_i46286_4_, double p_i46286_6_, OL p_i46286_8_) {
      super(worldIn, p_i46286_2_, p_i46286_4_, p_i46286_6_, 0.0, 0.0, 0.0);
      this.setParticleTexture(nC.getMinecraft().getRenderItem().getItemModelMesher().getParticleIcon(p_i46286_8_));
