...
public class UO implements Sz<Ts> {
   ...
   private Rv dataManager;
   private List<Ru<?>> dataManagerEntries;

   public UO() {
   }

   public UO(Iw entityIn) {
      this.entityId = entityIn.getEntityId();
      this.uniqueId = entityIn.getUniqueID();
      this.type = Ir.REGISTRY.getIDForObject(entityIn.getClass());
   ...
   public String toString() {
      return "SPacketSpawnMob{entityId=" + this.entityId + ", uniqueId=" + this.uniqueId + ", type=" + this.type + ", x=" + this.x + ", y=" + this.y + ", z=" + this.z + ", velocityX=" + this.velocityX + ", velocityY=" + this.velocityY + ", velocityZ=" + this.velocityZ + ", yaw=" + this.yaw + ", pitch=" + this.pitch + ", headPitch=" + this.headPitch + ", dataManager=" + this.dataManager + ", dataManagerEntries=" + this.dataManagerEntries + '}';
   }
