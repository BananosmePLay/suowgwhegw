...
public class oL extends nH {
   public ow villagerHead;
   public ow villagerBody;
   public ow villagerArms;
   public ow rightVillagerLeg;
   public ow leftVillagerLeg;
   public ow villagerNose;

   public oL(float scale) {
      this(scale, 0.0F, 64, 64);
   }

   public oL(float scale, float p_i1164_2_, int width, int height) {
      this.villagerHead = (new ow(this)).setTextureSize(width, height);
      ...
      this.villagerNose = (new ow(this)).setTextureSize(width, height);
      ...
      this.villagerBody = (new ow(this)).setTextureSize(width, height);
      ...
      this.villagerArms = (new ow(this)).setTextureSize(width, height);
      ...
      this.rightVillagerLeg = (new ow(this, 0, 22)).setTextureSize(width, height);
      ...
      this.leftVillagerLeg = (new ow(this, 0, 22)).setTextureSize(width, height);
