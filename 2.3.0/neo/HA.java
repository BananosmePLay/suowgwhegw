...
public class HA {
   ...
   @Nullable
   public static Vec3d findRandomTarget(Ik entitycreatureIn, int xz, int y) {
      return findRandomTargetBlock(entitycreatureIn, xz, y, (Vec3d)null);
   }

   @Nullable
   public static Vec3d getLandPos(Ik p_191377_0_, int p_191377_1_, int p_191377_2_) {
      return generateRandomPos(p_191377_0_, p_191377_1_, p_191377_2_, (Vec3d)null, false);
   }

   @Nullable
   public static Vec3d findRandomTargetBlockTowards(Ik entitycreatureIn, int xz, int y, Vec3d targetVec3) {
   ...
   @Nullable
   public static Vec3d findRandomTargetBlockAwayFrom(Ik entitycreatureIn, int xz, int y, Vec3d targetVec3) {
      staticVector = (new Vec3d(entitycreatureIn.posX, entitycreatureIn.posY, entitycreatureIn.posZ)).subtract(targetVec3);
      return findRandomTargetBlock(entitycreatureIn, xz, y, staticVector);
   }

   @Nullable
   private static Vec3d findRandomTargetBlock(Ik entitycreatureIn, int xz, int y, @Nullable Vec3d targetVec3) {
      return generateRandomPos(entitycreatureIn, xz, y, targetVec3, true);
   }

   @Nullable
   private static Vec3d generateRandomPos(Ik p_191379_0_, int p_191379_1_, int p_191379_2_, @Nullable Vec3d p_191379_3_, boolean p_191379_4_) {
      VL pathnavigate = p_191379_0_.getNavigator();
      Random random = p_191379_0_.getRNG();
      boolean flag;
      if (p_191379_0_.hasHome()) {
         double d0 = p_191379_0_.getHomePosition().distanceSq((double)MathHelper.floor(p_191379_0_.posX), (double)MathHelper.floor(p_191379_0_.posY), (double)MathHelper.floor(p_191379_0_.posZ)) + 4.0;
      ...
      for(int k = 0; k < 10; ++k) {
         ...
         if (p_191379_3_ == null || (double)l * p_191379_3_.x + (double)j1 * p_191379_3_.z >= 0.0) {
            BlockPos blockpos1;
   ...
   private static BlockPos moveAboveSolid(BlockPos p_191378_0_, Ik p_191378_1_) {
   ...
   private static boolean isWaterDestination(BlockPos p_191380_0_, Ik p_191380_1_) {
      return p_191380_1_.world.getBlockState(p_191380_0_).getMaterial() == hM.WATER;
   }
