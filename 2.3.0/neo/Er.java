...
public class Er {
   ...
   private final Ey systemDetailsCategory = new Ey(this, "System Details");
   private final List<Ey> crashReportSections = Lists.newArrayList();
   private File crashReportFile;
   private boolean firstCategoryInCrashReport = true;
   private StackTraceElement[] stacktrace = new StackTraceElement[0];
   private boolean reported = false;

   public Er(String descriptionIn, Throwable causeThrowable) {
   ...
   private void populateEnvironment() {
      this.systemDetailsCategory.addDetail("Minecraft Version", new Ez<String>() {
         public String call() {
            return "1.12.2";
         }
      ...
      this.systemDetailsCategory.addDetail("Operating System", new Ez<String>() {
         public String call() {
      ...
      this.systemDetailsCategory.addDetail("Java Version", new Ez<String>() {
         public String call() {
      ...
      this.systemDetailsCategory.addDetail("Java VM Version", new Ez<String>() {
         public String call() {
      ...
      this.systemDetailsCategory.addDetail("Memory", new Ez<String>() {
         public String call() {
      ...
      this.systemDetailsCategory.addDetail("JVM Flags", new Ez<String>() {
         public String call() {
      ...
      this.systemDetailsCategory.addDetail("IntCache", new Ez<String>() {
         public String call() throws Exception {
            return bcK.getCacheSizes();
         }
      ...
      if (bnK.FMLCommonHandler_enhanceCrashReport.exists()) {
         Object object = bnK.call(bnK.FMLCommonHandler_instance);
         bnK.callString(object, bnK.FMLCommonHandler_enhanceCrashReport, this, this.systemDetailsCategory);
      }
   ...
   public void getSectionsInStringBuilder(StringBuilder builder) {
      if ((this.stacktrace == null || this.stacktrace.length <= 0) && !this.crashReportSections.isEmpty()) {
         this.stacktrace = (StackTraceElement[])((StackTraceElement[])ArrayUtils.subarray(((Ey)this.crashReportSections.get(0)).getStackTrace(), 0, 1));
      }
      ...
      while(var6.hasNext()) {
         Ey crashreportcategory = (Ey)var6.next();
   ...
   public String getCompleteReport() {
      if (!this.reported) {
         this.reported = true;
         bjo.onCrashReport(this, this.systemDetailsCategory);
      }

      StringBuilder stringbuilder = new StringBuilder();
      stringbuilder.append("---- Minecraft Crash Report ----\n");
      bnK.call(bnK.CoreModManager_onCrash, stringbuilder);
      stringbuilder.append("// ");
   ...
   public boolean saveToFile(File toFile) {
      if (this.crashReportFile != null) {
         ...
         try {
            ...
            ((Writer)writer).write(this.getCompleteReport());
   ...
   public Ey getCategory() {
      return this.systemDetailsCategory;
   }

   public Ey makeCategory(String name) {
      return this.makeCategoryDepth(name, 1);
   }

   public Ey makeCategoryDepth(String categoryName, int stacktraceLength) {
      Ey crashreportcategory = new Ey(this, categoryName);
      if (this.firstCategoryInCrashReport) {
         ...
         if (i > 0 && !this.crashReportSections.isEmpty()) {
            Ey crashreportcategory1 = (Ey)this.crashReportSections.get(this.crashReportSections.size() - 1);
   ...
   public static Er makeCrashReport(Throwable causeIn, String descriptionIn) {
      Er crashreport;
      if (causeIn instanceof ReportedException) {
         crashreport = ((ReportedException)causeIn).getCrashReport();
      } else {
         crashreport = new Er(descriptionIn, causeIn);
      }
