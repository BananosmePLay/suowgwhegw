...
public class WN extends WW {
   private boolean displayedIntro;
   private boolean demoTimeExpired;
   private int demoEndedReminder;
   private int gameModeTicks;

   public WN(bij worldIn) {
      super(worldIn);
   }
   ...
   public void updateBlockRemoving() {
      ...
      if (!this.displayedIntro && this.gameModeTicks > 20) {
         ...
         this.player.connection.sendPacket(new TC(5, 0.0F));
      }
      ...
      if (i % 24000L == 500L) {
         ...
         if (i == 100L) {
            this.player.connection.sendPacket(new TC(5, 101.0F));
         } else if (i == 175L) {
            this.player.connection.sendPacket(new TC(5, 102.0F));
         } else if (i == 250L) {
            this.player.connection.sendPacket(new TC(5, 103.0F));
         }
