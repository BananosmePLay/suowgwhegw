...
public class zZ extends Aa<zY> implements JsonSerializer<zY> {
   public zZ() {
   }

   public zY deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) throws JsonParseException {
      ...
      if (jsonobject.has("frames")) {
         try {
            ...
            for(l = 0; l < jsonarray.size(); ++l) {
               ...
               zX animationframe = this.parseAnimationFrame(l, jsonelement);
               if (animationframe != null) {
                  list.add(animationframe);
               }
            }
         } catch (ClassCastException var11) {
            ClassCastException classcastexception = var11;
      ...
      return new zY(list, k, l, i, flag);
   }

   private zX parseAnimationFrame(int frame, JsonElement element) {
      if (element.isJsonPrimitive()) {
         return new zX(JsonUtils.getInt(element, "frames[" + frame + "]"));
   ...
   public JsonElement serialize(zY p_serialize_1_, Type p_serialize_2_, JsonSerializationContext p_serialize_3_) {
   ...
   public JsonElement serialize(Object var1, Type var2, JsonSerializationContext var3) {
      return this.serialize((zY)var1, var2, var3);
   }
}
