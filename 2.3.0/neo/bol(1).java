...
public class bol {
   ...
   public bol(String propertyName, String[] propertyValues, String userName, String[] userValues, int defaultValue) {
   ...
   public void nextValue(boolean forward) {
      ...
      this.value = XH.limit(this.value, i, j);
      if (forward) {
         ++this.value;
         if (this.value > j) {
            this.value = i;
   ...
   public String toString() {
      return "" + this.propertyName + "=" + this.getPropertyValue() + " [" + XH.arrayToString((Object[])this.propertyValues) + "], value: " + this.value;
   }
}
