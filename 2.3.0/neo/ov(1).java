...
public class ov extends nH {
   private final ow rabbitLeftFoot;
   private final ow rabbitRightFoot;
   private final ow rabbitLeftThigh;
   private final ow rabbitRightThigh;
   private final ow rabbitBody;
   private final ow rabbitLeftArm;
   private final ow rabbitRightArm;
   private final ow rabbitHead;
   private final ow rabbitRightEar;
   private final ow rabbitLeftEar;
   private final ow rabbitTail;
   private final ow rabbitNose;
   ...
   public ov() {
      ...
      this.rabbitLeftFoot = new ow(this, 26, 24);
      ...
      this.rabbitRightFoot = new ow(this, 8, 24);
      ...
      this.rabbitLeftThigh = new ow(this, 30, 15);
      ...
      this.rabbitRightThigh = new ow(this, 16, 15);
      ...
      this.rabbitBody = new ow(this, 0, 0);
      ...
      this.rabbitLeftArm = new ow(this, 8, 15);
      ...
      this.rabbitRightArm = new ow(this, 0, 15);
      ...
      this.rabbitHead = new ow(this, 32, 0);
      ...
      this.rabbitRightEar = new ow(this, 52, 0);
      ...
      this.rabbitLeftEar = new ow(this, 58, 0);
      ...
      this.rabbitTail = new ow(this, 52, 6);
      ...
      this.rabbitNose = new ow(this, 32, 9);
   ...
   private void setRotationOffset(ow renderer, float x, float y, float z) {
   ...
   public void render(Ig entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
      ...
      if (this.isChild) {
         float f = 1.5F;
         yh.pushMatrix();
         yh.scale(0.56666666F, 0.56666666F, 0.56666666F);
         yh.translate(0.0F, 22.0F * scale, 2.0F * scale);
         ...
         yh.translate(0.0F, 36.0F * scale, 0.0F);
   ...
   public void setLivingAnimations(Iw entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
      ...
      this.jumpRotation = MathHelper.sin(((LY)entitylivingbaseIn).getJumpCompletion(partialTickTime) * 3.1415927F);
   }
}
