...
public class Db extends Ch {
   ...
   public void execute(Xx server, DB sender, String[] args) throws Ct {
      if (args.length < 1) {
         throw new Ej("commands.worldborder.usage", new Object[0]);
      } else {
         bab worldborder = this.getWorldBorder(server);
         double d6;
         double d10;
         long j1;
         if ("set".equals(args[0])) {
            if (args.length != 2 && args.length != 3) {
               throw new Ej("commands.worldborder.set.usage", new Object[0]);
            }
            ...
            if (args.length != 2 && args.length != 3) {
               throw new Ej("commands.worldborder.add.usage", new Object[0]);
            }
            ...
            if (args.length != 3) {
               throw new Ej("commands.worldborder.center.usage", new Object[0]);
            }
            ...
            if (args.length < 2) {
               throw new Ej("commands.worldborder.damage.usage", new Object[0]);
            }

            if ("buffer".equals(args[1])) {
               if (args.length != 3) {
                  throw new Ej("commands.worldborder.damage.buffer.usage", new Object[0]);
               }
               ...
               if (args.length != 3) {
                  throw new Ej("commands.worldborder.damage.amount.usage", new Object[0]);
               }
            ...
            if (args.length < 2) {
               throw new Ej("commands.worldborder.warning.usage", new Object[0]);
            }
            ...
            if ("time".equals(args[1])) {
               if (args.length != 3) {
                  throw new Ej("commands.worldborder.warning.time.usage", new Object[0]);
               }
               ...
               if (args.length != 3) {
                  throw new Ej("commands.worldborder.warning.distance.usage", new Object[0]);
               }
            ...
            d6 = worldborder.getDiameter();
            sender.setCommandStat(CK.QUERY_RESULT, MathHelper.floor(d6 + 0.5));
            sender.sendMessage(new TextComponentTranslation("commands.worldborder.get.success", new Object[]{String.format("%.0f", d6)}));
         }

      }
   }

   protected bab getWorldBorder(Xx server) {
