...
public class oh extends nH {
   public ow ironGolemHead;
   public ow ironGolemBody;
   public ow ironGolemRightArm;
   public ow ironGolemLeftArm;
   public ow ironGolemLeftLeg;
   public ow ironGolemRightLeg;

   public oh() {
      this(0.0F);
   }

   public oh(float p_i1161_1_) {
      this(p_i1161_1_, -7.0F);
   }

   public oh(float p_i46362_1_, float p_i46362_2_) {
      int i = true;
      int j = true;
      this.ironGolemHead = (new ow(this)).setTextureSize(128, 128);
      ...
      this.ironGolemBody = (new ow(this)).setTextureSize(128, 128);
      ...
      this.ironGolemRightLeg = (new ow(this, 0, 22)).setTextureSize(128, 128);
   ...
   public void setLivingAnimations(Iw entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
      Kj entityirongolem = (Kj)entitylivingbaseIn;
