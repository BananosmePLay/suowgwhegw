...
public class HO extends HN {
   ...
   private Ii areaEffectCloud;

   public HO(HS dragonIn) {
      super(dragonIn);
   }
   ...
   public void doClientRenderEffects() {
      ...
      if (this.flameTicks % 2 == 0 && this.flameTicks < 10) {
         ...
         for(int i = 0; i < 8; ++i) {
            ...
            for(int j = 0; j < 6; ++j) {
               this.dragon.world.spawnParticle(EnumParticleTypes.DRAGON_BREATH, d3, d4, d5, -vec3d.x * 0.07999999821186066 * (double)j, -vec3d.y * 0.6000000238418579, -vec3d.z * 0.07999999821186066 * (double)j);
            }
   ...
   public void doLocalUpdate() {
      ...
      if (this.flameTicks >= 200) {
         ...
         this.areaEffectCloud = new Ii(this.dragon.world, d0, d2, d1);
         ...
         this.areaEffectCloud.addEffect(new VZ(NL.INSTANT_DAMAGE));
   ...
   public HK<HO> getType() {
      return HK.SITTING_FLAMING;
   }
