...
public class bdV extends bef {
   private boolean chest;

   public bdV() {
   }

   public bdV(int p_i45613_1_, Random p_i45613_2_, bdy p_i45613_3_, EnumFacing p_i45613_4_) {
      super(p_i45613_1_);
   ...
   public static bdV createPiece(List<bdB> p_175876_0_, Random p_175876_1_, int p_175876_2_, int p_175876_3_, int p_175876_4_, EnumFacing p_175876_5_, int p_175876_6_) {
      bdy structureboundingbox = bdy.getComponentToAddBoundingBox(p_175876_2_, p_175876_3_, p_175876_4_, -1, 0, 0, 5, 7, 5, p_175876_5_);
      return isAboveGround(structureboundingbox) && bdB.findIntersecting(p_175876_0_, structureboundingbox) == null ? new bdV(p_175876_6_, p_175876_1_, structureboundingbox, p_175876_5_) : null;
   }
   ...
   public boolean addComponentParts(bij worldIn, Random randomIn, bdy structureBoundingBoxIn) {
      ...
      this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, 2, 4, 4, 5, 4, Nk.NETHER_BRICK.getDefaultState(), Nk.NETHER_BRICK.getDefaultState(), false);
      ...
      if (this.chest && structureBoundingBoxIn.isVecInside(new BlockPos(this.getXWithOffset(1, 3), this.getYWithOffset(2), this.getZWithOffset(1, 3)))) {
         this.chest = false;
         this.generateChest(worldIn, structureBoundingBoxIn, randomIn, 1, 2, 3, bhq.CHESTS_NETHER_BRIDGE);
      }
