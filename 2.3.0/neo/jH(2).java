...
public class jH implements AB {
   ...
   public Bj gameSettings;
   public ResourceLocation locationFontTextureBase;
   public float offsetBold = 1.0F;
   private float[] charWidthFloat = new float[256];
   private boolean blend = false;
   private bnZ oldBlendState = new bnZ();

   public jH(Bj gameSettingsIn, ResourceLocation location, zf textureManagerIn, boolean unicode) {
      this.gameSettings = gameSettingsIn;
      this.locationFontTextureBase = location;
      this.locationFontTexture = location;
      this.renderEngine = textureManagerIn;
      this.unicodeFlag = unicode;
      this.locationFontTexture = bqq.getHdFontLocation(this.locationFontTextureBase);
   ...
   private void readFontTexture() {
      ...
      try {
         ...
         bufferedimage = zk.readBufferedImage(iresource.getInputStream());
      } catch (IOException var24) {
         IOException ioexception = var24;
         throw new RuntimeException(ioexception);
      } finally {
         IOUtils.closeQuietly(iresource);
      }

      Properties props = bqq.readFontProperties(this.locationFontTexture);
      this.blend = bqq.readBoolean(props, "blend", false);
      int imgWidth = bufferedimage.getWidth();
      int imgHeight = bufferedimage.getHeight();
      int charW = imgWidth / 16;
      int charH = imgHeight / 16;
      float kx = (float)imgWidth / 128.0F;
      float boldScaleFactor = XH.limit(kx, 1.0F, 2.0F);
      this.offsetBold = 1.0F / boldScaleFactor;
      float offsetBoldConfig = bqq.readFloat(props, "offsetBold", -1.0F);
      ...
      bqq.readCustomCharWidths(props, this.charWidthFloat);
   ...
   private float renderDefaultChar(int ch, boolean italic) {
      ...
      float f1 = 7.99F;
      yh.glBegin(5);
      yh.glTexCoord2f((float)i / 128.0F, (float)j / 128.0F);
      yh.glVertex3f(this.posX + (float)k, this.posY, 0.0F);
      yh.glTexCoord2f((float)i / 128.0F, ((float)j + 7.99F) / 128.0F);
      yh.glVertex3f(this.posX - (float)k, this.posY + 7.99F, 0.0F);
      yh.glTexCoord2f(((float)i + f1 - 1.0F) / 128.0F, (float)j / 128.0F);
      yh.glVertex3f(this.posX + f1 - 1.0F + (float)k, this.posY, 0.0F);
      yh.glTexCoord2f(((float)i + f1 - 1.0F) / 128.0F, ((float)j + 7.99F) / 128.0F);
      yh.glVertex3f(this.posX + f1 - 1.0F - (float)k, this.posY + 7.99F, 0.0F);
      yh.glEnd();
      return f;
   }
   ...
   private ResourceLocation getUnicodePageLocation(int page) {
      if (UNICODE_PAGE_LOCATIONS[page] == null) {
         ...
         UNICODE_PAGE_LOCATIONS[page] = bqq.getHdFontLocation(UNICODE_PAGE_LOCATIONS[page]);
      }
   ...
   private float renderUnicodeChar(char ch, boolean italic) {
      ...
      if (i == 0) {
         ...
         yh.glBegin(5);
         yh.glTexCoord2f(f2 / 256.0F, f3 / 256.0F);
         yh.glVertex3f(this.posX + f5, this.posY, 0.0F);
         yh.glTexCoord2f(f2 / 256.0F, (f3 + 15.98F) / 256.0F);
         yh.glVertex3f(this.posX - f5, this.posY + 7.99F, 0.0F);
         yh.glTexCoord2f((f2 + f4) / 256.0F, f3 / 256.0F);
         yh.glVertex3f(this.posX + f4 / 2.0F + f5, this.posY, 0.0F);
         yh.glTexCoord2f((f2 + f4) / 256.0F, (f3 + 15.98F) / 256.0F);
         yh.glVertex3f(this.posX + f4 / 2.0F - f5, this.posY + 7.99F, 0.0F);
         yh.glEnd();
   ...
   public static void drawStringWithOutline(jH fontRenderer, String text, float x, float y, int color) {
      fontRenderer.drawString(text, (int)(x - 1.0F), (int)y, Color.BLACK.getRGB());
      fontRenderer.drawString(text, (int)(x + 1.0F), (int)y, Color.BLACK.getRGB());
      fontRenderer.drawString(text, (int)x, (int)(y - 1.0F), Color.BLACK.getRGB());
      fontRenderer.drawString(text, (int)x, (int)(y + 1.0F), Color.BLACK.getRGB());
   ...
   public int drawString(String text, float x, float y, int color, boolean dropShadow) {
      this.enableAlpha();
      if (this.blend) {
         yh.getBlendState(this.oldBlendState);
         yh.enableBlend();
      ...
      if (this.blend) {
         yh.setBlendState(this.oldBlendState);
      }
   ...
   protected void doDraw(float p_doDraw_1_) {
      ...
      if (this.strikethroughStyle) {
         tessellator1 = yN.getInstance();
         bufferbuilder1 = tessellator1.getBuffer();
         yh.disableTexture2D();
         bufferbuilder1.begin(7, zK.POSITION);
   ...
   protected void setColor(float p_setColor_1_, float p_setColor_2_, float p_setColor_3_, float p_setColor_4_) {
      yh.color(p_setColor_1_, p_setColor_2_, p_setColor_3_, p_setColor_4_);
   }
   ...
   protected Az getResource(ResourceLocation p_getResource_1_) throws IOException {
      return nC.getMinecraft().getResourceManager().getResource(p_getResource_1_);
   }
}
