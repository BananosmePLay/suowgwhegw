...
public class zk {
   ...
   private static final IntBuffer DATA_BUFFER = xE.createDirectIntBuffer(4194304);
   public static final yP MISSING_TEXTURE = new yP(16, 16);
   ...
   public static int glGenTextures() {
      return yh.generateTexture();
   }

   public static void deleteTexture(int textureId) {
      yh.deleteTexture(textureId);
   }
   ...
   private static int blendColors(int p_147943_0_, int p_147943_1_, int p_147943_2_, int p_147943_3_, boolean p_147943_4_) {
      return bna.alphaBlend(p_147943_0_, p_147943_1_, p_147943_2_, p_147943_3_);
   }
   ...
   private static void uploadTextureSub(int p_147947_0_, int[] p_147947_1_, int p_147947_2_, int p_147947_3_, int p_147947_4_, int p_147947_5_, boolean p_147947_6_, boolean p_147947_7_, boolean p_147947_8_) {
      ...
      for(int k = 0; k < p_147947_2_ * p_147947_3_; k += p_147947_2_ * j) {
         ...
         yh.glTexSubImage2D(3553, p_147947_0_, p_147947_4_, p_147947_5_ + l, p_147947_2_, j, 32993, 33639, DATA_BUFFER);
      }
   ...
   public static void allocateTextureImpl(int glTextureId, int mipmapLevels, int width, int height) {
      Object object = zk.class;
      if (bnK.SplashScreen.exists()) {
         object = bnK.SplashScreen.getTargetClass();
      }
      ...
      if (mipmapLevels >= 0) {
         yh.glTexParameteri(3553, 33085, mipmapLevels);
         yh.glTexParameteri(3553, 33082, 0);
         yh.glTexParameteri(3553, 33083, mipmapLevels);
         yh.glTexParameterf(3553, 34049, 0.0F);
      }

      for(int i = 0; i <= mipmapLevels; ++i) {
         yh.glTexImage2D(3553, i, 6408, width >> i, height >> i, 0, 32993, 33639, (IntBuffer)null);
      }
   ...
   private static void uploadTextureImageSubImpl(BufferedImage p_110993_0_, int p_110993_1_, int p_110993_2_, boolean p_110993_3_, boolean p_110993_4_) {
      ...
      for(int l = 0; l < i * j; l += i * k) {
         ...
         yh.glTexSubImage2D(3553, 0, p_110993_1_, p_110993_2_ + i1, i, j1, 32993, 33639, DATA_BUFFER);
      }
   ...
   public static void setTextureBlurMipmap(boolean p_147954_0_, boolean p_147954_1_) {
      if (p_147954_0_) {
         yh.glTexParameteri(3553, 10241, p_147954_1_ ? 9987 : 9729);
         yh.glTexParameteri(3553, 10240, 9729);
      } else {
         int i = XH.getMipmapType();
         yh.glTexParameteri(3553, 10241, p_147954_1_ ? i : 9728);
   ...
   static void bindTexture(int p_94277_0_) {
      yh.bindTexture(p_94277_0_);
   }

   public static int[] readImageData(AA resourceManager, ResourceLocation imageLocation) throws IOException {
      Az iresource = null;
