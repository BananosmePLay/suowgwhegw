...
public class baG {
   ...
   public DataOutputStream getChunkDataOutputStream(int x, int z) {
      return this.outOfBounds(x, z) ? null : new DataOutputStream(new BufferedOutputStream(new DeflaterOutputStream(new baF(this, x, z))));
   }
   ...
   protected synchronized void write(int x, int z, byte[] data, int length) {
      try {
         ...
         this.setChunkTimestamp(x, z, (int)(Xx.getCurrentTimeMillis() / 1000L));
