...
public enum Om implements IStringSerializable {
   ...
   private static final Om[] META_LOOKUP = new Om[values().length];
   private static final Om[] DYE_DMG_LOOKUP = new Om[values().length];
   ...
   private Om(int metaIn, int dyeDamageIn, String nameIn, String unlocalizedNameIn, int colorValueIn, TextFormatting chatColorIn) {
      this.meta = metaIn;
   ...
   public static Om byDyeDamage(int damage) {
   ...
   public static Om byMetadata(int meta) {
