...
public class od extends nH {
   private final ow guardianBody;
   private final ow guardianEye;
   private final ow[] guardianSpines;
   private final ow[] guardianTail;

   public od() {
      this.textureWidth = 64;
      this.textureHeight = 64;
      this.guardianSpines = new ow[12];
      this.guardianBody = new ow(this);
   ...
   public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Ig entityIn) {
      ...
      if (entity != null) {
         Vec3d vec3d = ((Ig)entity).getPositionEyes(0.0F);
