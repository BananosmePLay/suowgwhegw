...
public class bnZ {
   ...
   public bnZ(boolean enabled) {
      this(enabled, 1, 0);
   }

   public bnZ(boolean enabled, int srcFactor, int dstFactor, int srcFactorAlpha, int dstFactorAlpha) {
   ...
   public bnZ(boolean enabled, int srcFactor, int dstFactor) {
   ...
   public void setState(bnZ state) {
