...
public class sD extends ResourceLocation {
   private final String variant;

   protected sD(int unused, String... resourceName) {
   ...
   public sD(String pathIn) {
      this(0, parsePathString(pathIn));
   }

   public sD(ResourceLocation location, String variantIn) {
      this(location.toString(), variantIn);
   }

   public sD(String location, String variantIn) {
   ...
   public boolean equals(Object p_equals_1_) {
      if (this == p_equals_1_) {
         return true;
      } else if (p_equals_1_ instanceof sD && super.equals(p_equals_1_)) {
         sD modelresourcelocation = (sD)p_equals_1_;
