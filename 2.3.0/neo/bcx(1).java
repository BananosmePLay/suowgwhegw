...
public class bcx extends bco {
   private final bcw mode;

   public bcx(long p_i45474_1_, bco p_i45474_3_, bcw p_i45474_4_) {
      super(p_i45474_1_);
   ...
   private int[] getIntsCoolWarm(int p_151626_1_, int p_151626_2_, int p_151626_3_, int p_151626_4_) {
      ...
      int[] aint1 = bcK.getIntCache(p_151626_3_ * p_151626_4_);
   ...
   private int[] getIntsHeatIce(int p_151624_1_, int p_151624_2_, int p_151624_3_, int p_151624_4_) {
      ...
      int[] aint = this.parent.getInts(i, j, k, l);
      int[] aint1 = bcK.getIntCache(p_151624_3_ * p_151624_4_);
   ...
   private int[] getIntsSpecial(int p_151625_1_, int p_151625_2_, int p_151625_3_, int p_151625_4_) {
      ...
      int[] aint1 = bcK.getIntCache(p_151625_3_ * p_151625_4_);
