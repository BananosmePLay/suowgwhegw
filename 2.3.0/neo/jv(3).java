...
public class jv extends jI {
   private static final ResourceLocation WIDGETS = new ResourceLocation("textures/gui/advancements/widgets.png");
   private static final Pattern PATTERN = Pattern.compile("(.+) \\S+");
   private final jw guiAdvancementTab;
   private final b advancement;
   private final cb displayInfo;
   private final String title;
   private final int width;
   private final List<String> description;
   private final nC minecraft;
   private jv parent;
   private final List<jv> children = Lists.newArrayList();
   private h advancementProgress;
   private final int x;
   private final int y;

   public jv(jw p_i47385_1_, nC p_i47385_2_, b p_i47385_3_, cb p_i47385_4_) {
      ...
      String s1;
      for(Iterator var10 = this.description.iterator(); var10.hasNext(); l = Math.max(l, p_i47385_2_.fontRenderer.getStringWidth(s1))) {
   ...
   @Nullable
   private jv getFirstVisibleParent(b advancementIn) {
      do {
   ...
   public void drawConnectivity(int p_191819_1_, int p_191819_2_, boolean p_191819_3_) {
      ...
      while(var10.hasNext()) {
         jv guiadvancement = (jv)var10.next();
   ...
   public void draw(int p_191817_1_, int p_191817_2_) {
      if (!this.displayInfo.isHidden() || this.advancementProgress != null && this.advancementProgress.isDone()) {
         ...
         js advancementstate;
         if (f >= 1.0F) {
            advancementstate = js.OBTAINED;
         } else {
            advancementstate = js.UNOBTAINED;
         }
         ...
         this.minecraft.getRenderItem().renderItemAndEffectIntoGUI((Iw)null, this.displayInfo.getIcon(), p_191817_1_ + this.x + 8, p_191817_2_ + this.y + 5);
      }

      Iterator var5 = this.children.iterator();

      while(var5.hasNext()) {
         jv guiadvancement = (jv)var5.next();
         guiadvancement.draw(p_191817_1_, p_191817_2_);
      }

   }

   public void setAdvancementProgress(h advancementProgressIn) {
      this.advancementProgress = advancementProgressIn;
   }

   public void addGuiAdvancement(jv guiAdvancementIn) {
   ...
   public void drawHover(int p_191821_1_, int p_191821_2_, float p_191821_3_, int p_191821_4_, int p_191821_5_) {
      ...
      js advancementstate;
      js advancementstate1;
      js advancementstate2;
      if (f >= 1.0F) {
         j = this.width / 2;
         advancementstate = js.OBTAINED;
         advancementstate1 = js.OBTAINED;
         advancementstate2 = js.OBTAINED;
      } else if (j < 2) {
         j = this.width / 2;
         advancementstate = js.UNOBTAINED;
         advancementstate1 = js.UNOBTAINED;
         advancementstate2 = js.UNOBTAINED;
      ...
      if (flag1) {
         for(k1 = 0; k1 < this.description.size(); ++k1) {
            this.minecraft.fontRenderer.drawString((String)this.description.get(k1), (float)(i1 + 5), (float)(l + 26 - j1 + 7 + k1 * this.minecraft.fontRenderer.FONT_HEIGHT), -5592406, false);
         }
      } else {
         for(k1 = 0; k1 < this.description.size(); ++k1) {
            this.minecraft.fontRenderer.drawString((String)this.description.get(k1), (float)(i1 + 5), (float)(p_191821_2_ + this.y + 9 + 17 + k1 * this.minecraft.fontRenderer.FONT_HEIGHT), -5592406, false);
         }
      }

      yz.enableGUIStandardItemLighting();
      this.minecraft.getRenderItem().renderItemAndEffectIntoGUI((Iw)null, this.displayInfo.getIcon(), p_191821_1_ + this.x + 8, p_191821_2_ + this.y + 5);
   }
