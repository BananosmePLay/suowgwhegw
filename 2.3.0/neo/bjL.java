...
public class bjL {
   ...
   public bjL(String path, Properties props) {
      biS connectedparser = new biS("CustomPanorama");
      this.path = path;
      ...
      this.overlay1Top = biS.parseColor4(props.getProperty("overlay1.top"), -2130706433);
      this.overlay1Bottom = biS.parseColor4(props.getProperty("overlay1.bottom"), 16777215);
      this.overlay2Top = biS.parseColor4(props.getProperty("overlay2.top"), 0);
      this.overlay2Bottom = biS.parseColor4(props.getProperty("overlay2.bottom"), Integer.MIN_VALUE);
   }
