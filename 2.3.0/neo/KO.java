...
public class KO extends JY implements IK {
   private static final Rd<Byte> PUMPKIN_EQUIPPED;
   ...
   protected void initEntityAI() {
      this.tasks.addTask(1, new Ge(this, 1.25, 20, 10.0F));
      this.tasks.addTask(2, new Ho(this, 1.0, 1.0000001E-5F));
      this.tasks.addTask(3, new Hq(this, ME.class, 6.0F));
      this.tasks.addTask(4, new GH(this));
      this.targetTasks.addTask(1, new GR(this, Iu.class, 10, true, false, Lo.MOB_SELECTOR));
   }
   ...
   public void onLivingUpdate() {
      ...
      if (!this.world.isRemote) {
         ...
         for(int l = 0; l < 4; ++l) {
            ...
            if (this.world.getBlockState(blockpos).getMaterial() == hM.AIR && this.world.getBiome(blockpos).getTemperature(blockpos) < 0.8F && Nk.SNOW_LAYER.canPlaceBlockAt(this.world, blockpos)) {
               this.world.setBlockState(blockpos, Nk.SNOW_LAYER.getDefaultState());
            }
         }
      }
   ...
   public void attackEntityWithRangedAttack(Iw target, float distanceFactor) {
      ...
      this.playSound(NO.ENTITY_SNOWMAN_SHOOT, 1.0F, 1.0F / (this.getRNG().nextFloat() * 0.4F + 0.8F));
   ...
   protected boolean processInteract(ME player, EnumHand hand) {
      ...
      if (itemstack.getItem() == NK.SHEARS && this.isPumpkinEquipped() && !this.world.isRemote) {
   ...
   protected SoundEvent getAmbientSound() {
      return NO.ENTITY_SNOWMAN_AMBIENT;
   }

   @Nullable
   protected SoundEvent getHurtSound(DamageSource damageSourceIn) {
      return NO.ENTITY_SNOWMAN_HURT;
   }

   @Nullable
   protected SoundEvent getDeathSound() {
      return NO.ENTITY_SNOWMAN_DEATH;
   }
   ...
   static {
      PUMPKIN_EQUIPPED = Rv.createKey(KO.class, Rt.BYTE);
   }
}
