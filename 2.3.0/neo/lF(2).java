...
public class lF {
   ...
   public static String removeTextColorsIfConfigured(String text, boolean forceColor) {
      ...
      if (!forceColor) {
         nC.getMinecraft();
         if (!nC.gameSettings.chatColours) {
            var10000 = TextFormatting.getTextWithoutFormattingCodes(text);
            return var10000;
         }
      }
   ...
   public static List<ITextComponent> splitText(ITextComponent textComponent, int maxTextLenght, jH fontRendererIn, boolean p_178908_3_, boolean forceTextColor) {
      int i = 0;
