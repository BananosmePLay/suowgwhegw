...
public class og extends nH {
   ...
   public og(float scaleFactor, float p_i47227_2_, int textureWidthIn, int textureHeightIn) {
      this.head = (new ow(this)).setTextureSize(textureWidthIn, textureHeightIn);
      ...
      this.hat = (new ow(this, 32, 0)).setTextureSize(textureWidthIn, textureHeightIn);
      this.hat.addBox(-4.0F, -10.0F, -4.0F, 8, 12, 8, scaleFactor + 0.45F);
      this.head.addChild(this.hat);
      this.hat.showModel = false;
      this.nose = (new ow(this)).setTextureSize(textureWidthIn, textureHeightIn);
      ...
      this.body = (new ow(this)).setTextureSize(textureWidthIn, textureHeightIn);
      ...
      this.arms = (new ow(this)).setTextureSize(textureWidthIn, textureHeightIn);
      ...
      ow modelrenderer = (new ow(this, 44, 22)).setTextureSize(textureWidthIn, textureHeightIn);
   ...
   public void render(Ig entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
      ...
      Jv abstractillager = (Jv)entityIn;
      if (abstractillager.getArmPose() == Ju.CROSSED) {
   ...
   public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Ig entityIn) {
      ...
      Ju abstractillager$illagerarmpose = ((Jv)entityIn).getArmPose();
      if (abstractillager$illagerarmpose == Ju.ATTACKING) {
         ...
         ow var10000;
         if (((Iw)entityIn).getPrimaryHand() == EnumHandSide.RIGHT) {
         ...
         var10000 = this.leftArm;
         var10000.rotateAngleX -= MathHelper.sin(ageInTicks * 0.067F) * 0.05F;
      } else if (abstractillager$illagerarmpose == Ju.SPELLCASTING) {
      ...
      } else if (abstractillager$illagerarmpose == Ju.BOW_AND_ARROW) {
   ...
   public ow getArm(EnumHandSide p_191216_1_) {
