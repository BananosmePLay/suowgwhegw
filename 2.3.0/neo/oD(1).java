...
public class oD extends nH {
   private final ow[] silverfishBodyParts = new ow[7];
   private final ow[] silverfishWings;
   ...
   public oD() {
      ...
      for(int i = 0; i < this.silverfishBodyParts.length; ++i) {
         this.silverfishBodyParts[i] = new ow(this, SILVERFISH_TEXTURE_POSITIONS[i][0], SILVERFISH_TEXTURE_POSITIONS[i][1]);
      ...
      this.silverfishWings = new ow[3];
      this.silverfishWings[0] = new ow(this, 20, 0);
      ...
      this.silverfishWings[1] = new ow(this, 20, 11);
      ...
      this.silverfishWings[2] = new ow(this, 20, 18);
   ...
   public void render(Ig entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
      ...
      ow[] var8 = this.silverfishBodyParts;
