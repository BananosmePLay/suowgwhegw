...
public enum Bi {
   ...
   FULLSCREEN_MODE("of.options.FULLSCREEN_MODE", true, false, 0.0F, (float)XH.getDisplayModes().length, 1.0F),
   ...
   public static Bi byOrdinal(int ordinal) {
      Bi[] var1 = values();
      int var2 = var1.length;

      for(int var3 = 0; var3 < var2; ++var3) {
         Bi gamesettings$options = var1[var3];
   ...
   private Bi(String translation, boolean isFloat, boolean isBoolean) {
      this(translation, isFloat, isBoolean, 0.0F, 1.0F, 0.0F);
   }

   private Bi(String translation, boolean isFloat, boolean isBoolean, float valMin, float valMax, float valStep) {
   ...
   // $FF: synthetic method
   static float access$000(Bi x0) {
      return x0.valueMax;
   }

   // $FF: synthetic method
   static float access$100(Bi x0) {
      return x0.valueMin;
   }
}
