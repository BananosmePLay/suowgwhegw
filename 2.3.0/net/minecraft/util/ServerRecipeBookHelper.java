...
public class ServerRecipeBookHelper {
   ...
   private final BR field_194331_b = new BR();
   private MG field_194332_c;
   private NT field_194333_d;
   ...
   public void func_194327_a(MG p_194327_1_, @Nullable NT p_194327_2_, boolean p_194327_3_) {
      if (p_194327_2_ != null && p_194327_1_.getRecipeBook().isUnlocked(p_194327_2_)) {
         ...
         if (this.field_194335_f != null && this.field_194336_g != null && (this.func_194328_c() || p_194327_1_.isCreative())) {
            ...
            if (this.field_194331_b.canCraft(p_194327_2_, (IntList)null)) {
               ...
               this.func_194326_a();
               p_194327_1_.connection.sendPacket(new Uq(p_194327_1_.openContainer.windowId, p_194327_2_));
            }
   ...
   private void func_194326_a() {
      MJ inventoryplayer = this.field_194332_c.inventory;

      for(int i = 0; i < this.field_194336_g.getSizeInventory(); ++i) {
         Qy itemstack = this.field_194336_g.getStackInSlot(i);
   ...
   private void func_194329_b() {
      ...
      if (flag) {
         ...
         for(int j = 0; j < this.field_194336_g.getSizeInventory(); ++j) {
            Qy itemstack = this.field_194336_g.getStackInSlot(j);
      ...
      if (this.field_194331_b.canCraft(this.field_194333_d, intlist, i1)) {
         ...
         while(intlistiterator.hasNext()) {
            ...
            int l = BR.unpack(k).getMaxStackSize();
            if (l < j1) {
               j1 = l;
            }
         }
   ...
   private void func_194323_a(int p_194323_1_, IntList p_194323_2_) {
      ...
      if (this.field_194333_d instanceof Of) {
         Of shapedrecipes = (Of)this.field_194333_d;
      ...
      for(int k = 0; k < this.field_194336_g.getWidth() && j != k; ++k) {
         for(int l = 0; l < this.field_194336_g.getHeight(); ++l) {
            ...
            Qy itemstack = BR.unpack((Integer)iterator.next());
            if (itemstack.isEmpty()) {
               ++j1;
            } else {
   ...
   private void func_194325_a(Slot p_194325_1_, Qy p_194325_2_) {
      MJ inventoryplayer = this.field_194332_c.inventory;
      int i = inventoryplayer.findSlotMatchingUnusedItem(p_194325_2_);
      if (i != -1) {
         Qy itemstack = inventoryplayer.getStackInSlot(i).copy();
         if (!itemstack.isEmpty()) {
