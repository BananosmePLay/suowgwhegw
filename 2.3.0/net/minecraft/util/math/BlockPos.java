...
public class BlockPos extends Vec3i {
   ...
   public static final class PooledMutableBlockPos extends MutableBlockPos {
      ...
      public PooledMutableBlockPos setPos(Ig entityIn) {
      ...
      // $FF: synthetic method
      // $FF: bridge method
      public MutableBlockPos move(EnumFacing var1, int var2) {
         return this.move(var1, var2);
      }

      // $FF: synthetic method
      // $FF: bridge method
      public MutableBlockPos move(EnumFacing var1) {
         return this.move(var1);
      }

      // $FF: synthetic method
      // $FF: bridge method
      public MutableBlockPos setPos(Vec3i var1) {
         return this.setPos(var1);
      }

      // $FF: synthetic method
      // $FF: bridge method
      public MutableBlockPos setPos(double var1, double var3, double var5) {
         return this.setPos(var1, var3, var5);
      }

      // $FF: synthetic method
      // $FF: bridge method
      public MutableBlockPos setPos(Ig var1) {
         return this.setPos(var1);
      }

      // $FF: synthetic method
      // $FF: bridge method
      public MutableBlockPos setPos(int var1, int var2, int var3) {
   ...
   public static class MutableBlockPos extends BlockPos {
      ...
      public MutableBlockPos setPos(Ig entityIn) {
