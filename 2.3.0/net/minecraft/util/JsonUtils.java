...
public class JsonUtils {
   ...
   public static OL getItem(JsonElement json, String memberName) {
      if (json.isJsonPrimitive()) {
   ...
   public static OL getItem(JsonObject json, String memberName) {
      if (json.has(memberName)) {
   ...
   public static <T> T fromJson(Gson gson, Reader p_193838_1_, Type p_193838_2_, boolean p_193838_3_) {
      try {
         ...
         return gson.getAdapter(TypeToken.get(p_193838_2_)).read(jsonreader);
      } catch (IOException var5) {
         IOException ioexception = var5;
         throw new JsonParseException(ioexception);
      }
   ...
   public static <T> T fromJson(Gson p_193837_0_, String p_193837_1_, Type p_193837_2_, boolean p_193837_3_) {
      return fromJson(p_193837_0_, (Reader)(new StringReader(p_193837_1_)), p_193837_2_, p_193837_3_);
   }
