...
public class DataFixer implements IDataFixer {
   ...
   public QQ process(IFixType type, QQ compound) {
   ...
   public QQ process(IFixType type, QQ compound, int versionIn) {
   ...
   private QQ processFixes(IFixType type, QQ compound, int versionIn) {
   ...
   private QQ processWalkers(IFixType type, QQ compound, int versionIn) {
